...
def add_album_users(album_id, include_friend_group, device_id=None, account_id=None, read=None, write=None, delete=None, add=None, connections=None, connection_groups=None):  # noqa: E501
    """Add Album Users
...
def approve_album(album_id, device_id=None, account_id=None, approval_status=None, verified=None):  # noqa: E501
    """Approve Album
...
def get_album_collection(return_nulls, album_id, device_id=None, account_id=None, like_preview_size=None, asset_preview_size=None, note_preview_size=None, connection_preview_size=None, audience_preview_size=None):  # noqa: E501
    """ Get Album
...
def leave_album(album_id, device_id=None, account_id=None):  # noqa: E501
    """Leave Album
...
def remove_album(album_id, device_id=None, account_id=None):  # noqa: E501
    """Delete Album
...
def remove_album_users(album_id, remove_friend_group, device_id=None, account_id=None, connections=None, connection_groups=None):  # noqa: E501
    """Remove Album Users
