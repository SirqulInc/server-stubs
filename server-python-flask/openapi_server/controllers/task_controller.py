...
def create_task(account_id, name, app_key=None, grouping_id=None, endpoint_url=None, payload=None, scheduled_date=None, start_date=None, end_date=None, cron_expression=None, visibility=None, active=None):  # noqa: E501
    """Create Task
...
def delete_task(account_id, task_id):  # noqa: E501
    """Delete Task
...
def get_task(account_id, task_id):  # noqa: E501
    """Get Task
...
def search_tasks(account_id, grouping_id=None, filter=None, statuses=None, template_types=None, app_key=None, keyword=None, sort_field=None, descending=None, start=None, limit=None, active_only=None):  # noqa: E501
    """Search Tasks
...
def update_task(task_id, account_id, name=None, app_key=None, grouping_id=None, endpoint_url=None, payload=None, scheduled_date=None, start_date=None, end_date=None, cron_expression=None, visibility=None, active=None):  # noqa: E501
    """Update Task
