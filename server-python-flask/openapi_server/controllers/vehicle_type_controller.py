...
def create_vehicle_type(vehicle_type, body=None):  # noqa: E501
    """Create Vehicle Type
...
def delete_vehicle_type(vehicle_type_id):  # noqa: E501
    """Delete Vehicle Type
...
def get_vehicle_type(vehicle_type_id):  # noqa: E501
    """Get Vehicle Type
...
def search_vehicle_types(sort_field, descending, start, limit, active_only, retailer_id=None, hub_id=None):  # noqa: E501
    """Search Vehicle Type
...
def update_vehicle_type(vehicle_type_id, vehicle_type, body=None):  # noqa: E501
    """Update Vehicle Type
