...
def create_notification_template(account_id, conduit, title, body, app_key=None, event=None, tags=None):  # noqa: E501
...
def create_or_update_blocked_notifications(app_key, data, account_id=None):  # noqa: E501
...
def delete_notification_template(account_id, notification_template_id):  # noqa: E501
...
def get_notification_template(account_id, notification_template_id):  # noqa: E501
...
def register_notification_token(token, push_type, device_id=None, account_id=None, environment=None, app_key=None, game_type=None, active=None, latitude=None, longitude=None):  # noqa: E501
...
def search_blocked_notifications(app_key, account_id=None, search_tags=None, events=None, conduits=None, custom_types=None, content_types=None, content_ids=None, sort_field=None, descending=None, start=None, limit=None):  # noqa: E501
...
def search_notification_template(account_id, sort_field, descending, start, limit, app_key=None, event=None, conduit=None, global_only=None, reserved_only=None, keyword=None):  # noqa: E501
...
def search_recipients(sort_field, device_id=None, account_id=None, app_key=None, conduit=None, keyword=None, audience_id=None, audience_ids=None, connection_group_ids=None, recipient_account_ids=None, descending=None, start=None, limit=None):  # noqa: E501
...
def search_recipients_count(device_id=None, account_id=None, app_key=None, conduit=None, keyword=None, audience_id=None, audience_ids=None, connection_group_ids=None, sort_field=None, descending=None, start=None, limit=None):  # noqa: E501
...
def send_batch_notifications(account_id, app_key, custom_message, conduit=None, content_id=None, content_name=None, content_type=None, parent_id=None, parent_type=None):  # noqa: E501
...
def send_custom_notifications(device_id=None, account_id=None, receiver_account_ids=None, include_friend_group=None, app_key=None, game_type=None, conduit=None, content_id=None, content_name=None, content_type=None, parent_id=None, parent_type=None, action_category=None, subject=None, custom_message=None, friend_only_apns=None, latitude=None, longitude=None):  # noqa: E501
...
def update_notification_template(account_id, notification_template_id, title=None, body=None, tags=None):  # noqa: E501
