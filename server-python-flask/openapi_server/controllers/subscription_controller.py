...
def create_subscription(account_id, plan_id=None, promo_code=None):  # noqa: E501
    """Create Subscription
...
def delete_subscription(account_id):  # noqa: E501
    """Delete Subscription
...
def get_subscription(account_id):  # noqa: E501
    """Get Subscription
...
def get_subscription_plan(plan_id):  # noqa: E501
...
def get_subscription_plans(visible=None, role=None):  # noqa: E501
...
def get_subscription_usage(account_id, application_id=None, start=None, end=None):  # noqa: E501
...
def update_subscription(account_id, plan_id=None, promo_code=None, active=None):  # noqa: E501
    """Update Subscription
