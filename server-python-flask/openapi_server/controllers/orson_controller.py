...
def add_movie(account_id, movie_name, third_party_account_id=None, tags=None, file=None, url=None, param_callback=None):  # noqa: E501
    """Add Movie
...
def ai_docs(account_id, doc, return_topics=None, limit=None, offset=None):  # noqa: E501
    """Search Docs
...
def ai_find_images(account_id, text, parse_flag=None, fetch_flag=None, size=None):  # noqa: E501
    """Find images
...
def ai_tags(account_id, tags, conditional=None, limit=None, offset=None):  # noqa: E501
    """Search Tags
...
def ai_text(account_id, terms, conditional=None, limit=None, offset=None):  # noqa: E501
    """Search Text
...
def batch(account_id, third_party_account_id=None, limit=None, operations=None, file=None, url=None, param_callback=None):  # noqa: E501
    """Batch Analysis
...
def create_instant_episode(account_id, data):  # noqa: E501
...
def create_voice_canvas(account_id, dimensions, third_party_account_id=None, text=None, file=None, url=None, parse_flag=None, fetch_flag=None, param_callback=None):  # noqa: E501
...
def emotion(account_id, third_party_account_id=None, file=None, url=None, param_callback=None):  # noqa: E501
    """Detect emotions
...
def get_add_movie_result(request_id, account_id):  # noqa: E501
...
def get_batch(request_id, account_id):  # noqa: E501
...
def get_emotion(request_id, account_id):  # noqa: E501
    """Get Emotion Results
...
def get_episode_status(episode_id, account_id):  # noqa: E501
...
def get_render_status(render_id, account_id):  # noqa: E501
    """Check episode status
...
def get_stt(request_id, account_id):  # noqa: E501
...
def get_tech_tune(request_id, account_id):  # noqa: E501
...
def get_topics(request_id, account_id):  # noqa: E501
    """Get Topics
...
def get_tts(request_id, account_id):  # noqa: E501
...
def get_voice_canvas(request_id, account_id):  # noqa: E501
...
def start_video_render(account_id, data):  # noqa: E501
...
def stt(account_id, third_party_account_id=None, source_language=None, target_language=None, file=None, url=None, param_callback=None):  # noqa: E501
    """Speach to Text
...
def summarize_topics(account_id, third_party_account_id=None, doc=None, file=None, url=None, limit=None, offset=None, param_callback=None):  # noqa: E501
    """Summarize Topics
...
def tech_tune(account_id, num_faces_expected, third_party_account_id=None, file=None, url=None, param_callback=None):  # noqa: E501
...
def tts(account_id, text, third_party_account_id=None, language=None, voice=None, param_callback=None):  # noqa: E501
    """Text to Speach
