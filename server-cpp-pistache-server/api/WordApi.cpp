...
void WordApi::handleParsingException(const std::exception& ex, Pistache::Http::ResponseWriter &response) const noexcept {
    std::pair<Pistache::Http::Code, std::string> codeAndError = handleParsingException(ex);
    response.send(codeAndError.first, codeAndError.second);
}

std::pair<Pistache::Http::Code, std::string> WordApi::handleParsingException(const std::exception& ex) const noexcept {
    try {
        throw;
...
void WordApi::handleOperationException(const std::exception& ex, Pistache::Http::ResponseWriter &response) const noexcept {
    std::pair<Pistache::Http::Code, std::string> codeAndError = handleOperationException(ex);
    response.send(codeAndError.first, codeAndError.second);
}

std::pair<Pistache::Http::Code, std::string> WordApi::handleOperationException(const std::exception& ex) const noexcept {
...
void WordApi::create_word_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        auto wordQuery = request.query().get("word");
        std::optional<std::string> word;
        if (wordQuery.has_value()) {
            std::string valueQuery_instance;
            if (fromStringValue(wordQuery.value(), valueQuery_instance)) {
                word = valueQuery_instance;
            }
        }
        auto definitionQuery = request.query().get("definition");
        std::optional<std::string> definition;
        if (definitionQuery.has_value()) {
            std::string valueQuery_instance;
            if (fromStringValue(definitionQuery.value(), valueQuery_instance)) {
                definition = valueQuery_instance;
            }
        }
...
void WordApi::delete_word_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        // Getting the query params
        auto wordIdQuery = request.query().get("wordId");
        std::optional<int64_t> wordId;
        if (wordIdQuery.has_value()) {
            int64_t valueQuery_instance;
            if (fromStringValue(wordIdQuery.value(), valueQuery_instance)) {
                wordId = valueQuery_instance;
            }
        }
        auto accountIdQuery = request.query().get("accountId");
        std::optional<int64_t> accountId;
...
void WordApi::update_word_handler(const Pistache::Rest::Request& request, Pistache::Http::ResponseWriter response) {
    try {
        ...
        auto wordTextQuery = request.query().get("wordText");
        std::optional<std::string> wordText;
        if (wordTextQuery.has_value()) {
            std::string valueQuery_instance;
            if (fromStringValue(wordTextQuery.value(), valueQuery_instance)) {
                wordText = valueQuery_instance;
            }
        }
        auto definitionQuery = request.query().get("definition");
        std::optional<std::string> definition;
...
void WordApi::word_api_default_handler(const Pistache::Rest::Request &, Pistache::Http::ResponseWriter response) {
