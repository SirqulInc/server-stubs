...
private:
    ...
    virtual void add_field( const std::optional<int64_t> &accountId, const std::optional<std::string> &appKey, const std::optional<std::string> &objectName, const std::optional<std::string> &fieldName, const std::optional<std::string> &fieldType, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Create Data
    /// </summary>
    /// <remarks>
    ...
    virtual void create_data( const std::string &objectName, const std::optional<int64_t> &accountId, const std::string &body, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Create Object
    /// </summary>
    /// <remarks>
    ...
    virtual void create_object( const std::optional<int64_t> &accountId, const std::optional<std::string> &appKey, const std::optional<std::string> &objectName, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Delete Data
    /// </summary>
    /// <remarks>
    ...
    virtual void delete_data( const std::string &objectName, const std::string &objectId, const std::optional<int64_t> &accountId, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Delete Field
    /// </summary>
    /// <remarks>
    ...
    virtual void delete_field( const std::optional<int64_t> &accountId, const std::optional<std::string> &appKey, const std::optional<std::string> &objectName, const std::optional<std::string> &fieldName, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Delete Object
    /// </summary>
    /// <remarks>
    ...
    virtual void delete_object( const std::optional<int64_t> &accountId, const std::optional<std::string> &appKey, const std::optional<std::string> &objectName, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Get Data
    /// </summary>
    /// <remarks>
    ...
    virtual void get_data( const std::string &objectName, const std::string &objectId, const std::optional<int64_t> &accountId, const std::optional<std::string> &include, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Get Object
    /// </summary>
    /// <remarks>
    ...
    virtual void get_object( const std::optional<int64_t> &accountId, const std::optional<std::string> &appKey, const std::optional<std::string> &objectName, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Search Data
    /// </summary>
    /// <remarks>
    ...
    /// <param name="include"> (optional, default to &quot;&quot;)</param>
    virtual void search_data( const std::string &objectName, const std::optional<bool> &count, const std::optional<int64_t> &start, const std::optional<int64_t> &limit, const std::optional<int64_t> &accountId, const std::optional<std::string> &criteria, const std::optional<std::string> &order, const std::optional<std::string> &include, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Search Objects
    /// </summary>
    /// <remarks>
    ...
    virtual void search_object( const std::optional<int64_t> &accountId, const std::optional<std::string> &appKey, const std::optional<int64_t> &start, const std::optional<int64_t> &limit, const std::optional<std::string> &keyword, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Update Data
    /// </summary>
    /// <remarks>
    ...
    /// <param name="accountId">The account id of the logged in user (optional, default to 0L)</param>
    /// <param name="body"> (optional)</param>
    virtual void update_data( const std::string &objectName, const std::string &objectId, const std::optional<int64_t> &accountId, const std::string &body, Pistache::Http::ResponseWriter &response) = 0;
