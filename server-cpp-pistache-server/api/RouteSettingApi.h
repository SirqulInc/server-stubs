...
#ifndef RouteSettingApi_H_
#define RouteSettingApi_H_
...
class  RouteSettingApi : public ApiBase {
public:
    explicit RouteSettingApi(const std::shared_ptr<Pistache::Rest::Router>& rtr);
    ~RouteSettingApi() override = default;
    void init() override;
...
private:
    ...
    void create_route_settings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    void delete_route_settings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    void get_route_settings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    void search_route_settings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    void update_route_settings_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
    void route_setting_api_default_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
