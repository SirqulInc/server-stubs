...
private:
    ...
    virtual void get_app_data( const std::optional<int32_t> &start, const std::optional<int32_t> &limit, const std::optional<std::string> &deviceId, const std::optional<int64_t> &accountId, const std::optional<std::string> &gameType, const std::optional<bool> &includeGameData, const std::optional<std::string> &q, const std::optional<std::string> &keyword, const std::optional<std::string> &sortField, const std::optional<bool> &descending, const std::optional<int32_t> &i, const std::optional<int32_t> &l, const std::optional<bool> &gameObjectCount, const std::optional<std::string> &filter, const std::optional<int64_t> &dateCreated, const std::optional<int64_t> &ownerId, const std::optional<std::string> &missionIds, const std::optional<std::string> &gameIds, const std::optional<std::string> &packIds, const std::optional<std::string> &gameLevelIds, const std::optional<std::string> &appVersion, const std::optional<bool> &includeHigherVersionPacks, const std::optional<bool> &includeHigherVersionLevels, const std::optional<std::string> &responseGroups, const std::optional<std::string> &purchaseType, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Create App Data
    /// </summary>
    /// <remarks>
    ...
    /// <param name="responseGroups">use response groups to include large parts of the structure. possible values are: * MISSION_DEFAULT (default) - include the default mission (built-in packs), excludes all other mission groups * MISSION_DEFAULT_LEVELS_SAVED - include saved levels, excludes all other mission groups * MISSION_DEFAULT_LEVELS_COMMUNITY - include community levels, excludes all other mission groups * MISSION_INVITED (default) - include challenges sent to user * PROFILE (default) - include entire profile * PROFILE_DATA - only include profile date (exclude friends) * PROFILE_FRIENDS - include friends list  (optional, default to &quot;&quot;)</param>
    /// <param name="purchaseType">the will return the correct in app purchases for the device, possible values are: * SIRQUL (default) - purchasing from the sirqul store using tickets * IOS - purchasing from the itunes store for iPhone, iPod, iPod Touch * GOOGLE - purchasing from the google android store * AMAZON - purchasing from the amazon android store * MAC - purchasing from the itunes store for OSX * FREE - the item is free to purchase  (optional, default to &quot;&quot;)</param>
    virtual void post_app_data( const std::optional<std::string> &gameType, const std::optional<int32_t> &start, const std::optional<int32_t> &limit, const std::optional<std::string> &data, const std::optional<std::string> &deviceId, const std::optional<int64_t> &accountId, const std::optional<bool> &includeGameData, const std::optional<std::string> &q, const std::optional<std::string> &keyword, const std::optional<std::string> &sortField, const std::optional<bool> &descending, const std::optional<int32_t> &i, const std::optional<int32_t> &l, const std::optional<bool> &gameObjectCount, const std::optional<std::string> &filter, const std::optional<int64_t> &dateCreated, const std::optional<int64_t> &ownerId, const std::optional<std::string> &missionIds, const std::optional<std::string> &gameIds, const std::optional<std::string> &packIds, const std::optional<std::string> &gameLevelIds, const std::optional<std::string> &appVersion, const std::optional<bool> &includeHigherVersionPacks, const std::optional<bool> &includeHigherVersionLevels, const std::optional<std::string> &responseGroups, const std::optional<std::string> &purchaseType, Pistache::Http::ResponseWriter &response) = 0;
    /// <summary>
    /// Regenerate App Data
    /// </summary>
    /// <remarks>
    ...
    virtual void regen_app_data( const std::optional<int64_t> &accountId, const std::optional<std::string> &appKey, const std::optional<std::string> &buildVersion, const std::optional<std::string> &apiVersion, Pistache::Http::ResponseWriter &response) = 0;
