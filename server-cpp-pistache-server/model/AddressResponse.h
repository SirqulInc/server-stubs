...
#ifndef AddressResponse_H_
#define AddressResponse_H_
...
public:
    AddressResponse();
    virtual ~AddressResponse() = default;
    ...
    bool operator==(const AddressResponse& rhs) const;
    bool operator!=(const AddressResponse& rhs) const;
    ...
    friend  void to_json(nlohmann::json& j, const AddressResponse& o);
    friend  void from_json(const nlohmann::json& j, AddressResponse& o);
protected:
