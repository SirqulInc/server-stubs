...
public:
    ...
    void delete_region(const std::optional<int64_t> &accountId, const std::optional<int64_t> &regionId, Pistache::Http::ResponseWriter &response);
    void get_region(const std::optional<int64_t> &regionId, const std::optional<int64_t> &accountId, Pistache::Http::ResponseWriter &response);
