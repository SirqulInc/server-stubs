...
public:
    ...
    void get_score(const std::optional<int64_t> &accountId, const std::optional<std::string> &appKey, const std::optional<int64_t> &missionId, const std::optional<int64_t> &gameId, const std::optional<int64_t> &packId, const std::optional<int64_t> &gameLevelId, const std::optional<int64_t> &gameObjectId, const std::optional<std::string> &scoreObjectType, const std::optional<std::string> &scoreStatus, Pistache::Http::ResponseWriter &response);
