...
public class AdsApiServiceImpl extends AdsApiService {
    @Override
    public Response adsFind( @NotNull String appKey,  @NotNull Boolean randomize,  @NotNull Boolean targetedAdsOnly, String type, Long accountId, String appVersion, Double latitude, Double longitude, String device, Long deviceIdentifier, String deviceVersion, Integer start, Integer limit, Boolean includeAudiences, Boolean allocatesTickets, String missionIds, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
