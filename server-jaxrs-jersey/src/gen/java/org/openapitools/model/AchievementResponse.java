 ...
 */
@JsonPropertyOrder({
  AchievementResponse.JSON_PROPERTY_VALID,
  AchievementResponse.JSON_PROPERTY_MESSAGE,
  AchievementResponse.JSON_PROPERTY_VERSION,
  AchievementResponse.JSON_PROPERTY_SERIALIZE_NULLS,
  AchievementResponse.JSON_PROPERTY_START_TIME_LOG,
  AchievementResponse.JSON_PROPERTY_ERROR_CODE,
  AchievementResponse.JSON_PROPERTY_REQUEST,
  AchievementResponse.JSON_PROPERTY_ACHIEVEMENT_ID,
  AchievementResponse.JSON_PROPERTY_TITLE,
  AchievementResponse.JSON_PROPERTY_DESCRIPTION,
  AchievementResponse.JSON_PROPERTY_ANALYTICS_TAG,
  AchievementResponse.JSON_PROPERTY_RANK_TYPE,
  AchievementResponse.JSON_PROPERTY_RANK_INCREMENT,
  AchievementResponse.JSON_PROPERTY_VALIDATE,
  AchievementResponse.JSON_PROPERTY_APP_NAME,
  AchievementResponse.JSON_PROPERTY_ACTIVE,
  AchievementResponse.JSON_PROPERTY_UPDATED,
  AchievementResponse.JSON_PROPERTY_CREATED,
  AchievementResponse.JSON_PROPERTY_TIER_COUNT,
  AchievementResponse.JSON_PROPERTY_MIN_INCREMENT,
  AchievementResponse.JSON_PROPERTY_MAX_INCREMENT,
  AchievementResponse.JSON_PROPERTY_TIERS,
  AchievementResponse.JSON_PROPERTY_RETURNING
})
