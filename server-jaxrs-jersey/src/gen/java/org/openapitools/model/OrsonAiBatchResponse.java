 ...
 */
@JsonPropertyOrder({
  OrsonAiBatchResponse.JSON_PROPERTY_REQUEST_ID,
  OrsonAiBatchResponse.JSON_PROPERTY_RESPONSE_CODE,
  OrsonAiBatchResponse.JSON_PROPERTY_RESPONSE_RAW,
  OrsonAiBatchResponse.JSON_PROPERTY_TRANSCRIPT,
  OrsonAiBatchResponse.JSON_PROPERTY_TOPICS,
  OrsonAiBatchResponse.JSON_PROPERTY_EMOTIONS
})
...
public class OrsonAiBatchResponse   {
  ...
  public static final String JSON_PROPERTY_EMOTIONS = "emotions";
  @JsonProperty(JSON_PROPERTY_EMOTIONS)
