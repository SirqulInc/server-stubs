 ...
 */
@JsonPropertyOrder({
  ShipmentOrder.JSON_PROPERTY_VALID,
  ShipmentOrder.JSON_PROPERTY_BATCH_I_D,
  ShipmentOrder.JSON_PROPERTY_BATCH_SIZE,
  ShipmentOrder.JSON_PROPERTY_ORDER_TRACKING_I_D,
  ShipmentOrder.JSON_PROPERTY_CLIENT_REF_NO,
  ShipmentOrder.JSON_PROPERTY_CLIENT_REF_NO2,
  ShipmentOrder.JSON_PROPERTY_HUB_CODE,
  ShipmentOrder.JSON_PROPERTY_ACCOUNT_NO,
  ShipmentOrder.JSON_PROPERTY_COMPANY_NAME,
  ShipmentOrder.JSON_PROPERTY_VEHICLE_TYPE_NAME,
  ShipmentOrder.JSON_PROPERTY_SERVICE_TYPE_NAME,
  ShipmentOrder.JSON_PROPERTY_SERVICE_CODE,
  ShipmentOrder.JSON_PROPERTY_PIECES,
  ShipmentOrder.JSON_PROPERTY_WEIGHT,
  ShipmentOrder.JSON_PROPERTY_CUBIC_FEET,
  ShipmentOrder.JSON_PROPERTY_PICKUP_COMPANY,
  ShipmentOrder.JSON_PROPERTY_PICKUP_CONTACT,
  ShipmentOrder.JSON_PROPERTY_PICKUP_PHONE,
  ShipmentOrder.JSON_PROPERTY_PICKUP_STREET,
  ShipmentOrder.JSON_PROPERTY_PICKUP_STREET2,
  ShipmentOrder.JSON_PROPERTY_PICKUP_CITY,
  ShipmentOrder.JSON_PROPERTY_PICKUP_STATE,
  ShipmentOrder.JSON_PROPERTY_PICKUP_ZIP,
  ShipmentOrder.JSON_PROPERTY_PICKUP_TARGET_FROM,
  ShipmentOrder.JSON_PROPERTY_PICKUP_TARGET_TO,
  ShipmentOrder.JSON_PROPERTY_DELIVERY_COMPANY,
  ShipmentOrder.JSON_PROPERTY_DELIVERY_CONTACT,
  ShipmentOrder.JSON_PROPERTY_DELIVERY_PHONE,
  ShipmentOrder.JSON_PROPERTY_DELIVERY_STREET,
  ShipmentOrder.JSON_PROPERTY_DELIVERY_STREET2,
  ShipmentOrder.JSON_PROPERTY_DELIVERY_CITY,
  ShipmentOrder.JSON_PROPERTY_DELIVERY_STATE,
  ShipmentOrder.JSON_PROPERTY_DELIVERY_ZIP,
  ShipmentOrder.JSON_PROPERTY_DELIVERY_TARGET_FROM,
  ShipmentOrder.JSON_PROPERTY_DELIVERY_TARGET_TO,
  ShipmentOrder.JSON_PROPERTY_ORDER_PACKAGES,
  ShipmentOrder.JSON_PROPERTY_ROUTE_I_D,
  ShipmentOrder.JSON_PROPERTY_DRIVER_I_D,
  ShipmentOrder.JSON_PROPERTY_PICKUP_SEQUENCE_NO,
  ShipmentOrder.JSON_PROPERTY_DELIVERY_SEQUENCE_NO,
  ShipmentOrder.JSON_PROPERTY_PICKUP_E_T_A,
  ShipmentOrder.JSON_PROPERTY_DELIVERY_E_T_A
})
...
public class ShipmentOrder   {
  ...
  public static final String JSON_PROPERTY_ORDER_TRACKING_I_D = "OrderTrackingID";
  @JsonProperty(JSON_PROPERTY_ORDER_TRACKING_I_D)
  private Double orderTrackingID;

  public static final String JSON_PROPERTY_CLIENT_REF_NO = "ClientRefNo";
  @JsonProperty(JSON_PROPERTY_CLIENT_REF_NO)
  private String clientRefNo;

  public static final String JSON_PROPERTY_CLIENT_REF_NO2 = "ClientRefNo2";
  @JsonProperty(JSON_PROPERTY_CLIENT_REF_NO2)
  private String clientRefNo2;

  public static final String JSON_PROPERTY_HUB_CODE = "HubCode";
  @JsonProperty(JSON_PROPERTY_HUB_CODE)
  ...
  public static final String JSON_PROPERTY_VEHICLE_TYPE_NAME = "VehicleTypeName";
  @JsonProperty(JSON_PROPERTY_VEHICLE_TYPE_NAME)
  ...
  public static final String JSON_PROPERTY_PICKUP_COMPANY = "PickupCompany";
  @JsonProperty(JSON_PROPERTY_PICKUP_COMPANY)
  private String pickupCompany;

  public static final String JSON_PROPERTY_PICKUP_CONTACT = "PickupContact";
  @JsonProperty(JSON_PROPERTY_PICKUP_CONTACT)
  private String pickupContact;

  public static final String JSON_PROPERTY_PICKUP_PHONE = "PickupPhone";
  @JsonProperty(JSON_PROPERTY_PICKUP_PHONE)
  private String pickupPhone;

  public static final String JSON_PROPERTY_PICKUP_STREET = "PickupStreet";
  @JsonProperty(JSON_PROPERTY_PICKUP_STREET)
  private String pickupStreet;

  public static final String JSON_PROPERTY_PICKUP_STREET2 = "PickupStreet2";
  @JsonProperty(JSON_PROPERTY_PICKUP_STREET2)
  private String pickupStreet2;

  public static final String JSON_PROPERTY_PICKUP_CITY = "PickupCity";
  @JsonProperty(JSON_PROPERTY_PICKUP_CITY)
  private String pickupCity;

  public static final String JSON_PROPERTY_PICKUP_STATE = "PickupState";
  @JsonProperty(JSON_PROPERTY_PICKUP_STATE)
  private String pickupState;

  public static final String JSON_PROPERTY_PICKUP_ZIP = "PickupZip";
  @JsonProperty(JSON_PROPERTY_PICKUP_ZIP)
  private String pickupZip;

  public static final String JSON_PROPERTY_PICKUP_TARGET_FROM = "PickupTargetFrom";
  @JsonProperty(JSON_PROPERTY_PICKUP_TARGET_FROM)
  private Date pickupTargetFrom;

  public static final String JSON_PROPERTY_PICKUP_TARGET_TO = "PickupTargetTo";
  @JsonProperty(JSON_PROPERTY_PICKUP_TARGET_TO)
  private Date pickupTargetTo;

  public static final String JSON_PROPERTY_DELIVERY_COMPANY = "DeliveryCompany";
  @JsonProperty(JSON_PROPERTY_DELIVERY_COMPANY)
  ...
  public static final String JSON_PROPERTY_DELIVERY_STREET = "DeliveryStreet";
  @JsonProperty(JSON_PROPERTY_DELIVERY_STREET)
  private String deliveryStreet;

  public static final String JSON_PROPERTY_DELIVERY_STREET2 = "DeliveryStreet2";
  @JsonProperty(JSON_PROPERTY_DELIVERY_STREET2)
  ...
  @JsonProperty(JSON_PROPERTY_DELIVERY_STATE)
  private String deliveryState;

  public static final String JSON_PROPERTY_DELIVERY_ZIP = "DeliveryZip";
  @JsonProperty(JSON_PROPERTY_DELIVERY_ZIP)
  private String deliveryZip;

  public static final String JSON_PROPERTY_DELIVERY_TARGET_FROM = "DeliveryTargetFrom";
  @JsonProperty(JSON_PROPERTY_DELIVERY_TARGET_FROM)
  private Date deliveryTargetFrom;

  public static final String JSON_PROPERTY_DELIVERY_TARGET_TO = "DeliveryTargetTo";
  @JsonProperty(JSON_PROPERTY_DELIVERY_TARGET_TO)
  private Date deliveryTargetTo;

  public static final String JSON_PROPERTY_ORDER_PACKAGES = "OrderPackages";
  @JsonProperty(JSON_PROPERTY_ORDER_PACKAGES)
  private List<@Valid OrderPackage> orderPackages = new ArrayList<>();

  public static final String JSON_PROPERTY_ROUTE_I_D = "RouteID";
  @JsonProperty(JSON_PROPERTY_ROUTE_I_D)
  private Integer routeID;

  public static final String JSON_PROPERTY_DRIVER_I_D = "DriverID";
  @JsonProperty(JSON_PROPERTY_DRIVER_I_D)
  private Integer driverID;

  public static final String JSON_PROPERTY_PICKUP_SEQUENCE_NO = "PickupSequenceNo";
  @JsonProperty(JSON_PROPERTY_PICKUP_SEQUENCE_NO)
  private Integer pickupSequenceNo;

  public static final String JSON_PROPERTY_DELIVERY_SEQUENCE_NO = "DeliverySequenceNo";
  @JsonProperty(JSON_PROPERTY_DELIVERY_SEQUENCE_NO)
  private Integer deliverySequenceNo;

  public static final String JSON_PROPERTY_PICKUP_E_T_A = "PickupETA";
  @JsonProperty(JSON_PROPERTY_PICKUP_E_T_A)
  private String pickupETA;

  public static final String JSON_PROPERTY_DELIVERY_E_T_A = "DeliveryETA";
  @JsonProperty(JSON_PROPERTY_DELIVERY_E_T_A)
   ...
   **/
  @JsonProperty(value = "OrderTrackingID")
  @ApiModelProperty(value = "")
   ...
   * @return clientRefNo
   **/
  @JsonProperty(value = "ClientRefNo")
  @ApiModelProperty(value = "")
   ...
   * @return clientRefNo2
   **/
  @JsonProperty(value = "ClientRefNo2")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "VehicleTypeName")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "PickupCompany")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "PickupContact")
  @ApiModelProperty(value = "")
   ...
   * @return pickupPhone
   **/
  @JsonProperty(value = "PickupPhone")
  @ApiModelProperty(value = "")
   ...
   * @return pickupStreet
   **/
  @JsonProperty(value = "PickupStreet")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "PickupStreet2")
  @ApiModelProperty(value = "")
   ...
   * @return pickupState
   **/
  @JsonProperty(value = "PickupState")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "PickupTargetFrom")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "PickupTargetTo")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "DeliveryStreet")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "DeliveryStreet2")
  @ApiModelProperty(value = "")
   ...
   * @return deliveryZip
   **/
  @JsonProperty(value = "DeliveryZip")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "DeliveryTargetFrom")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "DeliveryTargetTo")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "OrderPackages")
  @ApiModelProperty(value = "")
  @Valid 
   ...
   **/
  @JsonProperty(value = "PickupSequenceNo")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "DeliverySequenceNo")
  @ApiModelProperty(value = "")
   ...
   * @return deliveryETA
   **/
  @JsonProperty(value = "DeliveryETA")
  @ApiModelProperty(value = "")
