 ...
 */
@JsonPropertyOrder({
  ProfileInfoResponse.JSON_PROPERTY_VALID,
  ProfileInfoResponse.JSON_PROPERTY_MESSAGE,
  ProfileInfoResponse.JSON_PROPERTY_VERSION,
  ProfileInfoResponse.JSON_PROPERTY_SERIALIZE_NULLS,
  ProfileInfoResponse.JSON_PROPERTY_START_TIME_LOG,
  ProfileInfoResponse.JSON_PROPERTY_ERROR_CODE,
  ProfileInfoResponse.JSON_PROPERTY_REQUEST,
  ProfileInfoResponse.JSON_PROPERTY_ACCOUNT_ID,
  ProfileInfoResponse.JSON_PROPERTY_LOCATION_DISPLAY,
  ProfileInfoResponse.JSON_PROPERTY_DISPLAY,
  ProfileInfoResponse.JSON_PROPERTY_USERNAME,
  ProfileInfoResponse.JSON_PROPERTY_PROFILE_IMAGE,
  ProfileInfoResponse.JSON_PROPERTY_PROFILE_AVATAR,
  ProfileInfoResponse.JSON_PROPERTY_ABOUT_US,
  ProfileInfoResponse.JSON_PROPERTY_LOCALE,
  ProfileInfoResponse.JSON_PROPERTY_SUMMARY_TITLE,
  ProfileInfoResponse.JSON_PROPERTY_GENDER,
  ProfileInfoResponse.JSON_PROPERTY_AGE,
  ProfileInfoResponse.JSON_PROPERTY_GAME_EXPERIENCE,
  ProfileInfoResponse.JSON_PROPERTY_CONTACT,
  ProfileInfoResponse.JSON_PROPERTY_CATEGORIES,
  ProfileInfoResponse.JSON_PROPERTY_PERSONAL_PROFILE,
  ProfileInfoResponse.JSON_PROPERTY_USER_SETTINGS,
  ProfileInfoResponse.JSON_PROPERTY_LATITUDE,
  ProfileInfoResponse.JSON_PROPERTY_LONGITUDE,
  ProfileInfoResponse.JSON_PROPERTY_CURRENT_POSTAL_CODE,
  ProfileInfoResponse.JSON_PROPERTY_ACCOUNT_TYPE,
  ProfileInfoResponse.JSON_PROPERTY_PREMIUM_EXPIRATION,
  ProfileInfoResponse.JSON_PROPERTY_MATCH_INDEX,
  ProfileInfoResponse.JSON_PROPERTY_TAGS,
  ProfileInfoResponse.JSON_PROPERTY_RETURNING
})
