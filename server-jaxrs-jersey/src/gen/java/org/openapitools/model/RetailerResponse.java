 ...
 */
@JsonPropertyOrder({
  RetailerResponse.JSON_PROPERTY_RETAILER_ID,
  RetailerResponse.JSON_PROPERTY_NAME,
  RetailerResponse.JSON_PROPERTY_FACEBOOK_URL,
  RetailerResponse.JSON_PROPERTY_TWITTER_URL,
  RetailerResponse.JSON_PROPERTY_ACTIVE,
  RetailerResponse.JSON_PROPERTY_CONTACT,
  RetailerResponse.JSON_PROPERTY_LOGO,
  RetailerResponse.JSON_PROPERTY_PICTURE1,
  RetailerResponse.JSON_PROPERTY_PICTURE2,
  RetailerResponse.JSON_PROPERTY_LATITUDE,
  RetailerResponse.JSON_PROPERTY_LONGITUDE,
  RetailerResponse.JSON_PROPERTY_VISIBILITY,
  RetailerResponse.JSON_PROPERTY_RESPONSIBLE,
  RetailerResponse.JSON_PROPERTY_MANAGER,
  RetailerResponse.JSON_PROPERTY_BILLABLE_ENTITY,
  RetailerResponse.JSON_PROPERTY_COUNTS
})
