 ...
 */
@JsonPropertyOrder({
  TournamentResponse.JSON_PROPERTY_ACTION,
  TournamentResponse.JSON_PROPERTY_HIGHEST_APP_VERSION,
  TournamentResponse.JSON_PROPERTY_MISSION_ID,
  TournamentResponse.JSON_PROPERTY_TICKETS_EARNED,
  TournamentResponse.JSON_PROPERTY_COST_TO_PLAY,
  TournamentResponse.JSON_PROPERTY_COST_TO_PLAY_TYPE,
  TournamentResponse.JSON_PROPERTY_OWNER,
  TournamentResponse.JSON_PROPERTY_TITLE,
  TournamentResponse.JSON_PROPERTY_DESCRIPTION,
  TournamentResponse.JSON_PROPERTY_AUTHOR_OVERRIDE,
  TournamentResponse.JSON_PROPERTY_ICON,
  TournamentResponse.JSON_PROPERTY_IMAGE,
  TournamentResponse.JSON_PROPERTY_SEQUENCE_TYPE,
  TournamentResponse.JSON_PROPERTY_UPDATED_DATE,
  TournamentResponse.JSON_PROPERTY_START_DATE,
  TournamentResponse.JSON_PROPERTY_END_DATE,
  TournamentResponse.JSON_PROPERTY_MISSION_TYPE,
  TournamentResponse.JSON_PROPERTY_ACTIVE,
  TournamentResponse.JSON_PROPERTY_BALANCE,
  TournamentResponse.JSON_PROPERTY_AVAILABLE_LIMIT,
  TournamentResponse.JSON_PROPERTY_INVITE_COUNT,
  TournamentResponse.JSON_PROPERTY_ACCEPTED_COUNT,
  TournamentResponse.JSON_PROPERTY_CHILD_COUNT,
  TournamentResponse.JSON_PROPERTY_ENABLE_BUY_BACK,
  TournamentResponse.JSON_PROPERTY_MINIMUM_TO_PLAY,
  TournamentResponse.JSON_PROPERTY_REWARDED,
  TournamentResponse.JSON_PROPERTY_REFUNDED,
  TournamentResponse.JSON_PROPERTY_JOIN_CODE,
  TournamentResponse.JSON_PROPERTY_REWARDS,
  TournamentResponse.JSON_PROPERTY_GAMES,
  TournamentResponse.JSON_PROPERTY_SCORES,
  TournamentResponse.JSON_PROPERTY_USER_PERMISSIONS_LIST,
  TournamentResponse.JSON_PROPERTY_RESULTS,
  TournamentResponse.JSON_PROPERTY_INVITE_STATUS,
  TournamentResponse.JSON_PROPERTY_AUDIENCES,
  TournamentResponse.JSON_PROPERTY_MISSION_INVITE_ID,
  TournamentResponse.JSON_PROPERTY_MISSION_INVITE,
  TournamentResponse.JSON_PROPERTY_INVITEE,
  TournamentResponse.JSON_PROPERTY_FORMAT_TYPE,
  TournamentResponse.JSON_PROPERTY_CREATIVES,
  TournamentResponse.JSON_PROPERTY_FIXED_REWARD,
  TournamentResponse.JSON_PROPERTY_ALLOCATE_TICKETS,
  TournamentResponse.JSON_PROPERTY_TICKET_TYPE,
  TournamentResponse.JSON_PROPERTY_TICKET_COUNT,
  TournamentResponse.JSON_PROPERTY_POINTS,
  TournamentResponse.JSON_PROPERTY_SPLIT_REWARD,
  TournamentResponse.JSON_PROPERTY_SECONDS_BETWEEN_LEVELS,
  TournamentResponse.JSON_PROPERTY_SECONDS_BETWEEN_PACKS,
  TournamentResponse.JSON_PROPERTY_ADVANCED_REPORTING,
  TournamentResponse.JSON_PROPERTY_TOURNAMENT_DATA
})
...
public class TournamentResponse   {
  ...
  public static final String JSON_PROPERTY_TOURNAMENT_DATA = "tournamentData";
  @JsonProperty(JSON_PROPERTY_TOURNAMENT_DATA)
   ...
   **/
  @JsonProperty(value = "tournamentData")
  @ApiModelProperty(value = "")
