 ...
 */
@JsonPropertyOrder({
  OfferTransactionResponse.JSON_PROPERTY_VALID,
  OfferTransactionResponse.JSON_PROPERTY_MESSAGE,
  OfferTransactionResponse.JSON_PROPERTY_VERSION,
  OfferTransactionResponse.JSON_PROPERTY_SERIALIZE_NULLS,
  OfferTransactionResponse.JSON_PROPERTY_START_TIME_LOG,
  OfferTransactionResponse.JSON_PROPERTY_ERROR_CODE,
  OfferTransactionResponse.JSON_PROPERTY_REQUEST,
  OfferTransactionResponse.JSON_PROPERTY_OFFER_LOCATION_ID,
  OfferTransactionResponse.JSON_PROPERTY_OFFER_ID,
  OfferTransactionResponse.JSON_PROPERTY_RETAILER_ID,
  OfferTransactionResponse.JSON_PROPERTY_TRANSACTION_ID,
  OfferTransactionResponse.JSON_PROPERTY_FAVORITE_ID,
  OfferTransactionResponse.JSON_PROPERTY_OFFER_NAME,
  OfferTransactionResponse.JSON_PROPERTY_SUB_TITLE,
  OfferTransactionResponse.JSON_PROPERTY_LOCATION_NAME,
  OfferTransactionResponse.JSON_PROPERTY_STARTS,
  OfferTransactionResponse.JSON_PROPERTY_EXPIRES,
  OfferTransactionResponse.JSON_PROPERTY_ACTIVATED,
  OfferTransactionResponse.JSON_PROPERTY_EXPIRATION,
  OfferTransactionResponse.JSON_PROPERTY_REDEEMABLE_START,
  OfferTransactionResponse.JSON_PROPERTY_REDEEMABLE_END,
  OfferTransactionResponse.JSON_PROPERTY_DISTANCE,
  OfferTransactionResponse.JSON_PROPERTY_OFFER_TYPE,
  OfferTransactionResponse.JSON_PROPERTY_LONGITUDE,
  OfferTransactionResponse.JSON_PROPERTY_LATITUDE,
  OfferTransactionResponse.JSON_PROPERTY_FAVORITE,
  OfferTransactionResponse.JSON_PROPERTY_FULL_PRICE,
  OfferTransactionResponse.JSON_PROPERTY_DISCOUNT_PRICE,
  OfferTransactionResponse.JSON_PROPERTY_ESTIMATED_VALUE,
  OfferTransactionResponse.JSON_PROPERTY_VOUCHER_DISCOUNT_PRICE,
  OfferTransactionResponse.JSON_PROPERTY_MISSION_LIST_RESPONSE,
  OfferTransactionResponse.JSON_PROPERTY_IMAGE,
  OfferTransactionResponse.JSON_PROPERTY_IMAGE1,
  OfferTransactionResponse.JSON_PROPERTY_IMAGE2,
  OfferTransactionResponse.JSON_PROPERTY_IMAGE3,
  OfferTransactionResponse.JSON_PROPERTY_IMAGE4,
  OfferTransactionResponse.JSON_PROPERTY_IMAGE5,
  OfferTransactionResponse.JSON_PROPERTY_IMAGES,
  OfferTransactionResponse.JSON_PROPERTY_BARCODE,
  OfferTransactionResponse.JSON_PROPERTY_EXTERNAL_URL,
  OfferTransactionResponse.JSON_PROPERTY_SQOOT_URL,
  OfferTransactionResponse.JSON_PROPERTY_ACTIVE,
  OfferTransactionResponse.JSON_PROPERTY_LOCATION,
  OfferTransactionResponse.JSON_PROPERTY_SUB_DETAILS,
  OfferTransactionResponse.JSON_PROPERTY_EXTERNAL_REDEEM_AUTH,
  OfferTransactionResponse.JSON_PROPERTY_EXTERNAL_REDEEM_OPTIONS,
  OfferTransactionResponse.JSON_PROPERTY_PUBLISHER,
  OfferTransactionResponse.JSON_PROPERTY_PRODUCT,
  OfferTransactionResponse.JSON_PROPERTY_EVENT,
  OfferTransactionResponse.JSON_PROPERTY_MEDIA,
  OfferTransactionResponse.JSON_PROPERTY_VIEWED_COUNT,
  OfferTransactionResponse.JSON_PROPERTY_CLICKED_COUNT,
  OfferTransactionResponse.JSON_PROPERTY_ADDED_LIMIT,
  OfferTransactionResponse.JSON_PROPERTY_ADDED_COUNT,
  OfferTransactionResponse.JSON_PROPERTY_USED_COUNT,
  OfferTransactionResponse.JSON_PROPERTY_REMOVED_COUNT,
  OfferTransactionResponse.JSON_PROPERTY_LOCATION_ADDED_COUNT,
  OfferTransactionResponse.JSON_PROPERTY_BARCODE_ENTRY,
  OfferTransactionResponse.JSON_PROPERTY_BARCODE_TYPE,
  OfferTransactionResponse.JSON_PROPERTY_TICKETS_REWARD,
  OfferTransactionResponse.JSON_PROPERTY_TICKETS_REWARD_TYPE,
  OfferTransactionResponse.JSON_PROPERTY_SPECIAL_OFFER_TYPE,
  OfferTransactionResponse.JSON_PROPERTY_LIKE_COUNT,
  OfferTransactionResponse.JSON_PROPERTY_DISLIKE_COUNT,
  OfferTransactionResponse.JSON_PROPERTY_FAVORITE_COUNT,
  OfferTransactionResponse.JSON_PROPERTY_NOTE_COUNT,
  OfferTransactionResponse.JSON_PROPERTY_LOG_ID,
  OfferTransactionResponse.JSON_PROPERTY_BILLABLE_ENTITY_ID,
  OfferTransactionResponse.JSON_PROPERTY_RESPONSIBLE_ACCOUNT_ID,
  OfferTransactionResponse.JSON_PROPERTY_AVAILABILITY_SUMMARY,
  OfferTransactionResponse.JSON_PROPERTY_EXTERNAL_ID,
  OfferTransactionResponse.JSON_PROPERTY_PARENT_OFFER,
  OfferTransactionResponse.JSON_PROPERTY_ADDRESS,
  OfferTransactionResponse.JSON_PROPERTY_DETAILS,
  OfferTransactionResponse.JSON_PROPERTY_FINE_PRINT,
  OfferTransactionResponse.JSON_PROPERTY_RETAILER_PHONE_NUMBER,
  OfferTransactionResponse.JSON_PROPERTY_TICKET_PRICE_TYPE,
  OfferTransactionResponse.JSON_PROPERTY_TICKET_PRICE,
  OfferTransactionResponse.JSON_PROPERTY_DISCOUNT_PERCENTAGE,
  OfferTransactionResponse.JSON_PROPERTY_PAYMENT_FEES,
  OfferTransactionResponse.JSON_PROPERTY_VOUCHER_PRICE,
  OfferTransactionResponse.JSON_PROPERTY_PURCHASES_REMAINING,
  OfferTransactionResponse.JSON_PROPERTY_REDEMPTIONS_REMAINING,
  OfferTransactionResponse.JSON_PROPERTY_REDEMPTION_STATUS,
  OfferTransactionResponse.JSON_PROPERTY_REDEMPTION_CODE,
  OfferTransactionResponse.JSON_PROPERTY_AUDIENCES,
  OfferTransactionResponse.JSON_PROPERTY_AUDIENCE_COUNT,
  OfferTransactionResponse.JSON_PROPERTY_WALLET_COUNT,
  OfferTransactionResponse.JSON_PROPERTY_QR_CODE_URL,
  OfferTransactionResponse.JSON_PROPERTY_SHOW_REMAINING,
  OfferTransactionResponse.JSON_PROPERTY_SHOW_REDEEMED,
  OfferTransactionResponse.JSON_PROPERTY_PURCHASE_LIMIT,
  OfferTransactionResponse.JSON_PROPERTY_PURCHASE_LIMIT_PER_USER,
  OfferTransactionResponse.JSON_PROPERTY_REDEMPTION_LIMIT,
  OfferTransactionResponse.JSON_PROPERTY_USER_REDEMPTION_LIMIT,
  OfferTransactionResponse.JSON_PROPERTY_CATEGORIES,
  OfferTransactionResponse.JSON_PROPERTY_FILTERS,
  OfferTransactionResponse.JSON_PROPERTY_CUSTOMER,
  OfferTransactionResponse.JSON_PROPERTY_PURCHASED_DATE,
  OfferTransactionResponse.JSON_PROPERTY_USED_DATE,
  OfferTransactionResponse.JSON_PROPERTY_TRANSACTION_CREATED,
  OfferTransactionResponse.JSON_PROPERTY_TRANSACTION_UPDATED,
  OfferTransactionResponse.JSON_PROPERTY_RETURNING
})
...
public class OfferTransactionResponse   {
  ...
  public static final String JSON_PROPERTY_PURCHASED_DATE = "purchasedDate";
  @JsonProperty(JSON_PROPERTY_PURCHASED_DATE)
  private Long purchasedDate;

  public static final String JSON_PROPERTY_USED_DATE = "usedDate";
  @JsonProperty(JSON_PROPERTY_USED_DATE)
  private Long usedDate;

  public static final String JSON_PROPERTY_TRANSACTION_CREATED = "transactionCreated";
  @JsonProperty(JSON_PROPERTY_TRANSACTION_CREATED)
  private Long transactionCreated;

  public static final String JSON_PROPERTY_TRANSACTION_UPDATED = "transactionUpdated";
  @JsonProperty(JSON_PROPERTY_TRANSACTION_UPDATED)
   ...
   **/
  @JsonProperty(value = "purchasedDate")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "transactionCreated")
  @ApiModelProperty(value = "")
   ...
   **/
  @JsonProperty(value = "transactionUpdated")
  @ApiModelProperty(value = "")
