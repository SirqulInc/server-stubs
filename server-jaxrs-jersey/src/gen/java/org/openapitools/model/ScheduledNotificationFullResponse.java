 ...
 */
@JsonPropertyOrder({
  ScheduledNotificationFullResponse.JSON_PROPERTY_SCHEDULED_NOTIFICATION_ID,
  ScheduledNotificationFullResponse.JSON_PROPERTY_ACTIVE,
  ScheduledNotificationFullResponse.JSON_PROPERTY_STATUS,
  ScheduledNotificationFullResponse.JSON_PROPERTY_TYPE,
  ScheduledNotificationFullResponse.JSON_PROPERTY_NAME,
  ScheduledNotificationFullResponse.JSON_PROPERTY_MESSAGE,
  ScheduledNotificationFullResponse.JSON_PROPERTY_GROUPING_ID,
  ScheduledNotificationFullResponse.JSON_PROPERTY_SCHEDULED_DATE,
  ScheduledNotificationFullResponse.JSON_PROPERTY_START_DATE,
  ScheduledNotificationFullResponse.JSON_PROPERTY_END_DATE,
  ScheduledNotificationFullResponse.JSON_PROPERTY_OWNER,
  ScheduledNotificationFullResponse.JSON_PROPERTY_BILLABLE_ENTITY,
  ScheduledNotificationFullResponse.JSON_PROPERTY_CONTENT_ID,
  ScheduledNotificationFullResponse.JSON_PROPERTY_CONTENT_NAME,
  ScheduledNotificationFullResponse.JSON_PROPERTY_CONTENT_TYPE,
  ScheduledNotificationFullResponse.JSON_PROPERTY_PARENT_ID,
  ScheduledNotificationFullResponse.JSON_PROPERTY_PARENT_TYPE,
  ScheduledNotificationFullResponse.JSON_PROPERTY_APPLICATION,
  ScheduledNotificationFullResponse.JSON_PROPERTY_TARGET_ID,
  ScheduledNotificationFullResponse.JSON_PROPERTY_TARGET_NAME,
  ScheduledNotificationFullResponse.JSON_PROPERTY_TARGET_TYPE,
  ScheduledNotificationFullResponse.JSON_PROPERTY_TARGET_PARAMS,
  ScheduledNotificationFullResponse.JSON_PROPERTY_DELIVER_ESTIMATE,
  ScheduledNotificationFullResponse.JSON_PROPERTY_DELIVER_COUNT,
  ScheduledNotificationFullResponse.JSON_PROPERTY_DELIVER_TOTAL,
  ScheduledNotificationFullResponse.JSON_PROPERTY_DELIVER_FAILED,
  ScheduledNotificationFullResponse.JSON_PROPERTY_PROCESSING_TIME,
  ScheduledNotificationFullResponse.JSON_PROPERTY_SENDING_TIME,
  ScheduledNotificationFullResponse.JSON_PROPERTY_UPDATED,
  ScheduledNotificationFullResponse.JSON_PROPERTY_CREATED,
  ScheduledNotificationFullResponse.JSON_PROPERTY_CRON_EXPRESSION,
  ScheduledNotificationFullResponse.JSON_PROPERTY_ENDPOINT_U_R_L,
  ScheduledNotificationFullResponse.JSON_PROPERTY_PAYLOAD,
  ScheduledNotificationFullResponse.JSON_PROPERTY_CONDITIONAL_INPUT,
  ScheduledNotificationFullResponse.JSON_PROPERTY_CONNECTION_ACCOUNT_IDS,
