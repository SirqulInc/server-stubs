...
use OpenAPI\Server\Api\PathingApiInterface;

class PathingController extends Controller
{
    /**
     * Constructor
     */
    public function __construct(
        private readonly PathingApiInterface $api,
    ...
    public function computePath(Request $request): JsonResponse
    {
        ...
        $reducePath = $request->boolean('reducePath');
