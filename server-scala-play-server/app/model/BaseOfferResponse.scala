...
/**
  * Represents the Swagger definition for BaseOfferResponse.
  */
...
case class BaseOfferResponse(
  ...
  specialOfferType: Option[BaseOfferResponse.SpecialOfferType.Value],
...
object BaseOfferResponse {
  implicit lazy val baseOfferResponseJsonFormat: Format[BaseOfferResponse] = Json.format[BaseOfferResponse]
