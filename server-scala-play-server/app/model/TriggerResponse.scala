...
/**
  * Represents the Swagger definition for TriggerResponse.
  */
@javax.annotation.Generated(value = Array("org.openapitools.codegen.languages.ScalaPlayFrameworkServerCodegen"), date = "2026-02-09T20:57:39.376804970Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
case class TriggerResponse(
  scheduledNotificationId: Option[Long],
  active: Option[Boolean],
  status: Option[TriggerResponse.Status.Value],
  `type`: Option[TriggerResponse.Type.Value],
  name: Option[String],
  ...
  templateType: Option[TriggerResponse.TemplateType.Value],
  groupedTypes: Option[TriggerResponse.GroupedTypes.Value],
  triggerId: Option[Long]
)

object TriggerResponse {
  implicit lazy val triggerResponseJsonFormat: Format[TriggerResponse] = Json.format[TriggerResponse]
