...
/**
  * Represents the Swagger definition for ScheduledNotificationFullResponse.
  */
...
case class ScheduledNotificationFullResponse(
  ...
  status: Option[ScheduledNotificationFullResponse.Status.Value],
  `type`: Option[ScheduledNotificationFullResponse.Type.Value],
  name: Option[String],
  ...
  templateType: Option[ScheduledNotificationFullResponse.TemplateType.Value],
  groupedTypes: Option[ScheduledNotificationFullResponse.GroupedTypes.Value]
)

object ScheduledNotificationFullResponse {
  implicit lazy val scheduledNotificationFullResponseJsonFormat: Format[ScheduledNotificationFullResponse] = Json.format[ScheduledNotificationFullResponse]
