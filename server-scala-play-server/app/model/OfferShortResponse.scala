...
/**
  * Represents the Swagger definition for OfferShortResponse.
  */
...
case class OfferShortResponse(
  ...
  barcodeType: Option[OfferShortResponse.BarcodeType.Value],
  ticketsReward: Option[Long],
  ticketsRewardType: Option[String],
  specialOfferType: Option[OfferShortResponse.SpecialOfferType.Value],
...
object OfferShortResponse {
  implicit lazy val offerShortResponseJsonFormat: Format[OfferShortResponse] = Json.format[OfferShortResponse]
