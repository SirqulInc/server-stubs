...
/**
  * Represents the Swagger definition for OfferResponse.
  */
...
case class OfferResponse(
  ...
  barcodeType: Option[OfferResponse.BarcodeType.Value],
  ticketsReward: Option[Long],
  ticketsRewardType: Option[String],
  specialOfferType: Option[OfferResponse.SpecialOfferType.Value],
...
object OfferResponse {
  implicit lazy val offerResponseJsonFormat: Format[OfferResponse] = Json.format[OfferResponse]
