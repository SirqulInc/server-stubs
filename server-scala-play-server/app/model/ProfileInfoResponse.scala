...
/**
  * Represents the Swagger definition for ProfileInfoResponse.
  */
...
case class ProfileInfoResponse(
  ...
  gender: Option[ProfileInfoResponse.Gender.Value],
  age: Option[String],
  gameExperience: Option[ProfileInfoResponse.GameExperience.Value],
...
object ProfileInfoResponse {
  implicit lazy val profileInfoResponseJsonFormat: Format[ProfileInfoResponse] = Json.format[ProfileInfoResponse]
