...
/**
  * Represents the Swagger definition for TournamentResponse.
  */
@javax.annotation.Generated(value = Array("org.openapitools.codegen.languages.ScalaPlayFrameworkServerCodegen"), date = "2026-02-09T20:57:39.376804970Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
case class TournamentResponse(
  action: Option[TournamentResponse.Action.Value],
  ...
  inviteStatus: Option[TournamentResponse.InviteStatus.Value],
  ...
  tournamentData: Option[String]
)

object TournamentResponse {
  implicit lazy val tournamentResponseJsonFormat: Format[TournamentResponse] = Json.format[TournamentResponse]
