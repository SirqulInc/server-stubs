...
/**
  * Represents the Swagger definition for OrsonAiBatchResponse.
  */
...
object OrsonAiBatchResponse {
  implicit lazy val orsonAiBatchResponseJsonFormat: Format[OrsonAiBatchResponse] = Json.format[OrsonAiBatchResponse]
}
