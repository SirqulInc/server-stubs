...
/**
  * Represents the Swagger definition for RetailerOfferResponse.
  */
@javax.annotation.Generated(value = Array("org.openapitools.codegen.languages.ScalaPlayFrameworkServerCodegen"), date = "2026-02-09T20:57:39.376804970Z[Etc/UTC]", comments = "Generator version: 7.20.0-SNAPSHOT")
case class RetailerOfferResponse(
  ...
  barcodeType: Option[RetailerOfferResponse.BarcodeType.Value],
  ticketsReward: Option[Long],
  ticketsRewardType: Option[String],
  specialOfferType: Option[RetailerOfferResponse.SpecialOfferType.Value],
  ...
  locations: Option[List[Map[String, JsObject]]],
  returning: Option[String]
)

object RetailerOfferResponse {
  implicit lazy val retailerOfferResponseJsonFormat: Format[RetailerOfferResponse] = Json.format[RetailerOfferResponse]
