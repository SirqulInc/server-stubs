...
/**
  * Represents the Swagger definition for RetailerResponse.
  */
...
object RetailerResponse {
  implicit lazy val retailerResponseJsonFormat: Format[RetailerResponse] = Json.format[RetailerResponse]
}
