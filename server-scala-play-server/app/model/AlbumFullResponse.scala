...
/**
  * Represents the Swagger definition for AlbumFullResponse.
  */
...
case class AlbumFullResponse(
  ...
  tags: Option[String],
  visibility: Option[AlbumFullResponse.Visibility.Value],
  ...
  approvalStatus: Option[AlbumFullResponse.ApprovalStatus.Value],
...
object AlbumFullResponse {
  implicit lazy val albumFullResponseJsonFormat: Format[AlbumFullResponse] = Json.format[AlbumFullResponse]
