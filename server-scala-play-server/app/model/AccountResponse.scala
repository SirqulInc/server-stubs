...
/**
  * Represents the Swagger definition for AccountResponse.
  */
...
case class AccountResponse(
  ...
  gender: Option[AccountResponse.Gender.Value],
...
object AccountResponse {
  implicit lazy val accountResponseJsonFormat: Format[AccountResponse] = Json.format[AccountResponse]
