...
trait ParticipantsApi {
  /**
    ...
    */
  def processAllParticipants(accountId: Long, appKey: Option[String], useShortNameAsID: Option[Boolean]): SirqulResponse
  ...
  /**
    ...
    */
  def processParticipants(accountId: Long, league: String, appKey: Option[String], useShortNameAsID: Option[Boolean], file: Option[TemporaryFile]): SirqulResponse
}
