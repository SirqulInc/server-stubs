...
trait CarrierApi {
  /**
    ...
    */
  def searchCarriers(keyword: Option[String], descending: Option[Boolean], start: Option[Int], limit: Option[Int], activeOnly: Option[Boolean]): List[CellCarrierResponse]
}
