...
trait NotificationApi {
  /**
    ...
    */
  def createNotificationTemplate(accountId: Long, conduit: String, title: String, body: String, appKey: Option[String], event: Option[String], tags: Option[String]): NotificationTemplateResponse
  ...
  /**
    ...
    * @param accountId the account id of the user
    */
  def createOrUpdateBlockedNotifications(appKey: String, data: String, accountId: Option[Long]): BlockedNotificationResponse
  ...
  /**
    ...
    */
  def deleteNotificationTemplate(accountId: Long, notificationTemplateId: Long): NotificationTemplateResponse
  ...
  /**
    ...
    */
  def getNotificationTemplate(accountId: Long, notificationTemplateId: Long): NotificationTemplateResponse
  ...
  /**
    ...
    * @param longitude Longitude used to update the user&#39;s current location
    */
  def registerNotificationToken(token: String, pushType: String, deviceId: Option[String], accountId: Option[Long], environment: Option[String], appKey: Option[String], gameType: Option[String], active: Option[Boolean], latitude: Option[Double], longitude: Option[Double]): SirqulResponse
  ...
  /**
    ...
    */
  def searchNotificationTemplate(accountId: Long, sortField: String, descending: Boolean, start: Int, limit: Int, appKey: Option[String], event: Option[String], conduit: Option[String], globalOnly: Option[Boolean], reservedOnly: Option[Boolean], keyword: Option[String]): NotificationTemplateResponse
  ...
  /**
    ...
    */
  def searchRecipients(sortField: String, deviceId: Option[String], accountId: Option[Long], appKey: Option[String], conduit: Option[String], keyword: Option[String], audienceId: Option[Long], audienceIds: Option[String], connectionGroupIds: Option[String], recipientAccountIds: Option[String], descending: Option[Boolean], start: Option[Int], limit: Option[Int]): List[NotificationRecipientResponse]
  ...
  /**
    ...
    * @param limit limit of the pagination
    */
  def searchRecipientsCount(deviceId: Option[String], accountId: Option[Long], appKey: Option[String], conduit: Option[String], keyword: Option[String], audienceId: Option[Long], audienceIds: Option[String], connectionGroupIds: Option[String], sortField: Option[String], descending: Option[Boolean], start: Option[Int], limit: Option[Int]): NotificationRecipientResponseListResponse
  ...
  /**
    ...
    */
  def sendBatchNotifications(accountId: Long, appKey: String, customMessage: String, conduit: Option[String], contentId: Option[Long], contentName: Option[String], contentType: Option[String], parentId: Option[Long], parentType: Option[String]): SirqulResponse
  ...
  /**
    ...
    */
  def updateNotificationTemplate(accountId: Long, notificationTemplateId: Long, title: Option[String], body: Option[String], tags: Option[String]): NotificationTemplateResponse
}
