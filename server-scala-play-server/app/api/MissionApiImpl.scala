...
class MissionApiImpl extends MissionApi {
  ...
  /**
    * @inheritdoc
    */
  override def deleteMission(accountId: Long, missionId: Long): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getMission(accountId: Long, missionId: Long, returnCreative: Option[Boolean]): MissionResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def importMission(accountId: Long, latitude: Double, longitude: Double, appKey: String, keyword: Option[String], start: Option[Int], limit: Option[Int], adSize: Option[String]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def searchMissionFormats(start: Int, limit: Int, activeOnly: Boolean): List[MissionFormatResponse] = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def searchMissionsByBillableEntity(accountId: Long, keyword: Option[String], start: Option[Int], limit: Option[Int], includeGameData: Option[Boolean], includeAudiences: Option[Boolean], includeInactive: Option[Boolean], suffix: Option[String], sortField: Option[String], descending: Option[Boolean]): List[MissionResponse] = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def updateMission(accountId: Long, missionId: Long, title: Option[String], description: Option[String], subType: Option[String], metaData: Option[String], startDate: Option[Long], endDate: Option[Long], active: Option[Boolean], gameLevelIds: Option[String], creativeIds: Option[String], audienceIds: Option[String], offerId: Option[Long], balance: Option[Double], advancedReporting: Option[Boolean], allocateTickets: Option[Boolean], ticketCount: Option[Long], ticketType: Option[String], points: Option[Long], applicationIds: Option[String], devices: Option[String], deviceIds: Option[String], deviceVersions: Option[String], locations: Option[String], radius: Option[String]): MissionResponse = {
    // TODO: Implement better logic
