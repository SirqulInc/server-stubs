...
trait ReservationApi {
  /**
    ...
    */
  def createReservation(deviceId: Option[String], accountId: Option[Long], startDate: Option[Long], endDate: Option[Long], offerId: Option[Long], offerLocationId: Option[Long], appKey: Option[String], metaData: Option[String]): Unit
  ...
  /**
    ...
    * @param accountId The account id of the user (deviceId or accountId required)
    */
  def deleteReservation(reservationId: Long, deviceId: Option[String], accountId: Option[Long]): Unit
  ...
  /**
    ...
    */
  def reservableAvailability(reservableId: Long, reservableType: String, deviceId: Option[String], accountId: Option[Long], availability: Option[String], availabilitySummary: Option[String]): List[AvailabilityResponse]
  ...
  /**
    ...
    */
  def searchAvailability(reservableId: Long, reservableType: String, deviceId: Option[String], accountId: Option[Long], startDate: Option[Long], endDate: Option[Long], start: Option[Int], limit: Option[Int]): List[AvailabilityResponse]
  ...
  /**
    ...
    * @param limit the limit of the index and/or pagination
    */
  def searchReservations(deviceId: Option[String], appKey: Option[String], accountId: Option[Long], filterAccountId: Option[Long], reservableId: Option[Long], reservableType: Option[String], keyword: Option[String], startDate: Option[Long], endDate: Option[Long], start: Option[Int], limit: Option[Int]): List[ReservationResponse]
  ...
  /**
    ...
    */
  def searchSchedule(reservableId: Long, reservableType: String, startDate: Long, endDate: Long, deviceId: Option[String], accountId: Option[Long], timeBucketMins: Option[Int]): List[TimeSlotResponse]
}
