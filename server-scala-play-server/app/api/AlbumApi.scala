...
trait AlbumApi {
  ...
  /**
    ...
    */
  def addAlbumUsers(albumId: Long, includeFriendGroup: Boolean, deviceId: Option[String], accountId: Option[Long], read: Option[Boolean], write: Option[Boolean], delete: Option[Boolean], add: Option[Boolean], connections: Option[String], connectionGroups: Option[String]): SirqulResponse
  ...
  /**
    ...
    */
  def approveAlbum(albumId: Long, deviceId: Option[String], accountId: Option[Long], approvalStatus: Option[String], verified: Option[Boolean]): SirqulResponse
  ...
  /**
    ...
    */
  def getAlbumCollection(returnNulls: Boolean, albumId: Long, deviceId: Option[String], accountId: Option[Long], likePreviewSize: Option[Int], assetPreviewSize: Option[Int], notePreviewSize: Option[Int], connectionPreviewSize: Option[Int], audiencePreviewSize: Option[Int]): AlbumFullResponse
  ...
  /**
    ...
    * @param accountId the account ID of the user (deviceId or accountId required)
    */
  def leaveAlbum(albumId: Long, deviceId: Option[String], accountId: Option[Long]): SirqulResponse
  ...
  /**
    ...
    * @param accountId the account ID of the user (deviceId or accountId required)
    */
  def removeAlbum(albumId: Long, deviceId: Option[String], accountId: Option[Long]): SirqulResponse
  ...
  /**
    ...
    * @param connectionGroups comma separated list of connection group IDs
    */
  def removeAlbumUsers(albumId: Long, removeFriendGroup: Boolean, deviceId: Option[String], accountId: Option[Long], connections: Option[String], connectionGroups: Option[String]): SirqulResponse
