...
trait TerritoryApi {
  /**
    ...
    */
  def createTerritory(accountId: Long, name: String, active: Option[Boolean]): TerritoryResponse
  ...
  /**
    ...
    */
  def deleteTerritory(accountId: Long, territoryId: Long): SirqulResponse
  ...
  /**
    ...
    */
  def getTerritory(territoryId: Long): TerritoryResponse
  ...
  /**
    ...
    */
  def searchTerritories(sortField: String, descending: Boolean, keyword: Option[String], start: Option[Int], limit: Option[Int]): List[TerritoryResponse]
  ...
  /**
    ...
    */
  def updateTerritory(accountId: Long, territoryId: Long, name: Option[String], active: Option[Boolean]): TerritoryResponse
}
