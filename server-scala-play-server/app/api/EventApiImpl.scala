...
class EventApiImpl extends EventApi {
  /**
    * @inheritdoc
    */
  override def attendEvent(deviceId: Option[String], accountId: Option[Long], appKey: Option[String], listingId: Option[Long], retailerLocationId: Option[Long], offerLocationId: Option[Long], transactionId: Option[Long], status: Option[Int], latitude: Option[Double], longitude: Option[Double]): OfferResponse = {
  ...
  /**
    * @inheritdoc
    */
  override def deleteEvent(accountId: Long, eventId: Long): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getEvent(accountId: Long, eventId: Long): OfferResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def searchEvents(accountId: Long, keyword: Option[String], activeOnly: Option[Boolean], categoryIds: Option[String], filterIds: Option[String], offerAudienceIds: Option[String], transactionAudienceIds: Option[String], sortField: Option[String], descending: Option[Boolean], startDate: Option[Long], endDate: Option[Long], start: Option[Int], limit: Option[Int]): List[OfferShortResponse] = {
    // TODO: Implement better logic
