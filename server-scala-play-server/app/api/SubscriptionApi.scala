...
trait SubscriptionApi {
  /**
    ...
    */
  def createSubscription(accountId: Long, planId: Option[Long], promoCode: Option[String]): SubscriptionResponse
  ...
  /**
    ...
    */
  def deleteSubscription(accountId: Long): SirqulResponse
  ...
  /**
    ...
    */
  def getSubscription(accountId: Long): SubscriptionResponse
  ...
  /**
    ...
    */
  def getSubscriptionPlan(planId: Long): SubscriptionPlanResponse
  ...
  /**
    ...
    */
  def getSubscriptionPlans(visible: Option[Boolean], role: Option[String]): List[SubscriptionPlanResponse]
  ...
  /**
    ...
    */
  def getSubscriptionUsage(accountId: Long, applicationId: Option[Long], start: Option[Long], end: Option[Long]): ApplicationUsageResponse
  ...
  /**
    ...
    */
  def updateSubscription(accountId: Long, planId: Option[Long], promoCode: Option[String], active: Option[Boolean]): SubscriptionResponse
}
