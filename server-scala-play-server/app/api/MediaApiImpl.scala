...
class MediaApiImpl extends MediaApi {
  ...
  /**
    * @inheritdoc
    */
  override def deleteMedia(accountId: Long, mediaId: Long): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getMedia(accountId: Long, mediaId: Long): MediaOfferResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def searchMedia(accountId: Long, activeOnly: Boolean, sortField: String, descending: Boolean, keyword: Option[String], categoryIds: Option[String], filterIds: Option[String], start: Option[Int], limit: Option[Int]): List[MediaOfferResponse] = {
    // TODO: Implement better logic
