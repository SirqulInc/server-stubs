...
class AlbumApiImpl extends AlbumApi {
  ...
  /**
    * @inheritdoc
    */
  override def addAlbumUsers(albumId: Long, includeFriendGroup: Boolean, deviceId: Option[String], accountId: Option[Long], read: Option[Boolean], write: Option[Boolean], delete: Option[Boolean], add: Option[Boolean], connections: Option[String], connectionGroups: Option[String]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def approveAlbum(albumId: Long, deviceId: Option[String], accountId: Option[Long], approvalStatus: Option[String], verified: Option[Boolean]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getAlbumCollection(returnNulls: Boolean, albumId: Long, deviceId: Option[String], accountId: Option[Long], likePreviewSize: Option[Int], assetPreviewSize: Option[Int], notePreviewSize: Option[Int], connectionPreviewSize: Option[Int], audiencePreviewSize: Option[Int]): AlbumFullResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def leaveAlbum(albumId: Long, deviceId: Option[String], accountId: Option[Long]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def removeAlbum(albumId: Long, deviceId: Option[String], accountId: Option[Long]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def removeAlbumUsers(albumId: Long, removeFriendGroup: Boolean, deviceId: Option[String], accountId: Option[Long], connections: Option[String], connectionGroups: Option[String]): SirqulResponse = {
    // TODO: Implement better logic
