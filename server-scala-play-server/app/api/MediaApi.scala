...
trait MediaApi {
  ...
  /**
    ...
    */
  def deleteMedia(accountId: Long, mediaId: Long): SirqulResponse
  ...
  /**
    ...
    */
  def getMedia(accountId: Long, mediaId: Long): MediaOfferResponse
  ...
  /**
    ...
    */
  def searchMedia(accountId: Long, activeOnly: Boolean, sortField: String, descending: Boolean, keyword: Option[String], categoryIds: Option[String], filterIds: Option[String], start: Option[Int], limit: Option[Int]): List[MediaOfferResponse]
