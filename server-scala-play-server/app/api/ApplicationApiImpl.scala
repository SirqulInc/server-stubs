...
class ApplicationApiImpl extends ApplicationApi {
  ...
  /**
    * @inheritdoc
    */
  override def createApplicationPlacement(appKey: String, size: String, deviceId: Option[String], accountId: Option[Long], name: Option[String], description: Option[String], height: Option[Int], width: Option[Int], refreshInterval: Option[Int], defaultImageId: Option[Long], active: Option[Boolean]): PlacementResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def deleteApplication(accountId: Option[Long], appKey: Option[String]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def deleteApplicationPlacement(placementId: Long, deviceId: Option[String], accountId: Option[Long]): PlacementResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getApplication(appKey: Option[String], applicationId: Option[Long]): ApplicationResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getApplicationPlacement(placementId: Long, deviceId: Option[String], accountId: Option[Long]): PlacementResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getApplicationVersions(): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getUniqueUsersByApp(appKey: String, q: Option[String], keyword: Option[String], since: Option[Long], i: Option[Int], start: Option[Int], l: Option[Int], limit: Option[Int]): AccountListResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def listApplications(accountId: Option[Long], q: Option[String], keyword: Option[String], platforms: Option[String], deviceIds: Option[String], deviceVersions: Option[String], categoryIds: Option[String], sortField: Option[String], hasAds: Option[Boolean], publicNotifications: Option[Boolean], filterBillable: Option[Boolean], filterContentAdmin: Option[Boolean], descending: Option[Boolean], i: Option[Int], start: Option[Int], l: Option[Int], limit: Option[Int], applicationIds: Option[String], hasObjectStore: Option[Boolean], activeOnly: Option[Boolean]): List[ApplicationShortResponse] = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def searchApplicationPlacement(appKey: String, deviceId: Option[String], accountId: Option[Long], start: Option[Int], limit: Option[Int]): List[PlacementResponse] = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def searchApplicationSettings(deviceId: Option[String], accountId: Option[Long], connectionAccountId: Option[Long], keyword: Option[String], sortField: Option[String], descending: Option[Boolean], start: Option[Int], limit: Option[Int]): ApplicationSettingsResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def updateApplicationActive(accountId: Long, appKey: String, active: Boolean): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def updateApplicationPlacement(placementId: Long, deviceId: Option[String], accountId: Option[Long], name: Option[String], description: Option[String], size: Option[String], height: Option[Int], width: Option[Int], refreshInterval: Option[Int], defaultImageId: Option[Long], active: Option[Boolean]): PlacementResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def uploadApplicationCertificate(appKey: String, deviceId: Option[String], accountId: Option[Long], certificate: Option[TemporaryFile]): SirqulResponse = {
    // TODO: Implement better logic
