...
class LeaderboardApiImpl extends LeaderboardApi {
  ...
  /**
    * @inheritdoc
    */
  override def deleteLeaderboard(leaderboardId: Long, accountId: Option[Long]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getLeaderboard(leaderboardId: Long, accountId: Option[Long], includeFullRankingList: Option[Boolean]): LeaderboardResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def updateLeaderboard(leaderboardId: Long, accountId: Option[Long], appKey: Option[String], rankType: Option[String], leaderboardMode: Option[String], sortField: Option[String], iconMedia: Option[TemporaryFile], iconAssetId: Option[Long], bannerMedia: Option[TemporaryFile], bannerAssetId: Option[Long], limitation: Option[Int], active: Option[Boolean], title: Option[String], description: Option[String], metaData: Option[String]): LeaderboardResponse = {
    // TODO: Implement better logic
