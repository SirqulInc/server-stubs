...
class EmployeeApiImpl extends EmployeeApi {
  /**
    * @inheritdoc
    */
  override def assignEmployee(accountId: Long, managerAccountId: Long, employeeAccountId: Long, role: Option[String]): EmployeeResponse = {
  ...
  /**
    * @inheritdoc
    */
  override def assignToLocationEmployee(accountId: Long, retailerLocationId: Long, employeeAccountId: Option[Long], assign: Option[Boolean]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def deleteEmployee(accountId: Long, employeeAccountId: Long): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getEmployee(accountId: Long, employeeAccountId: Long, settingsAppKey: Option[String]): EmployeeResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def unassignEmployee(accountId: Long, employeeAccountId: Long): EmployeeResponse = {
    // TODO: Implement better logic
