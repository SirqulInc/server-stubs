...
class PurchaseItemApiImpl extends PurchaseItemApi {
  ...
  /**
    * @inheritdoc
    */
  override def deletePurchaseItem(purchaseItemId: Long, deviceId: Option[String], accountId: Option[Long]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getPurchaseItem(purchaseItemId: Long, deviceId: Option[String], accountId: Option[Long]): PurchaseItemFullResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def searchPurchaseItems(deviceId: Option[String], accountId: Option[Long], appKey: Option[String], filterByBillable: Option[Boolean], purchaseType: Option[String], serviceAction: Option[String], keyword: Option[String], sortField: Option[String], descending: Option[Boolean], start: Option[Int], limit: Option[Int], activeOnly: Option[Boolean]): List[PurchaseItemResponse] = {
    // TODO: Implement better logic
