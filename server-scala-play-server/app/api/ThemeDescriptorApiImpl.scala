...
class ThemeDescriptorApiImpl extends ThemeDescriptorApi {
  ...
  /**
    * @inheritdoc
    */
  override def getThemeDescriptor(themeDescriptorId: Long, deviceId: Option[String], accountId: Option[Long], gameType: Option[String], latitude: Option[Double], longitude: Option[Double]): PurchaseItemListResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def removeThemeDescriptor(themeDescriptorId: Long, deviceId: Option[String], accountId: Option[Long], gameType: Option[String], latitude: Option[Double], longitude: Option[Double]): SirqulResponse = {
    // TODO: Implement better logic
