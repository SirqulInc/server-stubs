...
class RetailerApiImpl extends RetailerApi {
  ...
  /**
    * @inheritdoc
    */
  override def deleteRetailer(deviceId: Option[String], accountId: Option[Long], retailerId: Option[Long]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getRetailer(retailerId: Long, deviceId: Option[String], accountId: Option[Long], includeCounts: Option[Boolean]): RetailerFullResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getRetailers(visibility: String, sortField: String, descending: Boolean, start: Int, limit: Int, activeOnly: Boolean, deviceId: Option[String], accountId: Option[Long], q: Option[String], keyword: Option[String], categoryIds: Option[String], filterIds: Option[String], i: Option[Int], l: Option[Int]): List[RetailerResponse] = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def retailerLoginCheck(username: String, password: String, deviceId: Option[String], latitude: Option[Double], longitude: Option[Double], appKey: Option[String]): AccountLoginResponse = {
    // TODO: Implement better logic
