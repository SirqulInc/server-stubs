...
class ScheduledNotificationApiImpl extends ScheduledNotificationApi {
  ...
  /**
    * @inheritdoc
    */
  override def deleteScheduledNotification(accountId: Long, scheduledNotificationId: Long, deleteByGroupingId: Option[Boolean]): ScheduledNotificationFullResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getScheduledNotification(accountId: Long, scheduledNotificationId: Long): ScheduledNotificationFullResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def scheduleNotificationListings(accountId: Long, appKey: String, reportName: String, message: String, offset: Int, recipientReportId: Long, reportParams: Option[String], `type`: Option[String]): SirqulResponse = {
    // TODO: Implement better logic
