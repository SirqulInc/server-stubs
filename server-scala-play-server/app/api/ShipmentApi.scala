...
trait ShipmentApi {
  /**
    ...
    */
  def cancelShipment(id: Long): Unit

  /**
    * Create Shipment
    * Create new shipment
    */
  def createShipment(body: Option[Shipment]): Shipment
  ...
  /**
    ...
    */
  def deleteShipment(id: Long): Unit
  ...
  /**
    ...
    */
  def getShipment(id: Long): Shipment
  ...
  /**
    ...
    */
  def searchShipments(sortField: String, descending: Boolean, start: Int, limit: Int, activeOnly: Boolean, ownerId: Option[Long], riderId: Option[Long], routeId: Option[Long]): List[Shipment]
  ...
  /**
    ...
    */
  def updateShipment(id: Long, body: Option[Shipment]): Shipment
  ...
  /**
    ...
    */
  def updateShipmentStatus(id: Long, body: Option[Map[String, Boolean]]): Unit
}
