...
class OfferApiImpl extends OfferApi {
  /**
    * @inheritdoc
    */
  override def batchUpdateOfferLocations(data: String, deviceId: Option[String], accountId: Option[Long]): SirqulResponse = {
  ...
  /**
    * @inheritdoc
    */
  override def deleteOffer(offerId: Long, deviceId: Option[String], accountId: Option[Long]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def deleteOfferLocation(offerLocationId: Long, deviceId: Option[String], accountId: Option[Long]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getOffer(offerId: Long, includeOfferLocations: Boolean, deviceId: Option[String], accountId: Option[Long]): RetailerOfferResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getOfferDetails(deviceId: Option[String], accountId: Option[Long], offerId: Option[Long], offerLocationId: Option[Long], distance: Option[Double], latitude: Option[Double], longitude: Option[Double], includeOfferLocations: Option[Boolean], includeRetailerLocations: Option[Boolean], includeChildOffers: Option[Boolean]): OfferResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getOfferListCounts(latitude: Double, longitude: Double, searchRange: Option[BigDecimal], distanceUnit: Option[String]): ListCountResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getOfferLocation(offerLocationId: Option[Long], udid: Option[String]): OfferShortResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def redeemOfferTransaction(offerTransactionId: Long, status: Int, deviceId: Option[String], accountId: Option[Long], offerLocationId: Option[Long]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def topOfferTransactions(start: Option[Int], limit: Option[Int]): OfferListResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def updateOfferStatus(offerIds: String, active: Boolean, deviceId: Option[String], accountId: Option[Long]): SirqulResponse = {
    // TODO: Implement better logic
