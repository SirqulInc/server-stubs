...
class NoteApiImpl extends NoteApi {
  /**
    * @inheritdoc
    */
  override def batchOperation(notableId: Long, notableType: String, deviceId: Option[String], accountId: Option[Long], batchOperation: Option[String]): SirqulResponse = {
  ...
  /**
    * @inheritdoc
    */
  override def deleteNote(noteId: Long, deviceId: Option[String], accountId: Option[Long], latitude: Option[Double], longitude: Option[Double], appKey: Option[String]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getNote(noteId: Long, deviceId: Option[String], accountId: Option[Long], returnFullResponse: Option[Boolean]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def searchNotes(deviceId: Option[String], accountId: Option[Long], notableType: Option[String], notableId: Option[Long], noteTypes: Option[String], appKey: Option[String], keyword: Option[String], flagCountMinimum: Option[Long], flagsExceedThreshold: Option[Boolean], includeInactive: Option[Boolean], sortField: Option[String], descending: Option[Boolean], returnFullResponse: Option[Boolean], updatedSince: Option[Long], updatedBefore: Option[Long], start: Option[Int], limit: Option[Int]): List[NoteResponse] = {
    // TODO: Implement better logic
