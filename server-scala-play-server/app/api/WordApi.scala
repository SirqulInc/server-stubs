...
trait WordApi {
  /**
    ...
    */
  def createWord(accountId: Long, word: String, definition: String, active: Boolean, allocateTickets: Boolean, ticketCount: Long, assetId: Option[Long], ticketType: Option[String], points: Option[Long]): WordzWordResponse
  ...
  /**
    ...
    */
  def deleteWord(wordId: Long, accountId: Long): SirqulResponse
  ...
  /**
    ...
    * @param accountId The logged in user.
    */
  def getWord(wordId: Long, accountId: Long): WordzWordResponse
  ...
  /**
    ...
    */
  def getWords(accountId: Long, sortField: String, descending: Boolean, activeOnly: Boolean, start: Int, limit: Int, keyword: Option[String]): List[WordzWordResponse]
  ...
  /**
    ...
    * @param points The number of points to award for completing a mission
    */
  def updateWord(wordId: Long, accountId: Long, ticketCount: Long, wordText: Option[String], definition: Option[String], assetId: Option[Long], active: Option[Boolean], allocateTickets: Option[Boolean], ticketType: Option[String], points: Option[Long]): WordzWordResponse
}
