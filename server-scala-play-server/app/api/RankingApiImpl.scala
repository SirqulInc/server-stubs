...
class RankingApiImpl extends RankingApi {
  /**
    * @inheritdoc
    */
  override def getHistoricalRankings(appKey: String, rankType: String, startDate: Long, endDate: Long, deviceId: Option[String], accountId: Option[Long], sortField: Option[String], descending: Option[Boolean], start: Option[Int], limit: Option[Int]): RankFullResponse = {
  ...
  /**
    * @inheritdoc
    */
  override def getUserRank(deviceId: Option[String], accountId: Option[Long], appKey: Option[String], rankType: Option[String], returnUserRank: Option[Boolean], leaderboardMode: Option[String], sortField: Option[String], keyword: Option[String], descending: Option[Boolean], start: Option[Int], limit: Option[Int]): JsObject = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def updateRankings(accountId: Long, appKey: String, rankType: String, increment: Option[Long], timeIncrement: Option[Long], tag: Option[String], startDate: Option[Long], endDate: Option[Long], updateGlobal: Option[Boolean], createLeaderboard: Option[Boolean]): SirqulResponse = {
    // TODO: Implement better logic
