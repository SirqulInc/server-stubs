...
class WalletApiImpl extends WalletApi {
  /**
    * @inheritdoc
    */
  override def createOfferTransaction(deviceId: Option[String], accountId: Option[Long], offerId: Option[Long], offerLocationId: Option[Long], offerCart: Option[String], promoCode: Option[String], currencyType: Option[String], usePoints: Option[Boolean], metaData: Option[String], appKey: Option[String], status: Option[Int]): List[OfferTransactionResponse] = {
  ...
  /**
    * @inheritdoc
    */
  override def deleteOfferTransaction(transactionId: Long, deviceId: Option[String], accountId: Option[Long]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getOfferTransaction(transactionId: Long, deviceId: Option[String], accountId: Option[Long], includeMission: Option[Boolean], latitude: Option[Double], longitude: Option[Double], returnFullResponse: Option[Boolean]): OfferTransactionResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def previewOfferTransaction(deviceId: Option[String], accountId: Option[Long], offerId: Option[Long], offerLocationId: Option[Long], offerCart: Option[String], promoCode: Option[String], currencyType: Option[String], usePoints: Option[Boolean], metaData: Option[String], appKey: Option[String]): List[OfferTransactionResponse] = {
    // TODO: Implement better logic
