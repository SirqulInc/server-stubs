...
class AccountApiImpl extends AccountApi {
  ...
  /**
    * @inheritdoc
    */
  override def blockAccount(accountIdBeingBlocked: Long, deviceId: Option[String], accountId: Option[Long], blockFlagValue: Option[Boolean], removeFromGroupsIfBlocked: Option[Boolean], latitude: Option[Double], longitude: Option[Double]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def editUsername(deviceId: Option[String], accountId: Option[Long], emailAddress: Option[String], username: Option[String]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getReferralList(accountId: Option[Long], appKey: Option[String], retrieveType: Option[String], levelLimit: Option[BigDecimal], ancestorLevelLimit: Option[BigDecimal], childrenLevelLimit: Option[BigDecimal], ancestorListStart: Option[BigDecimal], ancestorListLimit: Option[BigDecimal], childrenListStart: Option[BigDecimal], childrenListLimit: Option[BigDecimal], childrenChildren: Option[Boolean]): Unit = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getSettings(deviceId: Option[String], accountId: Option[Long], latitude: Option[Double], longitude: Option[Double]): UserSettingsResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def loginDelegate(accessToken: String, appKey: String, deviceId: Option[String], accessTokenSecret: Option[String], delegatedAccountId: Option[Long], delegatedUsername: Option[String], networkUID: Option[String], ageRestriction: Option[Int], responseFilters: Option[String], latitude: Option[Double], longitude: Option[Double]): ProfileResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def loginGeneral(accessToken: String, networkUID: String, appKey: String, deviceId: Option[String], deviceIdType: Option[String], accessTokenSecret: Option[String], ageRestriction: Option[Int], responseFilters: Option[String], latitude: Option[Double], longitude: Option[Double], emailMatch: Option[Boolean], chosenAccountId: Option[Long], thirdPartyCredentialId: Option[Long]): ProfileResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def loginUsername(username: String, password: String, deviceId: Option[String], latitude: Option[Double], longitude: Option[Double], app: Option[String], gameType: Option[String], appKey: Option[String], returnProfile: Option[Boolean], responseFilters: Option[String]): ProfileResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def logout(deviceId: Option[String], deviceIdType: Option[String], accountId: Option[Long], latitude: Option[Double], longitude: Option[Double]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def mergeAccount(mergeAccountId: Long, appKey: String, deviceId: Option[String], accountId: Option[Long]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def passwordChange(accountId: Long, oldPassword: String, newPassword: String, confirmPassword: String): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def passwordReset(token: String, password: String, confirm: String): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def requestPasswordReset(email: String, from: Option[String], domain: Option[String], subUrl: Option[String], referer: Option[String]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def requestValidateAccount(accountId: Long): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def secureLogin(username: String, password: String, gameType: String, deviceId: Option[String], charsetName: Option[String], latitude: Option[Double], longitude: Option[Double], returnProfile: Option[Boolean], responseFilters: Option[String]): ProfileResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def setMatchToken(deviceId: Option[String], accountId: Option[Long], matchToken: Option[String], gameType: Option[String], appKey: Option[String], latitude: Option[Double], longitude: Option[Double]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def updateActveStatus(accountId: Long, connectionAccountId: Long, active: Boolean, deviceId: Option[String], appKey: Option[String]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def updateLocation(deviceId: Option[String], accountId: Option[Long], latitude: Option[Double], longitude: Option[Double], clientTime: Option[Long]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def validateAccountSignup(token: String): AccountLoginResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def validatePasswordReset(token: String): SirqulResponse = {
    // TODO: Implement better logic
