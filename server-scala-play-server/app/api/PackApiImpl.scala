...
class PackApiImpl extends PackApi {
  ...
  /**
    * @inheritdoc
    */
  override def deletePack(accountId: Long, packId: Long): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getPack(accountId: Long, packId: Long, includeGameData: Boolean): PackResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def searchPacks(accountId: Long, sortField: String, descending: Boolean, keyword: Option[String], packType: Option[String], start: Option[Int], limit: Option[Int], includeGameData: Option[Boolean], includeInactive: Option[Boolean], appKey: Option[String]): List[PackResponse] = {
    // TODO: Implement better logic
