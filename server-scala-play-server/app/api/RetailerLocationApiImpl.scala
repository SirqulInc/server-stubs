...
class RetailerLocationApiImpl extends RetailerLocationApi {
  ...
  /**
    * @inheritdoc
    */
  override def deleteRetailerLocation(deviceId: Option[String], accountId: Option[Long], retailerLocationId: Option[Long]): SirqulResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getRetailerLocation(retailerLocationId: Long, deviceId: Option[String], accountId: Option[Long], retailerLocationToken: Option[String]): RetailerLocationResponse = {
    // TODO: Implement better logic
  ...
  /**
    * @inheritdoc
    */
  override def getRetailerLocationConsumer(retailerLocationId: Long, deviceId: Option[String], accountId: Option[Long]): RetailerLocationResponse = {
    // TODO: Implement better logic
