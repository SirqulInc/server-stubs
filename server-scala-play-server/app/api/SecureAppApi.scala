...
trait SecureAppApi {
  /**
    ...
    */
  def createSecureApplication(accountId: Long, appKey: String, keyCert: TemporaryFile, trustStore: TemporaryFile, username: String, password: String, active: Option[Boolean], biometricType: Option[String], biometricPosition: Option[String], biometricPosition2: Option[String]): SirqulResponse
  ...
  /**
    ...
    * @param appKey The application to secure
    */
  def deleteSecureApplication(accountId: Long, appKey: String): SirqulResponse
  ...
  /**
    ...
    */
  def loginSecure(appKey: String, biometricFile: TemporaryFile, deviceId: Option[String], biometricFile2: Option[TemporaryFile], ageRestriction: Option[Int], returnProfile: Option[Boolean], responseFilters: Option[String], latitude: Option[Double], longitude: Option[Double]): ProfileResponse
  ...
  /**
    ...
    */
  def purchaseSecure(body: PaymentRequest): ProfileResponse
  ...
  /**
    ...
    * @param appKey The application to secure
    */
  def resetSecure(accountId: Long, appKey: String): SirqulResponse
  ...
  /**
    ...
    * @param biometricPosition2 The position for each the biometric2 file uploaded
    */
  def updateSecureApplication(accountId: Long, appKey: String, active: Option[Boolean], keyCert: Option[TemporaryFile], trustStore: Option[TemporaryFile], username: Option[String], password: Option[String], biometricType: Option[String], biometricPosition: Option[String], biometricPosition2: Option[String]): SirqulResponse
}
