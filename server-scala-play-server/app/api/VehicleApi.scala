...
trait VehicleApi {
  /**
    ...
    */
  def createVehicle(vehicle: String, body: Option[Vehicle]): Vehicle
  ...
  /**
    ...
    */
  def searchVehicle(hubId: Long, sortField: String, descending: Boolean, start: Int, limit: Int, activeOnly: Boolean, keyword: Option[String]): List[Vehicle]
  ...
  /**
    ...
    */
  def updateVehicle(id: Long, vehicle: String, body: Option[Vehicle]): Vehicle
}
