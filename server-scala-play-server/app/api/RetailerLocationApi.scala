...
trait RetailerLocationApi {
  ...
  /**
    ...
    */
  def deleteRetailerLocation(deviceId: Option[String], accountId: Option[Long], retailerLocationId: Option[Long]): SirqulResponse
  ...
  /**
    ...
    */
  def getRetailerLocation(retailerLocationId: Long, deviceId: Option[String], accountId: Option[Long], retailerLocationToken: Option[String]): RetailerLocationResponse
  ...
  /**
    ...
    */
  def getRetailerLocationConsumer(retailerLocationId: Long, deviceId: Option[String], accountId: Option[Long]): RetailerLocationResponse
