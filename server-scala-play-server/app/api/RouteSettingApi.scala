...
trait RouteSettingApi {
  /**
    ...
    */
  def createRouteSettings(body: Option[RouteSettings]): RouteSettings
  ...
  /**
    ...
    */
  def deleteRouteSettings(routeSettingsId: Long): JsObject
  ...
  /**
    ...
    */
  def getRouteSettings(routeSettingsId: Long): RouteSettings
  ...
  /**
    ...
    */
  def searchRouteSettings(sortField: String, descending: Boolean, start: Int, limit: Int, activeOnly: Boolean, hubId: Option[Long], programId: Option[Long], keyword: Option[String]): List[RouteSettings]
  ...
  /**
    ...
    */
  def updateRouteSettings(routeSettingsId: Long, body: Option[RouteSettings]): RouteSettings
}
