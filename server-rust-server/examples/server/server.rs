...
impl<C> Api<C> for Server<C> where C: Has<XSpanIdString> + Send + Sync
{
    ...
    {
        info!("consumer_create(\"{}\", \"{}\", \"{}\", \"{}\", \"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, name, hostname, username, password, data_mapping, device_id, account_id, port, virtual_host, exchanger, exchanger_type, workers, use_ssl, context.get().0.clone());
    ...
    {
        info!("consumer_update(\"{}\", {}, \"{}\", {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, queue_id, data_mapping, device_id, account_id, use_ssl, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("queue_create(\"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, name, device_id, account_id, workers, analytic_tags, hostname, port, username, password, virtual_host, use_ssl, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("queue_delete({}, {:?}, {:?}) - X-Span-ID: {:?}", queue_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("queue_get({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, queue_id, app_key, name, hostname, virtual_host, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("queue_publish(\"{}\", {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", message, queue_id, app_key, name, hostname, virtual_host, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("queue_search({:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", queue_id, device_id, account_id, name, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("queue_update({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", queue_id, device_id, account_id, app_key, workers, analytic_tags, hostname, port, username, password, virtual_host, use_ssl, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("block_account({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id_being_blocked, device_id, account_id, block_flag_value, remove_from_groups_if_blocked, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("edit_username({:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, email_address, username, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_account({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", return_nulls, device_id, account_id, connection_account_email, connection_account_id, response_filters, game_type, app_key, purchase_type, update_viewed_date, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_profile_assets({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", return_nulls, device_id, account_id, owner_id, media_types, mime_types, sort_field, descending, latitude, longitude, _i, start, _l, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_referral_list({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, retrieve_type, level_limit, ancestor_level_limit, children_level_limit, ancestor_list_start, ancestor_list_limit, children_list_start, children_list_limit, children_children, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_settings({:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("login_delegate(\"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", access_token, app_key, device_id, access_token_secret, delegated_account_id, delegated_username, network_uid, age_restriction, response_filters, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("login_general(\"{}\", \"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", access_token, network_uid, app_key, device_id, device_id_type, access_token_secret, age_restriction, response_filters, latitude, longitude, email_match, chosen_account_id, third_party_credential_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("login_username(\"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", username, password, device_id, latitude, longitude, app, game_type, app_key, return_profile, response_filters, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("logout({:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, device_id_type, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("merge_account({}, \"{}\", {:?}, {:?}) - X-Span-ID: {:?}", merge_account_id, app_key, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("password_change({}, \"{}\", \"{}\", \"{}\") - X-Span-ID: {:?}", account_id, old_password, new_password, confirm_password, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("password_reset(\"{}\", \"{}\", \"{}\") - X-Span-ID: {:?}", token, password, confirm, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("request_password_reset(\"{}\", {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", email, from, domain, sub_url, referer, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("request_validate_account({}) - X-Span-ID: {:?}", account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_accounts({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, keyword, latitude, longitude, radius, gender, game_experience, age, category_ids, return_nulls, response_filters, purchase_type, sort_field, descending, start, limit, active_only, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("secure_login(\"{}\", \"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", username, password, game_type, device_id, charset_name, latitude, longitude, return_profile, response_filters, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("set_match_token({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, match_token, game_type, app_key, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_actve_status({}, {}, {}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, connection_account_id, active, device_id, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_location({:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, latitude, longitude, client_time, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_settings({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, blocked_notifications, suggestion_method, suggestion_count, suggestion_time_frame, show_others_exact_location, show_as_zipcode, show_exact_location, favorite_visibility, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("validate_account_signup(\"{}\") - X-Span-ID: {:?}", token, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("validate_password_reset(\"{}\") - X-Span-ID: {:?}", token, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("achievement_tier_search_post({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, app_key, keyword, achievement_type, rank_type, sort_field, descending, descending_goal, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_achievement(\"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, title, device_id, account_id, analytics_tag, description, rank_type, rank_increment, min_increment, max_increment, validate, active, trigger_definition, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_achievement_tier({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", achievement_id, score_all_instances, device_id, account_id, icon, icon_asset_id, title, description, goal_count, mission_id, game_id, pack_id, game_level_id, game_object_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_achievement({}, {:?}) - X-Span-ID: {:?}", achievement_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_achievement_tier({}, {:?}) - X-Span-ID: {:?}", achievement_tier_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_achievement({}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", achievement_id, device_id, account_id, achievement_type, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_achievement_tier({}, {}) - X-Span-ID: {:?}", account_id, achievement_tier_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_user_achievements({}, \"{}\", {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", return_nulls, app_key, include_undiscovered, device_id, account_id, connection_account_email, connection_account_id, rank_type, achievement_type, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("list_achievement_tags({:?}) - X-Span-ID: {:?}", app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("list_achievements({:?}, {}, {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", sort_field, descending, start, limit, active_only, device_id, account_id, app_key, keyword, achievement_type, rank_type, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_achievements(\"{}\", {:?}, {}, {}, {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, sort_field, descending, include_tiers, include_inactive_tiers, start, limit, device_id, account_id, keyword, achievement_type, rank_type, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_achievement({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, achievement_id, analytics_tag, title, description, rank_type, rank_increment, min_increment, null_min_increment, max_increment, null_max_increment, validate, active, trigger_definition, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_achievement_tier({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", achievement_tier_id, device_id, account_id, icon, icon_asset_id, title, description, goal_count, mission_id, game_id, pack_id, game_level_id, game_object_id, score_all_instances, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_user_achievement({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, achievement_id, tag, custom_id, increment, start_date, end_date, return_progress, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_entity_reference({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("add_album_collection(\"{}\", {}, {}, {}, {}, {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", title, cover_asset_nullable, include_cover_in_asset_list, public_read, public_write, public_delete, public_add, anonymous, device_id, account_id, assets_to_add, media, media_url, asset_id, attached_media, attached_media_url, start_date, end_date, tags, description, album_type, album_type_id, sub_type, latitude, longitude, location_description, visibility, game_type, app_key, cell_phone, street_address, street_address2, city, state, postal_code, full_address, meta_data, category_ids, category_filter_ids, audience_ids, include_all_app_users_as_members, include_audiences_as_members, audience_operator, approval_status, linked_object_type, linked_object_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("add_album_users({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", album_id, include_friend_group, device_id, account_id, read, write, delete, add, connections, connection_groups, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("approve_album({}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", album_id, device_id, account_id, approval_status, verified, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_album_collection({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", return_nulls, album_id, device_id, account_id, like_preview_size, asset_preview_size, note_preview_size, connection_preview_size, audience_preview_size, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("leave_album({}, {:?}, {:?}) - X-Span-ID: {:?}", album_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("remove_album({}, {:?}, {:?}) - X-Span-ID: {:?}", album_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("remove_album_users({}, {}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", album_id, remove_friend_group, device_id, account_id, connections, connection_groups, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_album_collection({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", album_id, device_id, account_id, assets_to_add, assets_to_remove, asset_id, media, media_url, active, title, start_date, end_date, tags, description, album_type, album_type_id, sub_type, public_read, public_write, public_delete, public_add, latitude, longitude, location_description, visibility, cell_phone, street_address, street_address2, city, state, postal_code, full_address, anonymous, meta_data, category_ids, category_filter_ids, audience_ids, audience_ids_to_add, audience_ids_to_remove, include_all_app_users_as_members, include_audiences_as_members, audience_operator, linked_object_type, linked_object_id, index_now, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("activities({}, {}, {}) - X-Span-ID: {:?}", start, limit, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("aggregated_filtered_usage({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, application_id, app_key, start_date, end_date, device_type, device, device_os, gender, age_group, country, state, city, zip, model, tag, user_account_id, user_account_display, user_account_username, group_by_root, group_by, distinct_count, sort_field, descending, hide_unknown, response_format, _l, limit, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("filtered_usage({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, application_id, app_key, start_date, end_date, device_type, device, device_os, gender, age_group, country, state, city, zip, model, tag, user_account_id, user_account_display, user_account_username, custom_id, custom_type, custom_value, custom_value2, custom_long, custom_long2, custom_message, custom_message2, group_by, distinct_count, sum_column, sort_field, descending, hide_unknown, response_format, _l, limit, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("usage(\"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", tag, device_id, account_id, application_id, app_key, app_version, device, device_type, device_os, model, latitude, longitude, custom_id, custom_type, achievement_increment, city, state, country, zip, location_description, client_time, error_message, ip, user_agent, background_event, custom_message, custom_message2, custom_value, custom_value2, custom_long, custom_long2, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("usage_batch(\"{}\", \"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, device, data, device_id, account_id, app_version, device_type, device_os, model, update_ranking, return_summary_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_app_data({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", start, limit, device_id, account_id, game_type, include_game_data, q, keyword, sort_field, descending, _i, _l, game_object_count, filter, date_created, owner_id, mission_ids, game_ids, pack_ids, game_level_ids, app_version, include_higher_version_packs, include_higher_version_levels, response_groups, purchase_type, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("post_app_data(\"{}\", {}, {}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", game_type, start, limit, data, device_id, account_id, include_game_data, q, keyword, sort_field, descending, _i, _l, game_object_count, filter, date_created, owner_id, mission_ids, game_ids, pack_ids, game_level_ids, app_version, include_higher_version_packs, include_higher_version_levels, response_groups, purchase_type, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("regen_app_data({:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, build_version, api_version, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_application_placement(\"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, size, device_id, account_id, name, description, height, width, refresh_interval, default_image_id, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_application({:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_application_placement({}, {:?}, {:?}) - X-Span-ID: {:?}", placement_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_application({:?}, {:?}) - X-Span-ID: {:?}", app_key, application_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_application_placement({}, {:?}, {:?}) - X-Span-ID: {:?}", placement_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_application_versions() - X-Span-ID: {:?}", context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_unique_users_by_app(\"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, q, keyword, since, _i, start, _l, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("list_applications({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, q, keyword, platforms, device_ids, device_versions, category_ids, sort_field, has_ads, public_notifications, filter_billable, filter_content_admin, descending, _i, start, _l, limit, application_ids, has_object_store, active_only, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_application_placement(\"{}\", {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, device_id, account_id, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_application_settings({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, connection_account_id, keyword, sort_field, descending, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_applications({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, latitude, longitude, q, keyword, q_search_fields, sort_field, descending, _i, start, _l, limit, has_ads, public_notifications, active_only, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_application(\"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, app_name, device_id, account_id, about, bundle_id, app_icon_asset_id, app_logo_asset_id, facebook_app_id, facebook_app_secret, google_api_key, update_eula_date, eula_version, landing_page_url, show_in_activities, activity_description, invite_welcome_text, invite_page_url, url_scheme, platforms, download_urls, category_ids, scoring_type, hint_cost, max_score, tickets_per_point, has_game_data, public_notifications, use_matching_algorithm, global_tickets, build_version, api_version, placement_name, placement_description, placement_size, placement_height, placement_width, placement_refresh_interval, create_object_store, public_content_approval, production_mode, minimum_session_length, session_gap_length, local_ads_enabled, sqoot_api_key, trilat_processing_type, max_sample_size, min_rssi, modules, authorized_count, authorized_servers, default_timezone, smtp_pass, meta_data, placement_meta_data, ips_floor, enable_apns_badge, include_in_report, default_app_filter_id, enable_welcome_email, apple_app_id, apple_team_id, apple_auth_key_id, apple_auth_key, apple_issuer_id, app_store_key_id, app_store_key, google_private_key_file, authorize_net_api_key, authorize_net_transaction_key, email_sender, smtp_user, smtp_host, vatom_business_id, vatom_rest_client_id, vatom_rest_secret_key, twilio_account_sid, twilio_auth_token, twilio_sender_phone_number, open_ai_secret_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_application_active({}, \"{}\", {}) - X-Span-ID: {:?}", account_id, app_key, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_application_placement({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", placement_id, device_id, account_id, name, description, size, height, width, refresh_interval, default_image_id, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("upload_application_certificate(\"{}\", {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, device_id, account_id, certificate, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_application_config({}, \"{}\", \"{}\", {}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, config_version, asset_id, retailer_id, retailer_location_id, udid, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_application_config({}, {}) - X-Span-ID: {:?}", account_id, config_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_application_config({}, {}) - X-Span-ID: {:?}", account_id, config_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_application_config_by_config_version(\"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, config_version, retailer_id, retailer_location_id, udid, allow_older_versions, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_application_config({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, retailer_id, retailer_location_id, udid, config_version, sort_field, descending, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_application_config({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, config_id, app_key, config_version, asset_id, retailer_id, retailer_location_id, udid, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("asset_morph({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", offer_id, ad_size, creative_id, width, height, background_size, template, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_asset(\"{}\", {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", asset_id, device_id, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_asset({}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", asset_id, device_id, account_id, note_descending, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("remove_asset(\"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", asset_id, device_id, account_id, album_id, collection_id, remove_from_default_albums, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_assets({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, album_ids, asset_ids, app_key, media_type, mime_type, keyword, version_code, version_name, updated_since, updated_before, sort_field, descending, search_media_library, filter_by_billable, active_only, return_app, start, limit, search_mode, asset_type, approval_status, assigned_account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_asset({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", asset_id, device_id, account_id, album_id, attached_asset_id, version_code, version_name, meta_data, caption, asset_type, approval_status, assigned_account_id, media, media_url, media_string, media_string_file_name, media_string_content_type, media_height, media_width, attached_media, attached_media_url, attached_media_string, attached_media_string_file_name, attached_media_string_content_type, attached_media_height, attached_media_width, location_description, search_tags, app_key, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("asset_download(\"{}\") - X-Span-ID: {:?}", filename, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("assigment_assignee_account_search({}, {:?}) - X-Span-ID: {:?}", account_id, keyword, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("assignment_create({}, \"{}\", {}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, name, assignee_account_id, description, retailer_location_id, tags, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("assignment_delete({}, {}) - X-Span-ID: {:?}", account_id, assignment_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("assignment_get({}, {}) - X-Span-ID: {:?}", account_id, assignment_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("assignment_search({}, {:?}, {}, {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, sort_field, descending, active_only, start, limit, creator_account_id, assignee_account_ids, retailer_location_ids, current_status_type, keyword, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("assignment_status_create({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, assignment_id, scheduled_notification_id, to_do, connection, method, status, closure, message, follow_up, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("assignment_status_delete({}, {}) - X-Span-ID: {:?}", account_id, assignment_status_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("assignment_status_get({}, {}) - X-Span-ID: {:?}", account_id, assignment_status_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("assignment_status_search({}, {:?}, {}, {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, sort_field, descending, active_only, start, limit, assignment_id, creator_account_id, assignee_account_id, retailer_location_id, status_type, keyword, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("assignment_status_update({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, assignment_status_id, scheduled_notification_id, to_do, connection, method, status, closure, message, follow_up, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("assignment_update({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, assignment_id, name, description, assignee_account_id, retailer_location_id, tags, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_audience({}, {}) - X-Span-ID: {:?}", account_id, audience_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_age_groups() - X-Span-ID: {:?}", context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_audience({}, {}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, audience_id, app_key, return_account_count, return_album_count, album_types_for_count, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_devices({}) - X-Span-ID: {:?}", include_inactive, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_experiences() - X-Span-ID: {:?}", context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_grouped_audiences({}, \"{}\") - X-Span-ID: {:?}", account_id, audience_grouping_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("list_by_account({}, {}, \"{}\") - X-Span-ID: {:?}", account_id, limit, suggestion_type, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("list_by_audience({}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", limit, gender, age, category_ids, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("list_lastest_by_account({}, {}, \"{}\") - X-Span-ID: {:?}", account_id, timeframe, suggestion_type, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("send_by_account({}, {}, {}) - X-Span-ID: {:?}", account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_bid(\"{}\", {}, {}, {}, {}, \"{}\", {:?}, {:?}) - X-Span-ID: {:?}", biddable_type, biddable_id, amount_per_view, amount_per_action, budget_amount, budget_schedule, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_bid({}, {:?}, {:?}) - X-Span-ID: {:?}", bid_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_bid({}, {:?}, {:?}) - X-Span-ID: {:?}", bid_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_bid({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", bid_id, device_id, account_id, amount_per_view, amount_per_action, budget_amount, budget_schedule, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_billable_entity({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, name, street_address, street_address2, city, state, postal_code, business_phone, business_phone_ext, authorize_net_api_key, authorize_net_transaction_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_billable_entity({:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_billable_entity({:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, include_counts, include_payments, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_billable_entity({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, name, street_address, street_address2, city, state, postal_code, business_phone, business_phone_ext, authorize_net_api_key, authorize_net_transaction_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("add_payment_method({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, payment_method_id, account_name, first_name, last_name, address, city, state, postal_code, country, phone, credit_card_number, expiration_date, ccv, account_number, bank_name, routing_number, default_payment_method, payment_method_nickname, tax_id, provider_customer_profile_id, provider_payment_profile_id, meta_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_smart_contract({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, token_name, token_symbol, payment_method_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_crypto_balance({}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, owner_account_id, payment_method_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_payment_method({}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, payment_method_id, get_current_balance, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_payment_method({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, provider, param_type, keyword, sort_field, descending, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_status_csv({}, {}, {:?}, {}, {}) - X-Span-ID: {:?}", account_id, batch_id, response_group, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("list_status_csv({}, {}, {}) - X-Span-ID: {:?}", account_id, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("status_csv({}, {}) - X-Span-ID: {:?}", account_id, batch_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("upload_csv({}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, upload_type, import_file, file_format, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_cargo_type({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_cargo_types(\"{}\", {}, {}, {}, {}, {:?}, {:?}) - X-Span-ID: {:?}", sort_field, descending, start, limit, active_only, retailer_id, hub_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_cargo_type({}) - X-Span-ID: {:?}", cargo_type_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_cargo_type({}) - X-Span-ID: {:?}", cargo_type_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_cargo_type({}, {:?}) - X-Span-ID: {:?}", cargo_type_id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_carriers({:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", keyword, descending, start, limit, active_only, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("category_distance_search({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, keyword, app_key, category_ids, parent_category_ids, root_only, sort_field, response_group, descending, start, limit, active_only, return_external, exact_match, param_type, external_type, min_offer_count, latitude, longitude, range, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_category({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, name, app_key, parent_category_id, description, param_type, asset_id, external_id, external_type, external_category_slug, sqoot_slug, active, meta_data, search_tags, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_category({}, {}) - X-Span-ID: {:?}", account_id, category_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("duplicate_category({}, {}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, category_id, app_key, parent_category_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_category({}, {:?}) - X-Span-ID: {:?}", category_id, return_external, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_categories({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, keyword, app_key, category_id, category_ids, parent_category_ids, root_only, sort_field, response_group, descending, start, limit, active_only, return_external, exact_match, param_type, external_type, exclude_external_type, min_offer_count, search_depth, search_mode, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_category({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, category_id, parent_category_id, name, description, param_type, asset_id, external_id, external_type, external_category_slug, sqoot_slug, active, meta_data, search_tags, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("add_connection_to_group({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", return_nulls, group_id, device_id, account_id, connection_id, connection_account_id, pending_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("add_connections_to_group({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", connection_group_id, device_id, account_id, connection_ids, connection_account_ids, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("add_sub_groups({}, {}, \"{}\", {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", return_nulls, group_id, sub_group_ids, device_id, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_or_update_connection({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, connection_id, connection_account_id, pending_id, group_id, game_type, app_key, is_trusted, ignore_friend_request, is_contact, is_blocked, is_following, connection_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_or_update_group({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", return_nulls, device_id, account_id, name, group_id, asset_id, connections, description, can_view_profile_info, can_view_game_info, can_view_friend_info, active, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("follow_accept({}, {}, \"{}\") - X-Span-ID: {:?}", account_id, connection_account_id, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("follow_reject({}, {}, \"{}\") - X-Span-ID: {:?}", account_id, connection_account_id, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("follow_remove({}, {}, \"{}\") - X-Span-ID: {:?}", account_id, connection_account_id, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("follow_request({}, {}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, connection_account_id, app_key, approval_needed, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("friend_accept({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", friend_account_id, notify_friend, device_id, account_id, game_type, app_key, notification_message, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("friend_reject({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", friend_account_id, device_id, account_id, game_type, app_key, notify_friend, notification_message, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("friend_remove({}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", friend_account_id, device_id, account_id, notify_friend, remove_from_groups, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("friend_request({}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", friend_account_id, device_id, account_id, game_type, app_key, notification_message, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_connection_sent_friend_requests({:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_connections({}, \"{}\", \"{}\", {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", return_nulls, filter, sort_field, descending, start, limit, device_id, account_id, connection_account_id, q, keyword, _i, _l, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_group_details({}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", combine_connections, device_id, account_id, group_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("group_search({:?}, {}, {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", sort_field, descending, active_only, start, limit, device_id, account_id, latitude, longitude, keyword, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("remove_connection_from_group({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", return_nulls, group_id, device_id, account_id, connection_id, connection_account_id, pending_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("remove_connections_from_group({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", connection_group_id, device_id, account_id, connection_ids, connection_account_ids, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("remove_group({}, {}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", return_nulls, group_id, device_id, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("remove_sub_groups({}, {}, \"{}\", {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", return_nulls, group_id, sub_group_ids, device_id, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_connections({}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", return_nulls, start, limit, device_id, account_id, q, keyword, latitude, longitude, game_type, app_key, _i, _l, sort_field, has_location, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("approve_album_contest({}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", album_contest_id, approval_status, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_contest({}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", album_contest_id, device_id, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_album_contest({}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", album_contest_id, device_id, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_album_contests(\"{}\", \"{}\", {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", filter, sort_field, descending, start, limit, device_id, account_id, game_type, app_key, app_type, contest_type, owner_id, q, keyword, _i, _l, date_created, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("vote_on_album_contest({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", album_contest_id, album_id, device_id, account_id, contest_type, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("add_preview({}, {}) - X-Span-ID: {:?}", account_id, creative_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("ads_find(\"{}\", {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, randomize, targeted_ads_only, param_type, account_id, app_version, latitude, longitude, device, device_identifier, device_version, start, limit, include_audiences, allocates_tickets, mission_ids, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_creative({}, \"{}\", {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, name, active, wait_for_asset, description, asset_image_id, action, data, suffix, param_type, balance, reference_id, app_version, mission_id, offer_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_creative({}, {}) - X-Span-ID: {:?}", account_id, creative_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_creative({}, {}) - X-Span-ID: {:?}", account_id, creative_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_creatives_by_application({}, \"{}\", {}, {}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, start, limit, mission_id, keyword, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("remove_preview({}, {}) - X-Span-ID: {:?}", account_id, creative_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_creative({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, creative_id, name, description, asset_image_id, action, data, suffix, param_type, balance, active, reference_id, app_version, mission_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create({}, {:?}) - X-Span-ID: {:?}", account_id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_dependents({}) - X-Span-ID: {:?}", account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("remove_dependent({}, {}) - X-Span-ID: {:?}", account_id, dependent_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("check_disbursements({}) - X-Span-ID: {:?}", disbursement_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_disbursement({}, {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, receiver_account_id, original_sender_account_id, amount, provider, scheduled_date, title, comment, external_id, introspection_params, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_disbursement({}, {}) - X-Span-ID: {:?}", account_id, disbursement_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_disbursements({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, receiver_account_id, statuses, providers, before_date, after_date, start, limit, active_only, external_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_disbursement({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, disbursement_id, amount, provider, scheduled_date, title, comment, external_id, retry, introspection_params, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("assign_employee({}, {}, {}, {:?}) - X-Span-ID: {:?}", account_id, manager_account_id, employee_account_id, role, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("assign_to_location_employee({}, {}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, retailer_location_id, employee_account_id, assign, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_employee({}, {}) - X-Span-ID: {:?}", account_id, employee_account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_employee({}, {}, {:?}) - X-Span-ID: {:?}", account_id, employee_account_id, settings_app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_employees({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, role, retailer_id, retailer_location_id, q, keyword, sort_field, descending, _i, start, _l, limit, active_only, managed_only, settings_app_key, category_ids, query, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("unassign_employee({}, {}) - X-Span-ID: {:?}", account_id, employee_account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("attend_event({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, app_key, listing_id, retailer_location_id, offer_location_id, transaction_id, status, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_event({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, title, retailer_location_ids, sub_title, details, category_ids, filter_ids, active, image_asset_id, redeemable_start, redeemable_end, meta_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_event({}, {}) - X-Span-ID: {:?}", account_id, event_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_event({}, {}) - X-Span-ID: {:?}", account_id, event_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_events({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, keyword, active_only, category_ids, filter_ids, offer_audience_ids, transaction_audience_ids, sort_field, descending, start_date, end_date, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_event({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, event_id, retailer_location_ids, title, sub_title, details, category_ids, filter_ids, active, image_asset_id, redeemable_start, redeemable_end, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_token({:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("graph_interface(\"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", event, device_id, account_id, permissionable_type, permissionable_id, asset_id, game_type, app_key, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("add_favorite({}, \"{}\", {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", favoritable_id, favoritable_type, device_id, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_favorite({:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, favorite_id, favoritable_id, favoritable_type, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_favorite({}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", favorite_id, device_id, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_favorites(\"{}\", {:?}, {}, {}, {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", favoritable_type, sort_field, descending, start, limit, active_only, return_full_response, device_id, account_id, connection_account_id, secondary_type, keyword, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("who_has_favorited({}, \"{}\", {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", favoritable_id, favoritable_type, start, limit, device_id, account_id, latitude, longitude, keyword, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_filter({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, name, app_key, parent_filter_id, description, external_id, external_type, active, meta_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_filter({}, {}) - X-Span-ID: {:?}", account_id, filter_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_filter({}) - X-Span-ID: {:?}", filter_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_filters({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, keyword, app_key, response_group, root_only, sort_field, descending, start, limit, active_only, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_filter({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, filter_id, parent_filter_id, name, description, external_id, external_type, active, meta_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_flag(\"{}\", {}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", flagable_type, flagable_id, device_id, account_id, flag_description, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_flag({:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, item_being_flagged_type, item_being_flagged_id, flagable_type, flagable_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_flag(\"{}\", {}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", flagable_type, flagable_id, device_id, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_flag_threshold(\"{}\", \"{}\") - X-Span-ID: {:?}", item_being_flagged_type, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_flag_threshold(\"{}\", {}, \"{}\", {:?}, {:?}) - X-Span-ID: {:?}", item_being_flagged_type, threshold, app_key, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_game({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, title, description, meta_data, pack_ids, include_game_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_game({}, {}) - X-Span-ID: {:?}", account_id, game_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_game({}, {}, {:?}) - X-Span-ID: {:?}", account_id, game_id, include_game_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_games({}, \"{}\", {}, {}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, start, limit, keyword, app_version, include_game_data, include_inactive, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_game({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, game_id, app_key, title, description, meta_data, pack_ids, include_game_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_game_level({}, {}) - X-Span-ID: {:?}", account_id, level_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_game_level({}, {}, {:?}) - X-Span-ID: {:?}", account_id, level_id, include_game_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_game_levels_by_application({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, keyword, sort_field, descending, start, limit, app_version, include_game_data, filters, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_game_levels_by_billable_entity({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, keyword, sort_field, descending, active_only, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_questions_in_level({}, {}) - X-Span-ID: {:?}", level_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_words_in_level({}, {}) - X-Span-ID: {:?}", level_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_questions_in_level({}, {}, \"{}\") - X-Span-ID: {:?}", level_id, account_id, question_ids, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_words_in_level({}, {}, \"{}\") - X-Span-ID: {:?}", level_id, account_id, word_ids, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("accept_invite(\"{}\", {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", token, account_id, album_id, mission_id, album_contest_id, offer_id, offer_location_id, retailer_location_id, app_key, auto_friend, auto_attend_event, auto_favorite_offer, auto_favorite_offer_location, auto_favorite_retailer_location, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("album_contest_invite({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, app_id, app_key, album_contest_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("album_invite({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, app_id, app_key, album_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("event_invite({}, \"{}\", {}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, listing_id, receiver_account_ids, retailer_location_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("game_invite({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, app_id, app_key, game_level_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_invite({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, token, album_id, mission_id, album_contest_id, offer_id, offer_location_id, retailer_location_id, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("mission_invite({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, app_id, app_key, mission_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("offer_invite({}, \"{}\", {}) - X-Span-ID: {:?}", account_id, app_key, offer_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("offer_location_invite({}, \"{}\", {}) - X-Span-ID: {:?}", account_id, app_key, offer_location_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("retailer_location_invite({}, \"{}\", {}, {:?}) - X-Span-ID: {:?}", account_id, app_key, retailer_location_id, album_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_leaderboard({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, rank_type, leaderboard_mode, icon_media, icon_asset_id, banner_media, banner_asset_id, limitation, sort_field, title, description, meta_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_leaderboard({}, {:?}) - X-Span-ID: {:?}", leaderboard_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_leaderboard({}, {:?}, {:?}) - X-Span-ID: {:?}", leaderboard_id, account_id, include_full_ranking_list, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_leaderboards({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, global_only, keyword, leaderboard_ids, rank_types, sort_field, descending, include_inactive, include_app_response, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_leaderboard({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", leaderboard_id, account_id, app_key, rank_type, leaderboard_mode, sort_field, icon_media, icon_asset_id, banner_media, banner_asset_id, limitation, active, title, description, meta_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("register_like(\"{}\", {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", likable_type, likable_id, device_id, account_id, permissionable_type, permissionable_id, like, app, game_type, app_key, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("remove_like(\"{}\", {}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", likable_type, likable_id, device_id, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_likes(\"{}\", {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", likable_type, likable_id, device_id, account_id, connection_account_ids, sort_field, descending, updated_since, updated_before, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_listing({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, name, filter_ids, description, start, end, location_name, location_description, is_private, external_id, external_id2, external_group_id, active, meta_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_listing({}, {}) - X-Span-ID: {:?}", account_id, listing_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_listing({}) - X-Span-ID: {:?}", listing_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_listing({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, keyword, start, limit, active_only, latitude, longitude, start_date, end_date, category_ids, filter_ids, use_listing_order_ids, external_id, external_id2, external_group_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("summary_listing({:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, start_date, category_ids, days_to_include, use_listing_order_ids, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_listing({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, listing_id, filter_ids, name, description, start, end, location_name, location_description, is_private, external_id, external_id2, external_group_id, active, meta_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("cache_trilateration_data(\"{}\", {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", udid, source_time, minimum_sample_size, data, data_file, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("cache_trilateration_data_gzip({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_location_by_ip({:?}) - X-Span-ID: {:?}", ip, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_location_by_trilateration({:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, latitude, longitude, data, response_filters, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_locations({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, currentlatitude, currentlongitude, current_latitude, current_longitude, query, zipcode, zip_code, selected_maplatitude, selected_maplongitude, selected_map_latitude, selected_map_longitude, search_range, use_geocode, _i, start, _l, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_location_v2({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_location_v2({}, {:?}) - X-Span-ID: {:?}", id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_media({}, {}) - X-Span-ID: {:?}", account_id, media_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_media({}, {}) - X-Span-ID: {:?}", account_id, media_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_media({}, {}, {:?}, {}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, active_only, sort_field, descending, keyword, category_ids, filter_ids, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_mission({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, title, description, sub_type, start_date, end_date, active, game_level_ids, creative_ids, audience_ids, mission_task, format_type, offer_id, balance, advanced_reporting, allocate_tickets, ticket_count, ticket_type, points, meta_data, application_ids, devices, device_ids, device_versions, locations, radius, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_mission({}, {}) - X-Span-ID: {:?}", account_id, mission_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("find_missions(\"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, suffix, param_type, account_id, app_version, latitude, longitude, device, device_identifier, device_version, start, limit, include_game_data, include_audiences, allocates_tickets, randomize, targeted_ads_only, mission_ids, audience_operator, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_mission({}, {}, {:?}) - X-Span-ID: {:?}", account_id, mission_id, return_creative, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("import_mission({}, {}, {}, \"{}\", {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, latitude, longitude, app_key, keyword, start, limit, ad_size, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_mission_formats({}, {}, {}) - X-Span-ID: {:?}", start, limit, active_only, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_missions({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, keyword, sub_type, start, limit, include_game_data, include_audiences, include_inactive, suffix, sort_field, descending, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_missions_by_billable_entity({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, keyword, start, limit, include_game_data, include_audiences, include_inactive, suffix, sort_field, descending, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_mission_invite({:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, mission_id, join_code, include_game_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_mission_invite({:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, mission_id, mission_invite_id, include_game_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_mission_invite({:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, mission_id, mission_invite_id, include_game_data, include_scores, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_mission_invites({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, app_key, app_version, mission_id, status, last_updated, start, limit, keyword, mission_types, filter_by_billable, include_game_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_mission_invite({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, app_key, mission_id, mission_invite_id, pack_id, game_level_id, status, permissionable_type, permissionable_id, include_game_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("batch_operation({}, \"{}\", {:?}, {:?}, {:?}) - X-Span-ID: {:?}", notable_id, notable_type, device_id, account_id, batch_operation, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_note({}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", note_id, device_id, account_id, latitude, longitude, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_note({}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", note_id, device_id, account_id, return_full_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_notes({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, notable_type, notable_id, note_types, app_key, keyword, flag_count_minimum, flags_exceed_threshold, include_inactive, sort_field, descending, return_full_response, updated_since, updated_before, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_note({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", note_id, device_id, account_id, comment, note_type, asset_ids, tags, permissionable_type, permissionable_id, app_key, location_description, latitude, longitude, meta_data, return_full_response, active, update_asset, asset_return_nulls, asset_album_id, asset_collection_id, asset_add_to_default_album, asset_add_to_media_library, asset_version_code, asset_version_name, asset_meta_data, asset_caption, asset_media, asset_media_url, asset_media_string, asset_media_string_file_name, asset_media_string_content_type, asset_attached_media, asset_attached_media_url, asset_attached_media_string, asset_attached_media_string_file_name, asset_attached_media_string_content_type, asset_location_description, asset_app, asset_search_tags, asset_latitude, asset_longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_notification_template({}, \"{}\", \"{}\", \"{}\", {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, conduit, title, body, app_key, event, tags, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_or_update_blocked_notifications(\"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", app_key, data, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_notification_template({}, {}) - X-Span-ID: {:?}", account_id, notification_template_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_notification_template({}, {}) - X-Span-ID: {:?}", account_id, notification_template_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_notifications({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, connection_account_id, app_key, event_type, content_ids, content_types, parent_ids, parent_types, action_category, conduits, keyword, return_read_messages, mark_as_read, from_date, latitude, longitude, return_sent, ignore_flagged, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("register_notification_token(\"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", token, push_type, device_id, account_id, environment, app_key, game_type, active, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_blocked_notifications(\"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, account_id, search_tags, events, conduits, custom_types, content_types, content_ids, sort_field, descending, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_notification_template({}, \"{}\", {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, sort_field, descending, start, limit, app_key, event, conduit, global_only, reserved_only, keyword, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_recipients({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", sort_field, device_id, account_id, app_key, conduit, keyword, audience_id, audience_ids, connection_group_ids, recipient_account_ids, descending, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_recipients_count({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, app_key, conduit, keyword, audience_id, audience_ids, connection_group_ids, sort_field, descending, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("send_batch_notifications({}, \"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, custom_message, conduit, content_id, content_name, content_type, parent_id, parent_type, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("send_custom_notifications({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, receiver_account_ids, include_friend_group, app_key, game_type, conduit, content_id, content_name, content_type, parent_id, parent_type, action_category, subject, custom_message, friend_only_apns, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_notification_template({}, {}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, notification_template_id, title, body, tags, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("add_field({}, \"{}\", \"{}\", \"{}\", \"{}\") - X-Span-ID: {:?}", account_id, app_key, object_name, field_name, field_type, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_object({}, \"{}\", \"{}\") - X-Span-ID: {:?}", account_id, app_key, object_name, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_field({}, \"{}\", \"{}\", \"{}\") - X-Span-ID: {:?}", account_id, app_key, object_name, field_name, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_object({}, \"{}\", \"{}\") - X-Span-ID: {:?}", account_id, app_key, object_name, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_object({}, \"{}\", \"{}\") - X-Span-ID: {:?}", account_id, app_key, object_name, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_object({}, \"{}\", {}, {}, {:?}) - X-Span-ID: {:?}", account_id, app_key, start, limit, keyword, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_data(\"{}\", {:?}, {:?}) - X-Span-ID: {:?}", object_name, account_id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_data(\"{}\", {}, {}, {}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", object_name, count, start, limit, account_id, criteria, order, include, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_data(\"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", object_name, object_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_data(\"{}\", \"{}\", {:?}, {:?}) - X-Span-ID: {:?}", object_name, object_id, account_id, include, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_data(\"{}\", \"{}\", {:?}, {:?}) - X-Span-ID: {:?}", object_name, object_id, account_id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("batch_update_offer_locations(\"{}\", {:?}, {:?}) - X-Span-ID: {:?}", data, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_offer({}, {:?}, {:?}) - X-Span-ID: {:?}", offer_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_offer_location({}, {:?}, {:?}) - X-Span-ID: {:?}", offer_location_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_offer({}, {}, {:?}, {:?}) - X-Span-ID: {:?}", offer_id, include_offer_locations, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_offer_details({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, offer_id, offer_location_id, distance, latitude, longitude, include_offer_locations, include_retailer_locations, include_child_offers, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_offer_list_counts({}, {}, {:?}, {:?}) - X-Span-ID: {:?}", latitude, longitude, search_range, distance_unit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_offer_location({:?}, {:?}) - X-Span-ID: {:?}", offer_location_id, udid, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("redeem_offer_transaction({}, {}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", offer_transaction_id, status, device_id, account_id, offer_location_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("top_offer_transactions({:?}, {:?}) - X-Span-ID: {:?}", start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_offer_status(\"{}\", {}, {:?}, {:?}) - X-Span-ID: {:?}", offer_ids, active, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_offer_transaction_status(\"{}\", {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", name, code, device_id, account_id, latitude, longitude, description, role, active, application_ids, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_offer_transaction_status({}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", status_id, device_id, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_offer_transaction_status({}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", status_id, device_id, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_offer_transaction_statuses({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, latitude, longitude, keyword, role, app_key, sort_field, descending, start, limit, include_inactive, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_offer_transaction_status({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, latitude, longitude, status_id, name, description, code, role, active, application_ids, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("image_generation({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, post_body, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("request_optimization({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_optimization_result(\"{}\", {}, {}) - X-Span-ID: {:?}", batch_id, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("add_movie({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, movie_name, third_party_account_id, tags, file, url, callback, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("ai_docs({}, \"{}\", {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, doc, return_topics, limit, offset, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("ai_find_images({}, \"{}\", {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, text, parse_flag, fetch_flag, size, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("ai_tags({}, \"{}\", {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, tags, conditional, limit, offset, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("ai_text({}, \"{}\", {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, terms, conditional, limit, offset, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("batch({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, third_party_account_id, limit, operations, file, url, callback, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_instant_episode({}, \"{}\") - X-Span-ID: {:?}", account_id, data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_voice_canvas({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, dimensions, third_party_account_id, text, file, url, parse_flag, fetch_flag, callback, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("emotion({}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, third_party_account_id, file, url, callback, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("start_video_render({}, \"{}\") - X-Span-ID: {:?}", account_id, data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("stt({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, third_party_account_id, source_language, target_language, file, url, callback, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("summarize_topics({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, third_party_account_id, doc, file, url, limit, offset, callback, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("tech_tune({}, {}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, num_faces_expected, third_party_account_id, file, url, callback, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("tts({}, \"{}\", {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, text, third_party_account_id, language, voice, callback, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_add_movie_result(\"{}\", {}) - X-Span-ID: {:?}", request_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_batch(\"{}\", {}) - X-Span-ID: {:?}", request_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_emotion(\"{}\", {}) - X-Span-ID: {:?}", request_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_episode_status({}, {}) - X-Span-ID: {:?}", episode_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_render_status(\"{}\", {}) - X-Span-ID: {:?}", render_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_stt(\"{}\", {}) - X-Span-ID: {:?}", request_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_tech_tune(\"{}\", {}) - X-Span-ID: {:?}", request_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_topics(\"{}\", {}) - X-Span-ID: {:?}", request_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_tts(\"{}\", {}) - X-Span-ID: {:?}", request_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_voice_canvas(\"{}\", {}) - X-Span-ID: {:?}", request_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_pack({}, \"{}\", {}, {}, {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, title, pack_order, price, highest, allocate_tickets, ticket_count, description, search_tags, active, game_type, app_key, pack_type, sequence_type, background_id, image_id, start_date, end_date, author_override, price_type, game_level_ids, in_game, ticket_type, points, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_pack({}, {}) - X-Span-ID: {:?}", account_id, pack_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_pack({}, {}, {}) - X-Span-ID: {:?}", account_id, pack_id, include_game_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_packs({}, {:?}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, sort_field, descending, keyword, pack_type, start, limit, include_game_data, include_inactive, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("process_all_participants({}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, use_short_name_as_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("process_participants({}, \"{}\", {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, league, app_key, use_short_name_as_id, file, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("compute_path(\"{}\", {:?}, {}, {}) - X-Span-ID: {:?}", data, units, reduce_path, directions, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_postal_code({}, \"{}\", {}, {}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, code, latitude, longitude, state_code, city, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_postal_code({}, {}) - X-Span-ID: {:?}", account_id, postal_code_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_postal_code({}) - X-Span-ID: {:?}", postal_code_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_postal_codes(\"{}\", {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", sort_field, descending, latitude, longitude, keyword, miles, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_postal_code({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, postal_code_id, code, latitude, longitude, state_code, city, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_persona({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, title, preview_accounts, date, age, gender, game_experience_level, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_persona({}, {}) - X-Span-ID: {:?}", account_id, persona_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_persona_list({}, {}) - X-Span-ID: {:?}", account_id, persona_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_persona({}, {}, {}) - X-Span-ID: {:?}", account_id, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_persona({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, persona_id, title, preview_accounts, active, date, age, gender, game_experience_level, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_program({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_programs(\"{}\", {}, {}, {}, {}, {:?}) - X-Span-ID: {:?}", sort_field, descending, start, limit, active_only, keyword, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_program({}) - X-Span-ID: {:?}", id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_program({}) - X-Span-ID: {:?}", id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("post_program({}, {:?}) - X-Span-ID: {:?}", id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("put_program({}, {:?}) - X-Span-ID: {:?}", id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_purchase_item(\"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, name, purchase_type, device_id, account_id, description, tickets, price, purchase_code, secret_key, purchase_limit, service_action, cover_asset_id, promo_asset_id, giftable, assetable, allocate_tickets, ticket_type, points, offer_location_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_purchase_item({}, {:?}, {:?}) - X-Span-ID: {:?}", purchase_item_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_purchase_item({}, {:?}, {:?}) - X-Span-ID: {:?}", purchase_item_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_purchase_items({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, app_key, filter_by_billable, purchase_type, service_action, keyword, sort_field, descending, start, limit, active_only, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_order(\"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, cart, device_id, account_id, description, currency_type, payment_method_id, external_order_id, external_payment_id, remote_ref_type, external_date, promo_code, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_order({}, {:?}, {:?}) - X-Span-ID: {:?}", order_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_order({:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, order_id, external_order_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("preview_order(\"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, cart, device_id, account_id, description, currency_type, payment_method_id, external_order_id, external_payment_id, remote_ref_type, external_date, promo_code, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_order({}, \"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", order_id, app_key, cart, device_id, account_id, payment_transaction_id, description, currency_type, payment_method_id, external_payment_id, external_date, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_question({}, \"{}\", \"{}\", {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, question, answers, active, allocate_tickets, ticket_count, tags, video_url, asset_id, ticket_type, points, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_question({}, {}) - X-Span-ID: {:?}", question_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_question({}, {}) - X-Span-ID: {:?}", question_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_questions({}, \"{}\", {}, {}, {}, {}, {:?}) - X-Span-ID: {:?}", account_id, sort_field, descending, active_only, start, limit, keyword, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_question({}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", question_id, account_id, ticket_count, question, answers, tags, video_url, asset_id, active, allocate_tickets, ticket_type, points, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_historical_rankings(\"{}\", \"{}\", {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, rank_type, start_date, end_date, device_id, account_id, sort_field, descending, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_rankings({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, game_type, app_key, q, keyword, rank_type, leaderboard_mode, within_account_ids, return_user_rank, album_id, audience_id, sort_field, descending, _i, start, _l, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_user_rank({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, app_key, rank_type, return_user_rank, leaderboard_mode, sort_field, keyword, descending, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("override_user_rank({}, {}, \"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, owner_account_id, app_key, rank_type, total_score, total_count, total_time, daily_score, daily_count, daily_time, weekly_score, weekly_count, weekly_time, monthly_score, monthly_count, monthly_time, top_score, lowest_score, streak_count, streak_best_count, start_date, end_date, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_rankings({}, \"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, rank_type, increment, time_increment, tag, start_date, end_date, update_global, create_leaderboard, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_rating(\"{}\", {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", ratable_type, ratable_id, rating_value, device_id, account_id, category_id, display, description, location_description, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_rating({}, {:?}, {:?}) - X-Span-ID: {:?}", rating_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_location_rating_indexes({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", category_ids, keyword, location_type, sort_field, descending, start, limit, search_range, latitude, longitude, return_overall_rating, distance_unit, return_retailer, return_assets, return_offers, return_categories, return_filters, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_rating_indexes({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", ratable_type, ratable_ids, category_ids, secondary_type, keyword, sort_field, descending, start, limit, latitude, longitude, return_ratable, return_overall_rating, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_ratings({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, filter_account_id, ratable_type, ratable_id, category_ids, keyword, sort_field, descending, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_rating({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", rating_id, device_id, account_id, rating_value, category_id, display, description, location_description, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_region({}, \"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, region_class, short_name, full_name, parent_ids, children_ids, postal_code_ids, locations, retailer_location_id, visibility, category_ids, filter_ids, start, end, polygon, meta_data, latitude, longitude, version_code, root, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_region({}, {}) - X-Span-ID: {:?}", account_id, region_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_region({}, {:?}) - X-Span-ID: {:?}", region_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_regions({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, query, keyword, latitude, longitude, range, region_class, visibility, search_mode, sort_field, descending, include_parent, include_children, include_postal_codes, category_ids, filter_ids, version_code, active_only, show_deleted, last_updated_since, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_region({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, region_id, region_class, short_name, full_name, parent_ids, children_ids, postal_code_ids, locations, retailer_location_id, visibility, category_ids, filter_ids, start, end, polygon, meta_data, latitude, longitude, version_code, root, active, clear_lists, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_batch({}, {:?}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, status, preview_limit, app_key, endpoint, parameters, name, start_date, end_date, description, page_url, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_region_leg_summary_batch({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_batch({}, {}) - X-Span-ID: {:?}", account_id, batch_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_report_batch({}, {}, {}) - X-Span-ID: {:?}", account_id, batch_id, all_results, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("run_report({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", desc, account_id, query, parameters, order, start, limit, response_format, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_batch({}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, start, limit, names, app_key, status, global_app_search, start_date, end_date, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_reservation({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, start_date, end_date, offer_id, offer_location_id, app_key, meta_data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_reservation({}, {:?}, {:?}) - X-Span-ID: {:?}", reservation_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("reservable_availability({}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", reservable_id, reservable_type, device_id, account_id, availability, availability_summary, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_availability({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", reservable_id, reservable_type, device_id, account_id, start_date, end_date, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_reservations({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, app_key, account_id, filter_account_id, reservable_id, reservable_type, keyword, start_date, end_date, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_schedule({}, {:?}, {}, {}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", reservable_id, reservable_type, start_date, end_date, device_id, account_id, time_bucket_mins, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_retailer({:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, retailer_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_retailer({}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", retailer_id, device_id, account_id, include_counts, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_retailers({:?}, {:?}, {}, {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", visibility, sort_field, descending, start, limit, active_only, device_id, account_id, q, keyword, category_ids, filter_ids, _i, _l, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("retailer_login_check(\"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", username, password, device_id, latitude, longitude, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_retailer({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", retailer_id, device_id, account_id, name, street_address, street_address2, city, state, postal_code, country, business_phone, business_phone_ext, website, email, facebook_url, twitter_url, logo, logo_asset_id, picture1, picture1_asset_id, picture2, picture2_asset_id, category_ids, filter_ids, latitude, longitude, meta_data, search_tags, retailer_type, visibility, active, response_format, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_retailer_locations({}, \"{}\", \"{}\", \"{}\", \"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", retailer_id, name, street_address, city, state, postal_code, device_id, account_id, street_address2, country, business_phone, business_phone_ext, website, email, internal_id, details_header, details_body, hours, logo, logo_asset_id, picture1, picture1_asset_id, picture2, picture2_asset_id, category_ids, filter_ids, latitude, longitude, building, google_place_id, yelp_id, active, public_location, location_type, audience_ids, audience_ids_to_add, audience_ids_to_remove, response_format, response_includes, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_retailer_location({:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, retailer_location_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_retailer_location({}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", retailer_location_id, device_id, account_id, retailer_location_token, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_retailer_location_consumer({}, {:?}, {:?}) - X-Span-ID: {:?}", retailer_location_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_retailer_locations({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", retailer_location_id, device_id, account_id, name, street_address, street_address2, city, state, postal_code, country, business_phone, business_phone_ext, website, email, internal_id, details_header, details_body, hours, logo, logo_asset_id, picture1, picture1_asset_id, picture2, picture2_asset_id, category_ids, filter_ids, latitude, longitude, building, google_place_id, yelp_id, meta_data, payment_provider, active, public_location, location_type, audience_ids, audience_ids_to_add, audience_ids_to_remove, response_format, tags, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_retaokiler({}, {}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", retailer_id, active_only, keyword, sort_field, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_route({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_routes(\"{}\", {}, {}, {}, {}, {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", sort_field, descending, start, limit, active_only, includes_empty, root_only, show_inherited_properties, hub_id, program_id, scheduled_start, scheduled_end, updated_start, updated_end, featured, seat_count, approved, started, completed, valid, parent_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("approve_route({}) - X-Span-ID: {:?}", route_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("copy_route({}, {:?}) - X-Span-ID: {:?}", route_id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_route_directions({}) - X-Span-ID: {:?}", route_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_route_polyline({}) - X-Span-ID: {:?}", route_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_route({}) - X-Span-ID: {:?}", route_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("disapprove_route({}) - X-Span-ID: {:?}", route_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_route({}, {}) - X-Span-ID: {:?}", route_id, show_inherited_properties, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_route_directions({}) - X-Span-ID: {:?}", route_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_route_shipments({}) - X-Span-ID: {:?}", route_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_route_stops({}, {}) - X-Span-ID: {:?}", route_id, confirmed_only, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("optimize_route({}) - X-Span-ID: {:?}", route_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("reorder_route_stops_patch({}, {:?}) - X-Span-ID: {:?}", route_id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("reorder_route_stops_post({}, {:?}) - X-Span-ID: {:?}", route_id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_route({}, {:?}) - X-Span-ID: {:?}", route_id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_route_stop({}, {}) - X-Span-ID: {:?}", route_id, stop_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_shipments_at_stop({}, {}) - X-Span-ID: {:?}", route_id, stop_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("remove_stop({}, {}) - X-Span-ID: {:?}", route_id, stop_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("set_driver({}, {}) - X-Span-ID: {:?}", id, driver_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_route_stop({}, {}, {:?}) - X-Span-ID: {:?}", route_id, stop_id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_route_settings({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_route_settings(\"{}\", {}, {}, {}, {}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", sort_field, descending, start, limit, active_only, hub_id, program_id, keyword, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_route_settings({}) - X-Span-ID: {:?}", route_settings_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_route_settings({}) - X-Span-ID: {:?}", route_settings_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_route_settings({}, {:?}) - X-Span-ID: {:?}", route_settings_id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("compute_routing(\"{}\") - X-Span-ID: {:?}", data, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_scheduled_notification({}, \"{}\", \"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, name, param_type, message, content_id, content_name, content_type, parent_id, parent_type, app_key, grouping_id, connection_group_ids, connection_account_ids, audience_id, audience_ids, album_ids, report_id, report_params, endpoint_url, payload, scheduled_date, start_date, end_date, cron_expression, cron_type, meta_data, conditional_input, template_type, visibility, active, send_now, event_type, deep_link_uri, send_to_all, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_scheduled_notification({}, {}, {:?}) - X-Span-ID: {:?}", account_id, scheduled_notification_id, delete_by_grouping_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_scheduled_notification({}, {}) - X-Span-ID: {:?}", account_id, scheduled_notification_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("schedule_notification_listings({}, \"{}\", \"{}\", \"{}\", {}, {}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, report_name, message, offset, recipient_report_id, report_params, param_type, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_scheduled_notifications({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, grouping_id, audience_id, filter, types, content_ids, content_types, parent_ids, parent_types, statuses, template_types, app_key, keyword, sort_field, descending, start, limit, active_only, group_by_grouping_id, return_audience_account_count, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_scheduled_notification({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", scheduled_notification_id, account_id, name, param_type, message, payload, content_id, content_name, content_type, parent_id, parent_type, app_key, grouping_id, connection_group_ids, connection_account_ids, audience_id, audience_ids, album_ids, report_id, report_params, endpoint_url, scheduled_date, start_date, end_date, cron_expression, cron_type, meta_data, conditional_input, template_type, visibility, active, error_message, status, update_by_grouping_id, send_now, event_type, deep_link_uri, send_to_all, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_score({}, \"{}\", {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, points, mission_id, game_id, pack_id, game_level_id, game_object_id, time_taken, highest, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_score({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, mission_id, game_id, pack_id, game_level_id, game_object_id, score_object_type, score_status, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_scores({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, mission_id, game_id, pack_id, game_level_id, game_object_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_secure_application({}, \"{}\", {:?}, {:?}, \"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, key_cert, trust_store, username, password, active, biometric_type, biometric_position, biometric_position2, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_secure_application({}, \"{}\") - X-Span-ID: {:?}", account_id, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("login_secure(\"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", app_key, biometric_file, device_id, biometric_file2, age_restriction, return_profile, response_filters, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("purchase_secure({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("reset_secure({}, \"{}\") - X-Span-ID: {:?}", account_id, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_secure_application({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, active, key_cert, trust_store, username, password, biometric_type, biometric_position, biometric_position2, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_service_hub({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_service_hubs(\"{}\", {}, {}, {}, {}, {:?}, {:?}) - X-Span-ID: {:?}", sort_field, descending, start, limit, active_only, keyword, retailer_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_service_hub({}) - X-Span-ID: {:?}", id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_service_hub({}) - X-Span-ID: {:?}", id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("post_service_hub({}, {:?}) - X-Span-ID: {:?}", id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("put_service_hub({}, {:?}) - X-Span-ID: {:?}", id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_shipment({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_shipments(\"{}\", {}, {}, {}, {}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", sort_field, descending, start, limit, active_only, owner_id, rider_id, route_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("cancel_shipment({}) - X-Span-ID: {:?}", id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_shipment({}) - X-Span-ID: {:?}", id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_shipment({}) - X-Span-ID: {:?}", id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_shipment({}, {:?}) - X-Span-ID: {:?}", id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_shipment_status({}, {:?}) - X-Span-ID: {:?}", id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_shipment_batch({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_shipment_batch({}, \"{}\", {}, {}, {}) - X-Span-ID: {:?}", hub_id, sort_field, descending, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_shipment_batch({}) - X-Span-ID: {:?}", batch_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_shipment_batch({}) - X-Span-ID: {:?}", batch_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_shipment_batch_status({}, {}, \"{}\", {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", batch_id, account_id, sort_field, descending, start, limit, valid, started, completed, has_shipment, has_route, keyword, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("simulation(\"{}\", {}) - X-Span-ID: {:?}", data, real_time, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_stop({}) - X-Span-ID: {:?}", id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_stop({}, {:?}) - X-Span-ID: {:?}", id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_stripe_checkout_session(\"{}\", \"{}\") - X-Span-ID: {:?}", app_key, stripe_parameters, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_subscription({}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, plan_id, promo_code, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_subscription({}) - X-Span-ID: {:?}", account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_subscription({}) - X-Span-ID: {:?}", account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_subscription_plan({}) - X-Span-ID: {:?}", plan_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_subscription_plans({:?}, {:?}) - X-Span-ID: {:?}", visible, role, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_subscription_usage({}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, application_id, start, end, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_subscription({}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, plan_id, promo_code, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_task({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, name, app_key, grouping_id, endpoint_url, payload, scheduled_date, start_date, end_date, cron_expression, visibility, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_task({}, {}) - X-Span-ID: {:?}", account_id, task_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_task({}, {}) - X-Span-ID: {:?}", account_id, task_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_tasks({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, grouping_id, filter, statuses, template_types, app_key, keyword, sort_field, descending, start, limit, active_only, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_task({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", task_id, account_id, name, app_key, grouping_id, endpoint_url, payload, scheduled_date, start_date, end_date, cron_expression, visibility, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_territory({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, name, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_territory({}, {}) - X-Span-ID: {:?}", account_id, territory_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_territory({}) - X-Span-ID: {:?}", territory_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_territories({:?}, {}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", sort_field, descending, keyword, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_territory({}, {}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, territory_id, name, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("add_or_update_theme_descriptor({}, {}, {}, {}, {:?}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", public_read, public_write, public_delete, public_add, visibility, include_friend_group, complete_with_default_values, device_id, account_id, game_type, theme_descriptor_id, title, description, connection_ids_to_add, connection_group_ids_to_add, app_version, color_value_json, string_replacer_json, custom_json_objects, icon_image, scene_atlas_image, bg_image, bg_sound, music_selection, location_description, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_theme_descriptor({}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", theme_descriptor_id, device_id, account_id, game_type, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_theme_descriptors(\"{}\", \"{}\", {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", filter, sort_field, descending, start, limit, device_id, account_id, game_type, contest_type, owner_id, q, keyword, _i, _l, date_created, app_version, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("remove_theme_descriptor({}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", theme_descriptor_id, device_id, account_id, game_type, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_credential(\"{}\", \"{}\", \"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", third_party_id, third_party_token, network_uid, app_key, account_id, device_id, session_id, third_party_name, email_address, signin_only_mode, response_filters, latitude, longitude, meta_data, third_party_refresh_token, audience_ids_to_add, audience_ids_to_remove, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_network({}, \"{}\", {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, name, enable_introspection, description, introspection_method, introspection_url, introspection_params, required_root_field, enable_mfa, size_mfa, shelf_life_mfa, oauth_token_url, oauth_private_key, oauth_public_key, oauth_client_id, oauth_secret_key, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_credential({}, \"{}\", \"{}\", \"{}\") - X-Span-ID: {:?}", account_id, network_uid, third_party_id, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_network({}, \"{}\") - X-Span-ID: {:?}", account_id, network_uid, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_credential(\"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", network_uid, app_key, account_id, device_id, session_id, third_party_credential_id, third_party_token, third_party_secret, create_new_account, response_filters, latitude, longitude, audience_ids_to_add, audience_ids_to_remove, referral_account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_network({}, \"{}\") - X-Span-ID: {:?}", account_id, network_uid, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_credentials({}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, keyword, network_uid, descending, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_networks({}, {:?}, {}, {}, {}, {}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, sort_field, descending, start, limit, active_only, keyword, filter_billable, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("send_mfa_challenge(\"{}\", \"{}\", {:?}, {:?}, {:?}) - X-Span-ID: {:?}", network_uid, app_key, third_party_token, third_party_credential_id, device_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_credential(\"{}\", \"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", network_uid, third_party_id, app_key, device_id, third_party_name, third_party_token, response_filters, meta_data, third_party_refresh_token, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_network({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, network_uid, name, description, enable_introspection, introspection_method, introspection_url, introspection_params, required_root_field, enable_mfa, size_mfa, shelf_life_mfa, oauth_token_url, oauth_private_key, oauth_public_key, oauth_client_id, oauth_secret_key, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_ticket_count({:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, game_type, app_key, ticket_type, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_ticket_list({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, ticket_object_type, action_type, ticket_ids, object_ids, receipt_tokens, game_type, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("gift_purchase({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", receiver_account_id, ticket_id, device_id, account_id, asset_id, custom_message, game_type, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("save_ticket(\"{}\", \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", action_type, ticket_object_type, return_nulls, device_id, account_id, game_type, app_key, object_id, purchase_code, receipt_token, receipt_data, count, ticket_type, purchase_provider, purchase_type, return_profile_response, include_profile_response, app_version, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("ticket_offers() - X-Span-ID: {:?}", context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_tournament({}, {}) - X-Span-ID: {:?}", account_id, mission_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_tournament({}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, mission_id, join_code, include_scores, object_preview_size, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_objects({}, {}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, game_level_id, sort_field, descending, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_rounds({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, status, mission_type, current_only, visibilities, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_tournaments({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, keyword, sub_type, include_inactive, mission_types, filter, sort_field, descending, visibility, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("submit_tournament_score({}, \"{}\", {}, {}, {}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, mission_id, game_id, pack_id, scores, game_level_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("submit_tournament_vote({}, \"{}\", {}, {}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, mission_id, game_object_id, device_id, check_if_device_already_voted, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("substitute_tournament_player({}, {}, {}, {}) - X-Span-ID: {:?}", account_id, mission_id, pack_id, game_level_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_tournament({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, mission_id, title, sub_type, image_asset_id, seconds_between_levels, seconds_for_tie_breaker, seconds_between_packs, maximum_level_length, cost_to_play, cost_to_play_type, minimum_to_play, starting_limit, available_limit, description, meta_data, start_date, audience_ids, active, enable_buy_back, offer_ids, offer_asset_id, fixed_reward, split_reward, allocate_tickets, tournament_data, visibility, preliminary_groups, preliminary_group_advancements, enable_multiple_entries, enable_multiple_votes, featured, winner_tag, tie_tag, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("batch_save_tracking(\"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", data, device_id, account_id, generate_accounts, update_account_locations, default_tag, slave_uid, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_predicted_locations({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, latitude, longitude, date_check, hour_check, threshold, distance_unit, search_range, sort_order, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_predicted_path({}, {}, {}) - X-Span-ID: {:?}", account_id, start_step_id, end_step_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_preferred_locations({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, latitude, longitude, date_check, hour_check, sort_field, descending, start, limit, search_range, distance_unit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_tracking_legs({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, owner_id, tracking_device_id, start_date, end_date, tags, get_last_point, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("save_tracking_leg({}, {}, {}, {}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", start_lat, start_lng, start_date, end_lat, end_lng, end_date, device_id, account_id, distance, duration, steps, tags, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("save_tracking_step({}, {}, {}, {}, {}, {}, {}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", leg_id, start_lat, start_lng, start_date, end_lat, end_lng, end_date, device_id, account_id, distance, duration, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_accounts_with_tracking_legs({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, keyword, start_date, end_date, tags, audience_ids, latitude, longitude, range, sort_field, descending, start, limit, active_only, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_tracking_legs({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, tracking_device_id, start_date, end_date, tags, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_trigger({}, \"{}\", {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, name, app_key, grouping_id, endpoint_url, payload, scheduled_date, start_date, end_date, cron_expression, conditional_input, visibility, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_trigger({}, {}) - X-Span-ID: {:?}", account_id, trigger_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_trigger({}, {}) - X-Span-ID: {:?}", account_id, trigger_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_triggers({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, grouping_id, filter, statuses, template_types, app_key, keyword, sort_field, descending, start, limit, active_only, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_trigger({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", trigger_id, account_id, name, app_key, grouping_id, endpoint_url, payload, scheduled_date, start_date, end_date, cron_expression, conditional_input, visibility, active, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_trip({:?}) - X-Span-ID: {:?}", body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("process_trip_matches({:?}, {:?}, {:?}) - X-Span-ID: {:?}", start_date, end_date, trip_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search({}, \"{}\", {}, {}, {}, {}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, sort_field, descending, start, limit, active_only, start_date, end_date, has_notifications, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_trips({}, \"{}\", {}, {}, {}, {}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, sort_field, descending, start, limit, active_only, start_date, end_date, matched_has_route, matched_has_driver, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_trip_notifications({}, {:?}) - X-Span-ID: {:?}", id, notifications, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete({}) - X-Span-ID: {:?}", id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("drive_trip({}, {}) - X-Span-ID: {:?}", id, recurrence, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("flexible_trip({}, {}) - X-Span-ID: {:?}", id, recurrence, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_trip({}) - X-Span-ID: {:?}", id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_trip_matches({}, \"{}\", {}, {}, {}, {}, {:?}, {:?}) - X-Span-ID: {:?}", id, sort_field, descending, start, limit, active_only, matched_has_route, matched_has_driver, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("ride({}, {}) - X-Span-ID: {:?}", id, recurrence, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_locations({}, {:?}) - X-Span-ID: {:?}", id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_recurrence_locations({}, {:?}) - X-Span-ID: {:?}", id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_recurrence_shipments({}, {:?}) - X-Span-ID: {:?}", id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_shipments({}, {:?}) - X-Span-ID: {:?}", id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_trip({}, {:?}) - X-Span-ID: {:?}", id, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("sms_buy_offer(\"{}\", \"{}\", \"{}\", \"{}\") - X-Span-ID: {:?}", app_key, body, from, currency_type, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("authorize_twitter(\"{}\") - X-Span-ID: {:?}", app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("login_twitter(\"{}\", \"{}\", \"{}\", \"{}\", {:?}, {:?}, {:?}) - X-Span-ID: {:?}", access_token, access_token_secret, app_key, response_filters, device_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("add_users_to_permissionable({:?}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", permissionable_type, permissionable_id, device_id, account_id, read, write, delete, add, connection_ids, connection_account_ids, connection_group_ids, pending, admin, include_friend_group, latitude, longitude, audience_ids, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("approve_permissionable({:?}, {}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", permissionable_type, permissionable_id, device_id, account_id, approval_status, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("leave_from_permissionable(\"{}\", {}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", permissionable_type, permissionable_id, device_id, account_id, latitude, longitude, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("remove_users_from_permissionable({:?}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", permissionable_type, permissionable_id, device_id, account_id, connection_ids, connection_account_ids, connection_group_ids, remove_friend_group, latitude, longitude, audience_ids, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_permissionables({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, connection_account_id, connection_account_ids, permissionable_type, permissionable_id, keyword, sort_field, descending, pending, admin, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_permissionables_following_distance({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", latitude, longitude, device_id, account_id, connection_account_id, connection_account_ids, permissionable_type, permissionable_id, search_range, keyword, pending, admin, start, limit, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_following({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_space({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_vatom_event({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_following({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_rels_key, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_points_balance({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_campaign_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_space({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_space_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_vatom_event({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_event_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_vatom_nft({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("execute_action_on_nft({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_id, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("geomap_search({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_business_behaviors({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_business_coins_balance({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_business_ids({}, {:?}) - X-Span-ID: {:?}", account_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_business_info({}, \"{}\", {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_business_users({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_campaign_group_entities({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_campaign_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_campaign_group_rules({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_campaign_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_campaign_group_stats({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_campaign_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_campaign_info({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_campaign_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_event_guest_list({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_event_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_inventory({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_my_following({}, {:?}) - X-Span-ID: {:?}", account_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_points_balance({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_user_id, vatom_campaign_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_points_balance_as_business({}, \"{}\", \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_user_id, vatom_campaign_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_space({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_space_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_user_coins_as_business({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_user_id, app_key, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_user_coins_balance({}, \"{}\", {:?}, {:?}) - X-Span-ID: {:?}", account_id, vatom_user_id, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_user_followers({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_user_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_user_following({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_user_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_user_info({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_user_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_user_profile({}, {:?}) - X-Span-ID: {:?}", account_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_vatom_event({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_event_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_vatom_nft({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("list_communities({}, \"{}\", {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("list_events({}, \"{}\", {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("list_spaces({}, \"{}\", {:?}, {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("list_user_coin_transactions({}, \"{}\", {:?}, {:?}) - X-Span-ID: {:?}", account_id, vatom_user_id, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("list_user_coin_transactions_as_business({}, \"{}\", \"{}\", {:?}, {:?}) - X-Span-ID: {:?}", account_id, vatom_user_id, app_key, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("perform_action_on_nft({}, \"{}\", \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_id, vatom_action, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("redeem_nft({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("redeem_user_coins_as_business({}, \"{}\", \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_user_id, app_key, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_businesses({}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_campaign_groups({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_identities({}, {:?}) - X-Span-ID: {:?}", account_id, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_inventory({}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("send_nft({}, \"{}\", \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_campaign_id, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("set_points_balance_as_business({}, \"{}\", \"{}\", \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_user_id, vatom_campaign_id, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("transfer_user_coins({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_user_id, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_business_coins({}, \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_event_guest_list({}, \"{}\", \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_event_id, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_space({}, \"{}\", \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_space_id, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_user_coins_as_business({}, \"{}\", \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_user_id, app_key, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_user_profile({}, \"{}\", {:?}) - X-Span-ID: {:?}", account_id, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_vatom_event({}, \"{}\", \"{}\", \"{}\", {:?}) - X-Span-ID: {:?}", account_id, app_key, vatom_event_id, vatom_parameters, return_raw_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_vehicle(\"{}\", {:?}) - X-Span-ID: {:?}", vehicle, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_vehicle({}, \"{}\", {}, {}, {}, {}, {:?}) - X-Span-ID: {:?}", hub_id, sort_field, descending, start, limit, active_only, keyword, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_vehicle({}) - X-Span-ID: {:?}", id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_vehicle({}) - X-Span-ID: {:?}", id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_vehicle({}, \"{}\", {:?}) - X-Span-ID: {:?}", id, vehicle, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_vehicle_type(\"{}\", {:?}) - X-Span-ID: {:?}", vehicle_type, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_vehicle_types(\"{}\", {}, {}, {}, {}, {:?}, {:?}) - X-Span-ID: {:?}", sort_field, descending, start, limit, active_only, retailer_id, hub_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_vehicle_type({}) - X-Span-ID: {:?}", vehicle_type_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_vehicle_type({}) - X-Span-ID: {:?}", vehicle_type_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_vehicle_type({}, \"{}\", {:?}) - X-Span-ID: {:?}", vehicle_type_id, vehicle_type, body, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_offer_transaction({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, offer_id, offer_location_id, offer_cart, promo_code, currency_type, use_points, meta_data, app_key, status, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_offer_transaction({}, {:?}, {:?}) - X-Span-ID: {:?}", transaction_id, device_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_offer_transaction({}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", transaction_id, device_id, account_id, include_mission, latitude, longitude, return_full_response, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("preview_offer_transaction({:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", device_id, account_id, offer_id, offer_location_id, offer_cart, promo_code, currency_type, use_points, meta_data, app_key, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_offer_transaction({}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", transaction_id, status, device_id, account_id, offer_location_id, currency_type, use_points, app_key, latitude, longitude, meta_data, return_full_response, exception_membership_offer_ids, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("search_weather({:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", region_id, latitude, longitude, timezone_offset, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("create_word({}, \"{}\", \"{}\", {}, {}, {}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, word, definition, active, allocate_tickets, ticket_count, asset_id, ticket_type, points, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("delete_word({}, {}) - X-Span-ID: {:?}", word_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_word({}, {}) - X-Span-ID: {:?}", word_id, account_id, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("get_words({}, \"{}\", {}, {}, {}, {}, {:?}) - X-Span-ID: {:?}", account_id, sort_field, descending, active_only, start, limit, keyword, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("update_word({}, {}, {}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", word_id, account_id, ticket_count, word_text, definition, asset_id, active, allocate_tickets, ticket_type, points, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
    ...
    {
        info!("run_workflow({}, {}, {:?}, {:?}, {:?}) - X-Span-ID: {:?}", account_id, workflow_id, sku_id, version_code, parameters, context.get().0.clone());
        Err(ApiError("Api-Error: Operation is NOT implemented".into()))
    }
