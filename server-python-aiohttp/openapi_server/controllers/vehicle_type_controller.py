...
async def create_vehicle_type(request: web.Request, vehicle_type, body=None) -> web.Response:
    """Create Vehicle Type
...
async def delete_vehicle_type(request: web.Request, vehicle_type_id) -> web.Response:
    """Delete Vehicle Type
...
async def get_vehicle_type(request: web.Request, vehicle_type_id) -> web.Response:
    """Get Vehicle Type
...
async def search_vehicle_types(request: web.Request, sort_field, descending, start, limit, active_only, retailer_id=None, hub_id=None) -> web.Response:
    """Search Vehicle Type
...
async def update_vehicle_type(request: web.Request, vehicle_type_id, vehicle_type, body=None) -> web.Response:
    """Update Vehicle Type
