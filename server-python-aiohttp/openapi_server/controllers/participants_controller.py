...
async def process_all_participants(request: web.Request, version, account_id, app_key=None, use_short_name_as_id=None) -> web.Response:
...
async def process_participants(request: web.Request, version, account_id, league, app_key=None, use_short_name_as_id=None, file=None) -> web.Response:
