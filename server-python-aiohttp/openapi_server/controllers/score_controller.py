...
async def create_score(request: web.Request, version, account_id, app_key, points, mission_id=None, game_id=None, pack_id=None, game_level_id=None, game_object_id=None, time_taken=None, highest=None) -> web.Response:
    """Create Score
...
async def get_score(request: web.Request, version, account_id, app_key, mission_id=None, game_id=None, pack_id=None, game_level_id=None, game_object_id=None, score_object_type=None, score_status=None) -> web.Response:
    """Get Score
...
async def search_scores(request: web.Request, version, account_id, app_key, mission_id=None, game_id=None, pack_id=None, game_level_id=None, game_object_id=None) -> web.Response:
    """Search Score
