...
async def create_trip(request: web.Request, version, body=None) -> web.Response:
    """Create Trip
...
async def delete(request: web.Request, version, id) -> web.Response:
    """Delete Trip
...
async def drive_trip(request: web.Request, version, id, recurrence) -> web.Response:
...
async def flexible_trip(request: web.Request, version, id, recurrence) -> web.Response:
...
async def get_trip(request: web.Request, version, id) -> web.Response:
    """Get Trip
...
async def get_trip_matches(request: web.Request, version, id, sort_field, descending, start, limit, active_only, matched_has_route=None, matched_has_driver=None) -> web.Response:
    """Get Trip Matches
...
async def process_trip_matches(request: web.Request, version, start_date=None, end_date=None, trip_id=None) -> web.Response:
...
async def ride(request: web.Request, version, id, recurrence) -> web.Response:
...
async def search(request: web.Request, version, account_id, sort_field, descending, start, limit, active_only, start_date=None, end_date=None, has_notifications=None) -> web.Response:
    """Search Trips
...
async def search_trips(request: web.Request, version, account_id, sort_field, descending, start, limit, active_only, start_date=None, end_date=None, matched_has_route=None, matched_has_driver=None) -> web.Response:
    """Search Trips
...
async def update_locations(request: web.Request, version, id, body=None) -> web.Response:
...
async def update_recurrence_locations(request: web.Request, version, id, body=None) -> web.Response:
...
async def update_recurrence_shipments(request: web.Request, version, id, body=None) -> web.Response:
...
async def update_shipments(request: web.Request, version, id, body=None) -> web.Response:
...
async def update_trip(request: web.Request, version, id, body=None) -> web.Response:
    """Update Trip
...
async def update_trip_notifications(request: web.Request, version, id, notifications=None) -> web.Response:
    """Trip Notifications
