...
async def add_field(request: web.Request, account_id, app_key, object_name, field_name, field_type) -> web.Response:
    """Create Field
...
async def create_data(request: web.Request, object_name, account_id=None, body=None) -> web.Response:
    """Create Data
...
async def create_object(request: web.Request, account_id, app_key, object_name) -> web.Response:
    """Create Object
...
async def delete_data(request: web.Request, object_name, object_id, account_id=None) -> web.Response:
    """Delete Data
...
async def delete_field(request: web.Request, account_id, app_key, object_name, field_name) -> web.Response:
    """Delete Field
...
async def delete_object(request: web.Request, account_id, app_key, object_name) -> web.Response:
    """Delete Object
...
async def get_data(request: web.Request, object_name, object_id, account_id=None, include=None) -> web.Response:
    """Get Data
...
async def get_object(request: web.Request, account_id, app_key, object_name) -> web.Response:
    """Get Object
...
async def search_data(request: web.Request, object_name, count, start, limit, account_id=None, criteria=None, order=None, include=None) -> web.Response:
    """Search Data
...
async def search_object(request: web.Request, account_id, app_key, start, limit, keyword=None) -> web.Response:
    """Search Objects
...
async def update_data(request: web.Request, object_name, object_id, account_id=None, body=None) -> web.Response:
    """Update Data
