...
async def add_movie(request: web.Request, account_id, movie_name, third_party_account_id=None, tags=None, file=None, url=None, param_callback=None) -> web.Response:
    """Add Movie
...
async def ai_docs(request: web.Request, account_id, doc, return_topics=None, limit=None, offset=None) -> web.Response:
    """Search Docs
...
async def ai_find_images(request: web.Request, account_id, text, parse_flag=None, fetch_flag=None, size=None) -> web.Response:
    """Find images
...
async def ai_tags(request: web.Request, account_id, tags, conditional=None, limit=None, offset=None) -> web.Response:
    """Search Tags
...
async def ai_text(request: web.Request, account_id, terms, conditional=None, limit=None, offset=None) -> web.Response:
    """Search Text
...
async def batch(request: web.Request, account_id, third_party_account_id=None, limit=None, operations=None, file=None, url=None, param_callback=None) -> web.Response:
    """Batch Analysis
...
async def create_instant_episode(request: web.Request, account_id, data) -> web.Response:
...
async def create_voice_canvas(request: web.Request, account_id, dimensions, third_party_account_id=None, text=None, file=None, url=None, parse_flag=None, fetch_flag=None, param_callback=None) -> web.Response:
...
async def emotion(request: web.Request, account_id, third_party_account_id=None, file=None, url=None, param_callback=None) -> web.Response:
    """Detect emotions
...
async def get_add_movie_result(request: web.Request, request_id, account_id) -> web.Response:
...
async def get_batch(request: web.Request, request_id, account_id) -> web.Response:
...
async def get_emotion(request: web.Request, request_id, account_id) -> web.Response:
    """Get Emotion Results
...
async def get_episode_status(request: web.Request, episode_id, account_id) -> web.Response:
...
async def get_render_status(request: web.Request, render_id, account_id) -> web.Response:
    """Check episode status
...
async def get_stt(request: web.Request, request_id, account_id) -> web.Response:
...
async def get_tech_tune(request: web.Request, request_id, account_id) -> web.Response:
...
async def get_topics(request: web.Request, request_id, account_id) -> web.Response:
    """Get Topics
...
async def get_tts(request: web.Request, request_id, account_id) -> web.Response:
...
async def get_voice_canvas(request: web.Request, request_id, account_id) -> web.Response:
...
async def start_video_render(request: web.Request, account_id, data) -> web.Response:
...
async def stt(request: web.Request, account_id, third_party_account_id=None, source_language=None, target_language=None, file=None, url=None, param_callback=None) -> web.Response:
    """Speach to Text
...
async def summarize_topics(request: web.Request, account_id, third_party_account_id=None, doc=None, file=None, url=None, limit=None, offset=None, param_callback=None) -> web.Response:
    """Summarize Topics
...
async def tech_tune(request: web.Request, account_id, num_faces_expected, third_party_account_id=None, file=None, url=None, param_callback=None) -> web.Response:
...
async def tts(request: web.Request, account_id, text, third_party_account_id=None, language=None, voice=None, param_callback=None) -> web.Response:
    """Text to Speach
