...
async def create_route_settings(request: web.Request, version, body=None) -> web.Response:
...
async def delete_route_settings(request: web.Request, version, route_settings_id) -> web.Response:
...
async def get_route_settings(request: web.Request, version, route_settings_id) -> web.Response:
    """Get Route Setting
...
async def search_route_settings(request: web.Request, version, sort_field, descending, start, limit, active_only, hub_id=None, program_id=None, keyword=None) -> web.Response:
...
async def update_route_settings(request: web.Request, version, route_settings_id, body=None) -> web.Response:
