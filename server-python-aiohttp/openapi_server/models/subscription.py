...
class Subscription(Model):
    ...
    def __init__(self, id: int=None, active: bool=None, valid: bool=None, subscription_plan: SubscriptionPlan=None, remote_subscription_id: str=None, promo_code: str=None, failed: bool=None, message: str=None):
    ...
    @property
    def remote_subscription_id(self):
    ...
    def remote_subscription_id(self, remote_subscription_id):
