...
class LocalTime(Model):
    ...
    def __init__(self, chronology: Chronology=None, hour_of_day: int=None, minute_of_hour: int=None, second_of_minute: int=None, millis_of_second: int=None, millis_of_day: int=None, fields: List[DateTimeField]=None, values: List[int]=None, field_types: List[DateTimeFieldType]=None):
