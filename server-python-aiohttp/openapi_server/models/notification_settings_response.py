...
class NotificationSettingsResponse(Model):
    ...
    def __init__(self, blocked_notifications: list[str]=None):
    ...
    def from_dict(cls, dikt: dict) -> 'NotificationSettingsResponse':
        ...
        :param dikt: A dict.
        :return: The NotificationSettingsResponse of this NotificationSettingsResponse.
        """
        return util.deserialize_model(dikt, cls)

    @property
    def blocked_notifications(self):
    ...
    def blocked_notifications(self, blocked_notifications):
        ...
        if not set(blocked_notifications).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `blocked_notifications` [{0}], must be a subset of [{1}]"
                .format(", ".join(map(str, set(blocked_notifications) - set(allowed_values))),
