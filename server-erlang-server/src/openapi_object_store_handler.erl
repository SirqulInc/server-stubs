...
- `POST` to `/object/field/add`, OperationId: `addField`:
Create Field.
...
- `POST` to `/object/data/:objectName`, OperationId: `createData`:
Create Data.
...
- `POST` to `/object/create`, OperationId: `createObject`:
Create Object.
...
- `DELETE` to `/object/data/:objectName/:objectId`, OperationId: `deleteData`:
Delete Data.
Delete a record for the specified object. Cannot be undone so use only when abolutely sure.

- `POST` to `/object/field/delete`, OperationId: `deleteField`:
Delete Field.
...
- `POST` to `/object/delete`, OperationId: `deleteObject`:
Delete Object.
...
- `GET` to `/object/data/:objectName/:objectId`, OperationId: `getData`:
Get Data.
Get a specific record from a specified object.

- `GET` to `/object/get`, OperationId: `getObject`:
Get Object.
...
- `PUT` to `/object/data/:objectName/:objectId`, OperationId: `updateData`:
Update Data.
