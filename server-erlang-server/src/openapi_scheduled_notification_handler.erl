...
- `POST` to `/notification/schedule/create`, OperationId: `createScheduledNotification`:
...
- `POST` to `/notification/schedule/delete`, OperationId: `deleteScheduledNotification`:
...
- `GET` to `/notification/schedule/get`, OperationId: `getScheduledNotification`:
Get Scheduled Notification.
Get a ScheduledNotification

- `POST` to `/notification/schedule/generate`, OperationId: `scheduleNotificationListings`:
...
- `GET` to `/notification/schedule/search`, OperationId: `searchScheduledNotifications`:
...
- `POST` to `/notification/schedule/update`, OperationId: `updateScheduledNotification`:
