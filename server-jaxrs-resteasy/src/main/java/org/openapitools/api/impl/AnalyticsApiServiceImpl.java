...
public class AnalyticsApiServiceImpl implements AnalyticsApiService {
      public Response activities(Integer start,Integer limit,Long accountId,SecurityContext securityContext)
