...
public class BillableEntityApiControllerImp extends BillableEntityApiControllerImpInterface {
    ...
    @Override
    public SirqulResponse deleteBillableEntity(Http.Request request, String deviceId, Long accountId) throws Exception {
        //Do your magic!!!
        return new SirqulResponse();
    }

    @Override
    public BillableEntityResponse getBillableEntity(Http.Request request, String deviceId, Long accountId, Boolean includeCounts, Boolean includePayments) throws Exception {
        //Do your magic!!!
        return new BillableEntityResponse();
    }
