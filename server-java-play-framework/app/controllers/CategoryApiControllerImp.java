...
public class CategoryApiControllerImp extends CategoryApiControllerImpInterface {
    ...
    @Override
    public SirqulResponse deleteCategory(Http.Request request, @NotNull Long accountId, @NotNull Long categoryId) throws Exception {
        //Do your magic!!!
        return new SirqulResponse();
    }

    @Override
    public CategoryTreeResponse duplicateCategory(Http.Request request, @NotNull Long accountId, @NotNull Long categoryId, String appKey, Long parentCategoryId) throws Exception {
        //Do your magic!!!
        return new CategoryTreeResponse();
    }

    @Override
    public CategoryTreeResponse getCategory(Http.Request request, @NotNull Long categoryId, Boolean returnExternal) throws Exception {
        //Do your magic!!!
        return new CategoryTreeResponse();
    }

    @Override
    public List<CategoryResponse> searchCategories(Http.Request request, Long accountId, String keyword, String appKey, String categoryId, String categoryIds, String parentCategoryIds, Boolean rootOnly, String sortField, String responseGroup, Boolean descending, Integer start, Integer limit, Boolean activeOnly, Boolean returnExternal, Boolean exactMatch, String type, String externalType, Boolean excludeExternalType, Integer minOfferCount, Integer searchDepth, String searchMode) throws Exception {
        //Do your magic!!!
        return new ArrayList<CategoryResponse>();
    }

    @Override
    public CategoryTreeResponse updateCategory(Http.Request request, @NotNull Long accountId, @NotNull Long categoryId, Long parentCategoryId, String name, String description, String type, Long assetId, String externalId, String externalType, String externalCategorySlug, String sqootSlug, Boolean active, String metaData, String searchTags) throws Exception {
        //Do your magic!!!
        return new CategoryTreeResponse();
    }
