...
public abstract class AnalyticsApiControllerImpInterface {
    ...
    public Result activitiesHttp(Http.Request request, @NotNull Integer start, @NotNull Integer limit, @NotNull Long accountId) throws Exception {
        List<UserActivityResponse> obj = activities(request, start, limit, accountId);
    ...
    public abstract SirqulResponse usage(Http.Request request, @NotNull String tag, String deviceId, Long accountId, Long applicationId, String appKey, String appVersion, String device, String deviceType, String deviceOS, String model, Double latitude, Double longitude, Long customId, String customType, Long achievementIncrement, String city, String state, String country, String zip, String locationDescription, Long clientTime, String errorMessage, String ip, String userAgent, Boolean backgroundEvent, String customMessage, String customMessage2, Double customValue, Double customValue2, Long customLong, Long customLong2) throws Exception;

    public Result usageBatchHttp(Http.Request request, @NotNull String appKey, @NotNull String device, @NotNull String data, String deviceId, Long accountId, String appVersion, String deviceType, String deviceOS, String model, Boolean updateRanking, Boolean returnSummaryResponse) throws Exception {
        SirqulResponse obj = usageBatch(request, appKey, device, data, deviceId, accountId, appVersion, deviceType, deviceOS, model, updateRanking, returnSummaryResponse);
    ...
    public abstract SirqulResponse usageBatch(Http.Request request, @NotNull String appKey, @NotNull String device, @NotNull String data, String deviceId, Long accountId, String appVersion, String deviceType, String deviceOS, String model, Boolean updateRanking, Boolean returnSummaryResponse) throws Exception;
