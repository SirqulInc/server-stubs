...
public class ScheduledNotificationApiControllerImp extends ScheduledNotificationApiControllerImpInterface {
    @Override
    public ScheduledNotificationFullResponse createScheduledNotification(Http.Request request, @NotNull Long accountId, @NotNull String name, @NotNull String type, @NotNull String message, Long contentId, String contentName, String contentType, Long parentId, String parentType, String appKey, String groupingId, String connectionGroupIds, String connectionAccountIds, Long audienceId, String audienceIds, String albumIds, Long reportId, String reportParams, String endpointURL, String payload, Long scheduledDate, Long startDate, Long endDate, String cronExpression, String cronType, String metaData, String conditionalInput, String templateType, String visibility, Boolean active, Boolean sendNow, String eventType, String deepLinkURI, Boolean sendToAll) throws Exception {
        //Do your magic!!!
        return new ScheduledNotificationFullResponse();
    }

    @Override
    public ScheduledNotificationFullResponse deleteScheduledNotification(Http.Request request, @NotNull Long accountId, @NotNull Long scheduledNotificationId, Boolean deleteByGroupingId) throws Exception {
        //Do your magic!!!
        return new ScheduledNotificationFullResponse();
    }

    @Override
    public ScheduledNotificationFullResponse getScheduledNotification(Http.Request request, @NotNull Long accountId, @NotNull Long scheduledNotificationId) throws Exception {
        //Do your magic!!!
        return new ScheduledNotificationFullResponse();
    }

    @Override
    public SirqulResponse scheduleNotificationListings(Http.Request request, @NotNull Long accountId, @NotNull String appKey, @NotNull String reportName, @NotNull String message, @NotNull Integer offset, @NotNull Long recipientReportId, String reportParams, String type) throws Exception {
        //Do your magic!!!
