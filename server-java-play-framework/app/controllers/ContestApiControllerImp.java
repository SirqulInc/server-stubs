...
public class ContestApiControllerImp extends ContestApiControllerImpInterface {
    @Override
    public AlbumContestResponse addOrUpdateAlbumContest(Http.Request request, @NotNull Boolean publicRead, @NotNull Boolean publicWrite, @NotNull Boolean publicDelete, @NotNull Boolean publicAdd, @NotNull String visibility, @NotNull Boolean includeFriendGroup, String deviceId, Long accountId, String gameType, String appKey, String contestType, Long albumContestId, String title, String description, Long albumId1, Boolean removeAlbum1, Long albumId2, Boolean removeAlbum2, Long startDate, Long endDate, String locationDescription, String connectionIdsToAdd, String connectionGroupIdsToAdd, Double latitude, Double longitude) throws Exception {
        //Do your magic!!!
        return new AlbumContestResponse();
    }

    @Override
    public SirqulResponse approveAlbumContest(Http.Request request, @NotNull Long albumContestId, @NotNull String approvalStatus, String deviceId, Long accountId) throws Exception {
        //Do your magic!!!
        return new SirqulResponse();
    }

    @Override
    public SirqulResponse deleteContest(Http.Request request, @NotNull Long albumContestId, String deviceId, Long accountId, Double latitude, Double longitude) throws Exception {
        //Do your magic!!!
        return new SirqulResponse();
    }

    @Override
    public AlbumContestResponse getAlbumContest(Http.Request request, @NotNull Long albumContestId, String deviceId, Long accountId, Double latitude, Double longitude) throws Exception {
        //Do your magic!!!
        return new AlbumContestResponse();
    }
    ...
    @Override
    public AlbumContestResponse voteOnAlbumContest(Http.Request request, @NotNull Long albumContestId, @NotNull Long albumId, String deviceId, Long accountId, String contestType, Double latitude, Double longitude) throws Exception {
        //Do your magic!!!
        return new AlbumContestResponse();
    }
