...
public class OfferApiControllerImp extends OfferApiControllerImpInterface {
    @Override
    public SirqulResponse batchUpdateOfferLocations(Http.Request request, @NotNull String data, String deviceId, Long accountId) throws Exception {
        //Do your magic!!!
    ...
    @Override
    public SirqulResponse deleteOffer(Http.Request request, @NotNull Long offerId, String deviceId, Long accountId) throws Exception {
        //Do your magic!!!
        return new SirqulResponse();
    }

    @Override
    public SirqulResponse deleteOfferLocation(Http.Request request, @NotNull Long offerLocationId, String deviceId, Long accountId) throws Exception {
        //Do your magic!!!
        return new SirqulResponse();
    }

    @Override
    public RetailerOfferResponse getOffer(Http.Request request, @NotNull Long offerId, @NotNull Boolean includeOfferLocations, String deviceId, Long accountId) throws Exception {
        //Do your magic!!!
        return new RetailerOfferResponse();
    }

    @Override
    public OfferResponse getOfferDetails(Http.Request request, String deviceId, Long accountId, Long offerId, Long offerLocationId, Double distance, Double latitude, Double longitude, Boolean includeOfferLocations, Boolean includeRetailerLocations, Boolean includeChildOffers) throws Exception {
        //Do your magic!!!
        return new OfferResponse();
    }

    @Override
    public ListCountResponse getOfferListCounts(Http.Request request, @NotNull Double latitude, @NotNull Double longitude, BigDecimal searchRange, String distanceUnit) throws Exception {
        //Do your magic!!!
        return new ListCountResponse();
    }

    @Override
    public OfferShortResponse getOfferLocation(Http.Request request, Long offerLocationId, String udid) throws Exception {
        //Do your magic!!!
