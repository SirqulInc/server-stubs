...
class AnalyticsApi(implicit val swagger: Swagger) extends ScalatraServlet
  ...
  val activitiesOperation = (apiOperation[List[UserActivityResponse]]("activities")
    ...
    parameters(pathParam[Double]("version").description(""), queryParam[Int]("start").description(""), queryParam[Int]("limit").description(""), queryParam[Long]("accountId").description(""))
  )

  get("/api/:version/analytics/useractivity", operation(activitiesOperation)) {
  ...
  get("/api/:version/analytics/aggregatedFilteredUsage", operation(aggregatedFilteredUsageOperation)) {
    val version = params.getOrElse("version", halt(400))
    //println("version: " + version)
  ...
  get("/api/:version/analytics/filteredUsage", operation(filteredUsageOperation)) {
    val version = params.getOrElse("version", halt(400))
    //println("version: " + version)
            val deviceId = params.getAs[String]("deviceId")
  ...
  val usageBatchOperation = (apiOperation[SirqulResponse]("usageBatch")
    ...
    parameters(pathParam[Double]("version").description(""), queryParam[String]("appKey").description(""), queryParam[String]("device").description(""), queryParam[String]("data").description(""), queryParam[String]("deviceId").description("").optional, queryParam[Long]("accountId").description("").optional, queryParam[String]("appVersion").description("").optional, queryParam[String]("deviceType").description("").optional, queryParam[String]("deviceOS").description("").optional, queryParam[String]("model").description("").optional, queryParam[Boolean]("updateRanking").description("").optional, queryParam[Boolean]("returnSummaryResponse").description("").optional)
  )

  post("/api/:version/analytics/usage/batch", operation(usageBatchOperation)) {
    val version = params.getOrElse("version", halt(400))
    //println("version: " + version)
            val appKey = params.getAs[String]("appKey")
