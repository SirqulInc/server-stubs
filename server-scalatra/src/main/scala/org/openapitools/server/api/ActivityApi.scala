...
import org.openapitools.server.model.ActivityResponse
import org.openapitools.server.model.EntityReference
...
class ActivityApi(implicit val swagger: Swagger) extends ScalatraServlet
  with FileUploadSupport
  with JacksonJsonSupport
  with SwaggerSupport {
  protected implicit val jsonFormats: Formats = DefaultFormats

  protected val applicationDescription: String = "ActivityApi"
