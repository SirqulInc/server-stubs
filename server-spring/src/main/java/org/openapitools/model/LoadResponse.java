...
public class LoadResponse {
  ...
  public LoadResponse id(@Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public LoadResponse name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public LoadResponse size(@Nullable Long size) {
    this.size = size;
    return this;
  }
  ...
  public LoadResponse loadingTime(@Nullable Long loadingTime) {
  ...
  public LoadResponse separatePayloads(@Nullable Boolean separatePayloads) {
  ...
  public LoadResponse pickup(@Nullable StopResponse pickup) {
    this.pickup = pickup;
    return this;
  }
  ...
  public LoadResponse dropoff(@Nullable StopResponse dropoff) {
