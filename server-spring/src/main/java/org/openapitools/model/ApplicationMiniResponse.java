...
public class ApplicationMiniResponse {
  ...
  public ApplicationMiniResponse valid(@Nullable Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public ApplicationMiniResponse message(@Nullable String message) {
  ...
  public ApplicationMiniResponse version(@Nullable Double version) {
  ...
  public ApplicationMiniResponse serializeNulls(@Nullable Boolean serializeNulls) {
  ...
  public ApplicationMiniResponse startTimeLog(@Nullable Long startTimeLog) {
  ...
  public ApplicationMiniResponse errorCode(@Nullable String errorCode) {
  ...
  public ApplicationMiniResponse applicationId(@Nullable Long applicationId) {
  ...
  public ApplicationMiniResponse appKey(@Nullable String appKey) {
    this.appKey = appKey;
    return this;
  }
  ...
  public ApplicationMiniResponse title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public ApplicationMiniResponse currentBuildVersion(@Nullable String currentBuildVersion) {
  ...
  public ApplicationMiniResponse currentApiVersion(@Nullable String currentApiVersion) {
  ...
  public ApplicationMiniResponse appIcon(@Nullable AssetShortResponse appIcon) {
  ...
  public ApplicationMiniResponse appLogo(@Nullable AssetShortResponse appLogo) {
  ...
  public ApplicationMiniResponse active(@Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public ApplicationMiniResponse returning(@Nullable String returning) {
