...
public class RuleListResponse {
  ...
  public RuleListResponse start(@Nullable Integer start) {
    this.start = start;
    return this;
  }
  ...
  public RuleListResponse limit(@Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public RuleListResponse countTotal(@Nullable Long countTotal) {
  ...
  public RuleListResponse count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public RuleListResponse hasMoreResults(@Nullable Boolean hasMoreResults) {
