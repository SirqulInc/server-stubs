...
public class EmployeeResponse {
  ...
  private @Nullable Boolean hasDelegateAccess;
  ...
  public EmployeeResponse accountId(@Nullable Long accountId) {
  ...
  public EmployeeResponse locationDisplay(@Nullable String locationDisplay) {
  ...
  public EmployeeResponse display(@Nullable String display) {
  ...
  public EmployeeResponse username(@Nullable String username) {
  ...
  public EmployeeResponse accountType(@Nullable String accountType) {
  ...
  public EmployeeResponse profileImage(@Nullable String profileImage) {
  ...
  public EmployeeResponse gender(@Nullable GenderEnum gender) {
    this.gender = gender;
    return this;
  }
  ...
  public EmployeeResponse contactEmail(@Nullable String contactEmail) {
  ...
  public EmployeeResponse contact(@Nullable ContactResponse contact) {
  ...
  public EmployeeResponse manager(@Nullable AccountMiniResponse manager) {
  ...
  public EmployeeResponse active(@Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public EmployeeResponse hasDelegateAccess(@Nullable Boolean hasDelegateAccess) {
  ...
  @Schema(name = "hasDelegateAccess", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("hasDelegateAccess")
  public @Nullable Boolean getHasDelegateAccess() {
    return hasDelegateAccess;
  }

  public void setHasDelegateAccess(@Nullable Boolean hasDelegateAccess) {
    this.hasDelegateAccess = hasDelegateAccess;
  }

  public EmployeeResponse latitude(@Nullable Double latitude) {
  ...
  public EmployeeResponse longitude(@Nullable Double longitude) {
  ...
  public EmployeeResponse locationLastUpdated(@Nullable Long locationLastUpdated) {
  ...
  public EmployeeResponse locationCount(@Nullable Integer locationCount) {
  ...
  @Schema(name = "locationCount", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("locationCount")
  public @Nullable Integer getLocationCount() {
    return locationCount;
  }

  public void setLocationCount(@Nullable Integer locationCount) {
    this.locationCount = locationCount;
  }
