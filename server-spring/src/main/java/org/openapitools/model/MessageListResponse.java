...
public class MessageListResponse {
  ...
  public MessageListResponse start(@Nullable Integer start) {
    this.start = start;
    return this;
  }
  ...
  public MessageListResponse limit(@Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public MessageListResponse countTotal(@Nullable Long countTotal) {
  ...
  public MessageListResponse count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public MessageListResponse hasMoreResults(@Nullable Boolean hasMoreResults) {
