...
public class FilterTreeResponse {
  ...
  public FilterTreeResponse filterId(@Nullable Long filterId) {
  ...
  public FilterTreeResponse name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public FilterTreeResponse display(@Nullable String display) {
  ...
  public FilterTreeResponse subFilterCount(@Nullable Integer subFilterCount) {
  ...
  public FilterTreeResponse parentId(@Nullable Long parentId) {
  ...
  public FilterTreeResponse description(@Nullable String description) {
  ...
  public FilterTreeResponse active(@Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public FilterTreeResponse externalId(@Nullable String externalId) {
  ...
  public FilterTreeResponse externalType(@Nullable String externalType) {
