...
public class OrsonAiBatchEmotionsResponse {
  ...
  private @Nullable OrsonAiEmotionsResponse result;

  public OrsonAiBatchEmotionsResponse requestId(@Nullable String requestId) {
  ...
  public OrsonAiBatchEmotionsResponse responseCode(@Nullable Integer responseCode) {
  ...
  public OrsonAiBatchEmotionsResponse responseRaw(@Nullable String responseRaw) {
  ...
  public OrsonAiBatchEmotionsResponse status(@Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public OrsonAiBatchEmotionsResponse error(@Nullable String error) {
    this.error = error;
    return this;
  }
  ...
  public OrsonAiBatchEmotionsResponse result(@Nullable OrsonAiEmotionsResponse result) {
    this.result = result;
    return this;
  }
  ...
  @JsonProperty("result")
  public @Nullable OrsonAiEmotionsResponse getResult() {
    return result;
  }

  public void setResult(@Nullable OrsonAiEmotionsResponse result) {
    this.result = result;
  }
