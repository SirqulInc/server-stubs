...
public class OfferListResponse {
  ...
  public OfferListResponse valid(@Nullable Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public OfferListResponse message(@Nullable String message) {
  ...
  public OfferListResponse version(@Nullable Double version) {
  ...
  public OfferListResponse serializeNulls(@Nullable Boolean serializeNulls) {
  ...
  public OfferListResponse startTimeLog(@Nullable Long startTimeLog) {
  ...
  public OfferListResponse errorCode(@Nullable String errorCode) {
  ...
  public OfferListResponse hasMoreResults(@Nullable Boolean hasMoreResults) {
  ...
  public OfferListResponse count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public OfferListResponse start(@Nullable Integer start) {
    this.start = start;
    return this;
  }
  ...
  public OfferListResponse limit(@Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public OfferListResponse countTotal(@Nullable Long countTotal) {
  ...
  public OfferListResponse returning(@Nullable String returning) {
