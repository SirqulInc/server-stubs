...
public class RoutingListResponse {
  ...
  public RoutingListResponse valid(@Nullable Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public RoutingListResponse message(@Nullable String message) {
  ...
  public RoutingListResponse version(@Nullable Double version) {
  ...
  public RoutingListResponse serializeNulls(@Nullable Boolean serializeNulls) {
  ...
  public RoutingListResponse startTimeLog(@Nullable Long startTimeLog) {
  ...
  public RoutingListResponse errorCode(@Nullable String errorCode) {
  ...
  public RoutingListResponse count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public RoutingListResponse returning(@Nullable String returning) {
