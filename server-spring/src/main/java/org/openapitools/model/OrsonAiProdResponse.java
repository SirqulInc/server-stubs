...
public class OrsonAiProdResponse {
  ...
  public OrsonAiProdResponse requestId(@Nullable String requestId) {
  ...
  public OrsonAiProdResponse responseCode(@Nullable Integer responseCode) {
  ...
  public OrsonAiProdResponse responseRaw(@Nullable String responseRaw) {
