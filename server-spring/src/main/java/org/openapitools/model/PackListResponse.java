...
public class PackListResponse {
  ...
  public PackListResponse start(@Nullable Integer start) {
    this.start = start;
    return this;
  }
  ...
  public PackListResponse limit(@Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public PackListResponse countTotal(@Nullable Long countTotal) {
  ...
  public PackListResponse count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PackListResponse hasMoreResults(@Nullable Boolean hasMoreResults) {
