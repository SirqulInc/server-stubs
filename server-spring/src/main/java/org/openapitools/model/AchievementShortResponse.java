...
public class AchievementShortResponse {
  ...
  public AchievementShortResponse valid(@Nullable Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public AchievementShortResponse message(@Nullable String message) {
  ...
  public AchievementShortResponse version(@Nullable Double version) {
  ...
  public AchievementShortResponse serializeNulls(@Nullable Boolean serializeNulls) {
  ...
  public AchievementShortResponse startTimeLog(@Nullable Long startTimeLog) {
  ...
  public AchievementShortResponse errorCode(@Nullable String errorCode) {
  ...
  public AchievementShortResponse achievementId(@Nullable Long achievementId) {
  ...
  public AchievementShortResponse title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public AchievementShortResponse description(@Nullable String description) {
  ...
  public AchievementShortResponse analyticsTag(@Nullable String analyticsTag) {
  ...
  public AchievementShortResponse rankType(@Nullable String rankType) {
  ...
  public AchievementShortResponse rankIncrement(@Nullable Integer rankIncrement) {
  ...
  public AchievementShortResponse validate(@Nullable Boolean validate) {
  ...
  public AchievementShortResponse appName(@Nullable String appName) {
  ...
  public AchievementShortResponse active(@Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public AchievementShortResponse updated(@Nullable Long updated) {
  ...
  public AchievementShortResponse created(@Nullable Long created) {
  ...
  public AchievementShortResponse tierCount(@Nullable Integer tierCount) {
  ...
  public AchievementShortResponse minIncrement(@Nullable Integer minIncrement) {
  ...
  public AchievementShortResponse maxIncrement(@Nullable Integer maxIncrement) {
  ...
  public AchievementShortResponse returning(@Nullable String returning) {
