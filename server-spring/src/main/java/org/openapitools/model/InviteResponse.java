...
public class InviteResponse {
  ...
  public InviteResponse valid(@Nullable Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public InviteResponse message(@Nullable String message) {
  ...
  public InviteResponse version(@Nullable Double version) {
  ...
  public InviteResponse serializeNulls(@Nullable Boolean serializeNulls) {
  ...
  public InviteResponse startTimeLog(@Nullable Long startTimeLog) {
  ...
  public InviteResponse errorCode(@Nullable String errorCode) {
  ...
  public InviteResponse url(@Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public InviteResponse token(@Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public InviteResponse offerId(@Nullable Long offerId) {
  ...
  public InviteResponse offerLocationId(@Nullable Long offerLocationId) {
  ...
  public InviteResponse returning(@Nullable String returning) {
