...
public class ListResponse {
  ...
  public ListResponse valid(@Nullable Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public ListResponse message(@Nullable String message) {
  ...
  public ListResponse version(@Nullable Double version) {
  ...
  public ListResponse serializeNulls(@Nullable Boolean serializeNulls) {
  ...
  public ListResponse startTimeLog(@Nullable Long startTimeLog) {
  ...
  public ListResponse errorCode(@Nullable String errorCode) {
  ...
  public ListResponse count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public ListResponse returning(@Nullable String returning) {
