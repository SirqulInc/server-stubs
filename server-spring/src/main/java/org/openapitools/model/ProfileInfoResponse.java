...
public class ProfileInfoResponse {
  ...
  public ProfileInfoResponse valid(@Nullable Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public ProfileInfoResponse message(@Nullable String message) {
  ...
  public ProfileInfoResponse version(@Nullable Double version) {
  ...
  public ProfileInfoResponse serializeNulls(@Nullable Boolean serializeNulls) {
  ...
  public ProfileInfoResponse startTimeLog(@Nullable Long startTimeLog) {
  ...
  public ProfileInfoResponse errorCode(@Nullable String errorCode) {
  ...
  public ProfileInfoResponse accountId(@Nullable Long accountId) {
  ...
  public ProfileInfoResponse locationDisplay(@Nullable String locationDisplay) {
  ...
  public ProfileInfoResponse display(@Nullable String display) {
  ...
  public ProfileInfoResponse username(@Nullable String username) {
  ...
  public ProfileInfoResponse profileImage(@Nullable String profileImage) {
  ...
  public ProfileInfoResponse profileAvatar(@Nullable AssetShortResponse profileAvatar) {
  ...
  public ProfileInfoResponse aboutUs(@Nullable String aboutUs) {
  ...
  public ProfileInfoResponse locale(@Nullable String locale) {
    this.locale = locale;
    return this;
  }
  ...
  public ProfileInfoResponse summaryTitle(@Nullable String summaryTitle) {
  ...
  public ProfileInfoResponse gender(@Nullable GenderEnum gender) {
    this.gender = gender;
    return this;
  }
  ...
  public ProfileInfoResponse age(@Nullable String age) {
    this.age = age;
    return this;
  }
  ...
  public ProfileInfoResponse gameExperience(@Nullable GameExperienceEnum gameExperience) {
  ...
  public ProfileInfoResponse contact(@Nullable ContactResponse contact) {
  ...
  public ProfileInfoResponse personalProfile(@Nullable PersonalProfileResponse personalProfile) {
  ...
  public ProfileInfoResponse userSettings(@Nullable UserSettingsResponse userSettings) {
  ...
  public ProfileInfoResponse latitude(@Nullable Double latitude) {
  ...
  public ProfileInfoResponse longitude(@Nullable Double longitude) {
  ...
  public ProfileInfoResponse currentPostalCode(@Nullable PostalCodeResponse currentPostalCode) {
  ...
  public ProfileInfoResponse accountType(@Nullable String accountType) {
  ...
  public ProfileInfoResponse premiumExpiration(@Nullable Long premiumExpiration) {
  ...
  public ProfileInfoResponse matchIndex(@Nullable Integer matchIndex) {
  ...
  public ProfileInfoResponse tags(@Nullable String tags) {
    this.tags = tags;
    return this;
  }
  ...
  public ProfileInfoResponse returning(@Nullable String returning) {
