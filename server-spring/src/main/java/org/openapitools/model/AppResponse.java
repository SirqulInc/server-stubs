...
public class AppResponse {
  ...
  private @Nullable MissionListResponse missions;

  private @Nullable ProfileResponse profile;

  private @Nullable MessageListResponse messages;

  private @Nullable String returning;

  public AppResponse valid(@Nullable Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public AppResponse message(@Nullable String message) {
  ...
  public AppResponse version(@Nullable Double version) {
  ...
  public AppResponse serializeNulls(@Nullable Boolean serializeNulls) {
  ...
  public AppResponse startTimeLog(@Nullable Long startTimeLog) {
  ...
  public AppResponse errorCode(@Nullable String errorCode) {
  ...
  public AppResponse missions(@Nullable MissionListResponse missions) {
  ...
  public @Nullable MissionListResponse getMissions() {
    return missions;
  }

  public void setMissions(@Nullable MissionListResponse missions) {
    this.missions = missions;
  }

  public AppResponse profile(@Nullable ProfileResponse profile) {
  ...
  public void setProfile(@Nullable ProfileResponse profile) {
    this.profile = profile;
  }

  public AppResponse messages(@Nullable MessageListResponse messages) {
  ...
  public @Nullable MessageListResponse getMessages() {
    return messages;
  }

  public void setMessages(@Nullable MessageListResponse messages) {
    this.messages = messages;
  }

  public AppResponse returning(@Nullable String returning) {
