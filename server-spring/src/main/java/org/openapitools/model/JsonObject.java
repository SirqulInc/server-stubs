...
public class JsonObject {
  ...
  public JsonObject asInt(@Nullable Integer asInt) {
    this.asInt = asInt;
    return this;
  }
  ...
  public JsonObject asJsonObject(@Nullable JsonObject asJsonObject) {
  ...
  public JsonObject jsonNull(@Nullable Boolean jsonNull) {
  ...
  public JsonObject asString(@Nullable String asString) {
  ...
  public JsonObject asBoolean(@Nullable Boolean asBoolean) {
  ...
  public JsonObject jsonArray(@Nullable Boolean jsonArray) {
  ...
  public JsonObject jsonObject(@Nullable Boolean jsonObject) {
  ...
  public JsonObject jsonPrimitive(@Nullable Boolean jsonPrimitive) {
  ...
  public JsonObject asJsonArray(@Nullable JsonArray asJsonArray) {
  ...
  public JsonObject asJsonPrimitive(@Nullable JsonPrimitive asJsonPrimitive) {
  ...
  public JsonObject asJsonNull(@Nullable JsonNull asJsonNull) {
  ...
  public JsonObject asNumber(@Nullable Object asNumber) {
  ...
  public JsonObject asDouble(@Nullable Double asDouble) {
  ...
  public JsonObject asFloat(@Nullable Float asFloat) {
  ...
  public JsonObject asLong(@Nullable Long asLong) {
    this.asLong = asLong;
    return this;
  }
  ...
  public JsonObject asByte(@Nullable byte[] asByte) {
    this.asByte = asByte;
    return this;
  }
  ...
  public JsonObject asCharacter(@Nullable String asCharacter) {
  ...
  public JsonObject asBigDecimal(@Nullable BigDecimal asBigDecimal) {
  ...
  public JsonObject asBigInteger(@Nullable Integer asBigInteger) {
  ...
  public JsonObject asShort(@Nullable Integer asShort) {
