...
public class AssetShortResponse {
  ...
  public AssetShortResponse valid(@Nullable Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public AssetShortResponse message(@Nullable String message) {
  ...
  public AssetShortResponse version(@Nullable Double version) {
  ...
  public AssetShortResponse serializeNulls(@Nullable Boolean serializeNulls) {
  ...
  public AssetShortResponse startTimeLog(@Nullable Long startTimeLog) {
  ...
  public AssetShortResponse errorCode(@Nullable String errorCode) {
  ...
  public AssetShortResponse assetId(@Nullable Long assetId) {
  ...
  public AssetShortResponse fileName(@Nullable String fileName) {
  ...
  public AssetShortResponse caption(@Nullable String caption) {
  ...
  public AssetShortResponse mediaType(@Nullable String mediaType) {
  ...
  public AssetShortResponse thumbnailURL(@Nullable String thumbnailURL) {
  ...
  public AssetShortResponse coverURL(@Nullable String coverURL) {
  ...
  public AssetShortResponse fullURL(@Nullable String fullURL) {
  ...
  public AssetShortResponse assetVersion(@Nullable String assetVersion) {
  ...
  public AssetShortResponse versionName(@Nullable String versionName) {
  ...
  public AssetShortResponse versionCode(@Nullable Integer versionCode) {
  ...
  public AssetShortResponse returning(@Nullable String returning) {
