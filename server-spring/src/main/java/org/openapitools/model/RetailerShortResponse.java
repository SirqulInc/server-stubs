...
public class RetailerShortResponse {
  ...
  public RetailerShortResponse retailerId(@Nullable Long retailerId) {
  ...
  public RetailerShortResponse name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public RetailerShortResponse facebookUrl(@Nullable String facebookUrl) {
  ...
  public RetailerShortResponse twitterUrl(@Nullable String twitterUrl) {
  ...
  public RetailerShortResponse active(@Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public RetailerShortResponse contact(@Nullable ContactInfoResponse contact) {
  ...
  public RetailerShortResponse logo(@Nullable AssetShortResponse logo) {
    this.logo = logo;
    return this;
  }
  ...
  public RetailerShortResponse picture1(@Nullable AssetShortResponse picture1) {
  ...
  public RetailerShortResponse picture2(@Nullable AssetShortResponse picture2) {
  ...
  public RetailerShortResponse latitude(@Nullable Double latitude) {
  ...
  public RetailerShortResponse longitude(@Nullable Double longitude) {
  ...
  public RetailerShortResponse visibility(@Nullable String visibility) {
