...
public class MissionResponse {
  ...
  public MissionResponse action(@Nullable ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  public MissionResponse highestAppVersion(@Nullable String highestAppVersion) {
  ...
  public MissionResponse missionId(@Nullable Long missionId) {
  ...
  public MissionResponse ticketsEarned(@Nullable Long ticketsEarned) {
  ...
  public MissionResponse costToPlay(@Nullable Integer costToPlay) {
  ...
  public MissionResponse costToPlayType(@Nullable String costToPlayType) {
  ...
  public MissionResponse owner(@Nullable AccountShortResponse owner) {
    this.owner = owner;
    return this;
  }
  ...
  public MissionResponse title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public MissionResponse description(@Nullable String description) {
  ...
  public MissionResponse authorOverride(@Nullable String authorOverride) {
  ...
  public MissionResponse icon(@Nullable AssetShortResponse icon) {
    this.icon = icon;
    return this;
  }
  ...
  public MissionResponse image(@Nullable AssetShortResponse image) {
    this.image = image;
    return this;
  }
  ...
  public MissionResponse sequenceType(@Nullable String sequenceType) {
  ...
  public MissionResponse updatedDate(@Nullable Long updatedDate) {
  ...
  public MissionResponse startDate(@Nullable Long startDate) {
  ...
  public MissionResponse endDate(@Nullable Long endDate) {
  ...
  public MissionResponse missionType(@Nullable String missionType) {
  ...
  public MissionResponse active(@Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public MissionResponse balance(@Nullable Double balance) {
  ...
  public MissionResponse availableLimit(@Nullable Integer availableLimit) {
  ...
  public MissionResponse inviteCount(@Nullable Integer inviteCount) {
  ...
  public MissionResponse acceptedCount(@Nullable Integer acceptedCount) {
  ...
  public MissionResponse childCount(@Nullable Long childCount) {
  ...
  public MissionResponse enableBuyBack(@Nullable Boolean enableBuyBack) {
  ...
  public MissionResponse minimumToPlay(@Nullable Integer minimumToPlay) {
  ...
  public MissionResponse rewarded(@Nullable Boolean rewarded) {
  ...
  public MissionResponse refunded(@Nullable Boolean refunded) {
  ...
  public MissionResponse joinCode(@Nullable String joinCode) {
  ...
  public MissionResponse games(@Nullable GameListResponse games) {
    this.games = games;
    return this;
  }
  ...
  public MissionResponse scores(@Nullable ScoreListResponse scores) {
    this.scores = scores;
    return this;
  }
  ...
  public MissionResponse userPermissionsList(@Nullable UserPermissionsListResponse userPermissionsList) {
  ...
  public MissionResponse inviteStatus(@Nullable InviteStatusEnum inviteStatus) {
  ...
  public MissionResponse missionInviteId(@Nullable Long missionInviteId) {
  ...
  public MissionResponse missionInvite(@Nullable MissionInviteResponse missionInvite) {
  ...
  public MissionResponse invitee(@Nullable AccountShortResponse invitee) {
  ...
  public MissionResponse formatType(@Nullable String formatType) {
  ...
  public MissionResponse fixedReward(@Nullable Boolean fixedReward) {
  ...
  public MissionResponse allocateTickets(@Nullable Boolean allocateTickets) {
  ...
  public MissionResponse ticketType(@Nullable String ticketType) {
  ...
  public MissionResponse ticketCount(@Nullable Long ticketCount) {
  ...
  public MissionResponse points(@Nullable Long points) {
    this.points = points;
    return this;
  }
  ...
  public MissionResponse splitReward(@Nullable String splitReward) {
  ...
  public MissionResponse secondsBetweenLevels(@Nullable Integer secondsBetweenLevels) {
  ...
  public MissionResponse secondsBetweenPacks(@Nullable Integer secondsBetweenPacks) {
  ...
  public MissionResponse advancedReporting(@Nullable Boolean advancedReporting) {
