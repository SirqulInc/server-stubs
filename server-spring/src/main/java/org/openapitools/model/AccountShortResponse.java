...
public class AccountShortResponse {
  ...
  public AccountShortResponse accountId(@Nullable Long accountId) {
  ...
  public AccountShortResponse locationDisplay(@Nullable String locationDisplay) {
  ...
  public AccountShortResponse display(@Nullable String display) {
  ...
  public AccountShortResponse username(@Nullable String username) {
  ...
  public AccountShortResponse accountType(@Nullable String accountType) {
  ...
  public AccountShortResponse profileImage(@Nullable String profileImage) {
  ...
  public AccountShortResponse gender(@Nullable GenderEnum gender) {
    this.gender = gender;
    return this;
  }
  ...
  public AccountShortResponse contactEmail(@Nullable String contactEmail) {
