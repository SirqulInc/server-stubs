...
public class GameResponse {
  ...
  private @Nullable PackListResponse packs;
  ...
  private @Nullable RuleListResponse rules;
  ...
  public GameResponse action(@Nullable ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  public GameResponse highestAppVersion(@Nullable String highestAppVersion) {
  ...
  public GameResponse gameId(@Nullable Long gameId) {
    this.gameId = gameId;
    return this;
  }
  ...
  public GameResponse gameType(@Nullable String gameType) {
  ...
  public GameResponse packs(@Nullable PackListResponse packs) {
    this.packs = packs;
    return this;
  }
  ...
  @JsonProperty("packs")
  public @Nullable PackListResponse getPacks() {
    return packs;
  }

  public void setPacks(@Nullable PackListResponse packs) {
    this.packs = packs;
  }

  public GameResponse scores(@Nullable ScoreListResponse scores) {
    this.scores = scores;
    return this;
  }
  ...
  public GameResponse owner(@Nullable AccountShortResponse owner) {
    this.owner = owner;
    return this;
  }
  ...
  public GameResponse userPermissionsList(@Nullable UserPermissionsListResponse userPermissionsList) {
  ...
  public GameResponse rules(@Nullable RuleListResponse rules) {
    this.rules = rules;
    return this;
  }
  ...
  @JsonProperty("rules")
  public @Nullable RuleListResponse getRules() {
    return rules;
  }

  public void setRules(@Nullable RuleListResponse rules) {
    this.rules = rules;
  }
  ...
  public GameResponse ticketsEarned(@Nullable Long ticketsEarned) {
  ...
  public GameResponse title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public GameResponse description(@Nullable String description) {
  ...
  public GameResponse authorOverride(@Nullable String authorOverride) {
  ...
  public GameResponse icon(@Nullable AssetShortResponse icon) {
    this.icon = icon;
    return this;
  }
  ...
  public GameResponse image(@Nullable AssetShortResponse image) {
    this.image = image;
    return this;
  }
  ...
  public GameResponse sequenceType(@Nullable String sequenceType) {
  ...
  public GameResponse updatedDate(@Nullable Long updatedDate) {
  ...
  public GameResponse startDate(@Nullable Long startDate) {
  ...
  public GameResponse endDate(@Nullable Long endDate) {
  ...
  public GameResponse appKey(@Nullable String appKey) {
    this.appKey = appKey;
    return this;
  }
