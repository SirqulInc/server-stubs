...
public class AlbumContestListResponse {
  ...
  public AlbumContestListResponse valid(@Nullable Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public AlbumContestListResponse message(@Nullable String message) {
  ...
  public AlbumContestListResponse version(@Nullable Double version) {
  ...
  public AlbumContestListResponse serializeNulls(@Nullable Boolean serializeNulls) {
  ...
  public AlbumContestListResponse startTimeLog(@Nullable Long startTimeLog) {
  ...
  public AlbumContestListResponse errorCode(@Nullable String errorCode) {
  ...
  public AlbumContestListResponse hasMoreResults(@Nullable Boolean hasMoreResults) {
  ...
  public AlbumContestListResponse count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public AlbumContestListResponse countTotal(@Nullable Long countTotal) {
  ...
  public AlbumContestListResponse returning(@Nullable String returning) {
