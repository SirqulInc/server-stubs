...
public class TicketListResponse {
  ...
  @Valid
  private List<@Valid TicketResponse> items = new ArrayList<>();
  ...
  public TicketListResponse valid(@Nullable Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  public TicketListResponse message(@Nullable String message) {
  ...
  public TicketListResponse version(@Nullable Double version) {
  ...
  public TicketListResponse serializeNulls(@Nullable Boolean serializeNulls) {
  ...
  public TicketListResponse startTimeLog(@Nullable Long startTimeLog) {
  ...
  public TicketListResponse errorCode(@Nullable String errorCode) {
  ...
  public TicketListResponse count(@Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public TicketListResponse hasMoreResults(@Nullable Boolean hasMoreResults) {
  ...
  public TicketListResponse start(@Nullable Integer start) {
    this.start = start;
    return this;
  }
  ...
  public TicketListResponse limit(@Nullable Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  public TicketListResponse countTotal(@Nullable Long countTotal) {
  ...
  public TicketListResponse returning(@Nullable String returning) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.valid, ticketListResponse.valid) &&
        Objects.equals(this.message, ticketListResponse.message) &&
        Objects.equals(this.version, ticketListResponse.version) &&
        Objects.equals(this.serializeNulls, ticketListResponse.serializeNulls) &&
        Objects.equals(this.startTimeLog, ticketListResponse.startTimeLog) &&
        Objects.equals(this.errorCode, ticketListResponse.errorCode) &&
        Objects.equals(this.request, ticketListResponse.request) &&
        Objects.equals(this.items, ticketListResponse.items) &&
        Objects.equals(this.count, ticketListResponse.count) &&
        Objects.equals(this.hasMoreResults, ticketListResponse.hasMoreResults) &&
        Objects.equals(this.start, ticketListResponse.start) &&
        Objects.equals(this.limit, ticketListResponse.limit) &&
        Objects.equals(this.countTotal, ticketListResponse.countTotal) &&
        Objects.equals(this.returning, ticketListResponse.returning);
  }
