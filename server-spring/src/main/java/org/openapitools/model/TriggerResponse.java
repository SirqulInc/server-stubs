...
public class TriggerResponse {
  ...
  public TriggerResponse scheduledNotificationId(@Nullable Long scheduledNotificationId) {
  ...
  public TriggerResponse active(@Nullable Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public TriggerResponse status(@Nullable StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public TriggerResponse type(@Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public TriggerResponse name(@Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public TriggerResponse message(@Nullable String message) {
  ...
  public TriggerResponse groupingId(@Nullable String groupingId) {
  ...
  public TriggerResponse scheduledDate(@Nullable Long scheduledDate) {
  ...
  public TriggerResponse startDate(@Nullable Long startDate) {
  ...
  public TriggerResponse endDate(@Nullable Long endDate) {
  ...
  public TriggerResponse owner(@Nullable AccountShortResponse owner) {
    this.owner = owner;
    return this;
  }
  ...
  public TriggerResponse billableEntity(@Nullable BillableEntityShortResponse billableEntity) {
  ...
  public TriggerResponse contentId(@Nullable Long contentId) {
  ...
  public TriggerResponse contentName(@Nullable String contentName) {
  ...
  public TriggerResponse contentType(@Nullable String contentType) {
  ...
  public TriggerResponse parentId(@Nullable Long parentId) {
  ...
  public TriggerResponse parentType(@Nullable String parentType) {
  ...
  public TriggerResponse application(@Nullable ApplicationMiniResponse application) {
  ...
  public TriggerResponse targetId(@Nullable Long targetId) {
  ...
  public TriggerResponse targetName(@Nullable String targetName) {
  ...
  public TriggerResponse targetType(@Nullable String targetType) {
  ...
  public TriggerResponse targetParams(@Nullable String targetParams) {
  ...
  public TriggerResponse deliverEstimate(@Nullable Long deliverEstimate) {
  ...
  public TriggerResponse deliverCount(@Nullable Long deliverCount) {
  ...
  public TriggerResponse deliverTotal(@Nullable Long deliverTotal) {
  ...
  public TriggerResponse deliverFailed(@Nullable Long deliverFailed) {
  ...
  public TriggerResponse processingTime(@Nullable Long processingTime) {
  ...
  public TriggerResponse sendingTime(@Nullable Long sendingTime) {
  ...
  public TriggerResponse updated(@Nullable Long updated) {
  ...
  public TriggerResponse created(@Nullable Long created) {
  ...
  public TriggerResponse cronExpression(@Nullable String cronExpression) {
  ...
  public TriggerResponse endpointURL(@Nullable String endpointURL) {
  ...
  public TriggerResponse payload(@Nullable String payload) {
  ...
  public TriggerResponse conditionalInput(@Nullable String conditionalInput) {
  ...
  public TriggerResponse templateType(@Nullable TemplateTypeEnum templateType) {
  ...
  public TriggerResponse triggerId(@Nullable Long triggerId) {
  ...
  @Schema(name = "triggerId", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("triggerId")
  public @Nullable Long getTriggerId() {
    return triggerId;
  }

  public void setTriggerId(@Nullable Long triggerId) {
    this.triggerId = triggerId;
  }
