...
MyApp.add_route('POST', '/api/3.18/object/field/add', {
  "resourcePath" => "/ObjectStore",
  "summary" => "Create Field",
  "nickname" => "add_field",
  "responseClass" => "ObjectStoreResponse",
  "endpoint" => "/object/field/add",
...
MyApp.add_route('POST', '/api/3.18/object/data/{objectName}', {
  "resourcePath" => "/ObjectStore",
  "summary" => "Create Data",
  "nickname" => "create_data",
  "responseClass" => "ObjectStoreResponse",
  "endpoint" => "/object/data/{objectName}",
...
MyApp.add_route('POST', '/api/3.18/object/create', {
  "resourcePath" => "/ObjectStore",
...
MyApp.add_route('DELETE', '/api/3.18/object/data/{objectName}/{objectId}', {
  "resourcePath" => "/ObjectStore",
  "summary" => "Delete Data",
  "nickname" => "delete_data",
  "responseClass" => "ObjectStoreResponse",
  "endpoint" => "/object/data/{objectName}/{objectId}",
...
MyApp.add_route('POST', '/api/3.18/object/field/delete', {
  "resourcePath" => "/ObjectStore",
  "summary" => "Delete Field",
  "nickname" => "delete_field",
  "responseClass" => "ObjectStoreResponse",
  "endpoint" => "/object/field/delete",
...
MyApp.add_route('POST', '/api/3.18/object/delete', {
  "resourcePath" => "/ObjectStore",
  "summary" => "Delete Object",
  "nickname" => "delete_object",
  "responseClass" => "ObjectStoreResponse",
  "endpoint" => "/object/delete",
...
MyApp.add_route('GET', '/api/3.18/object/data/{objectName}/{objectId}', {
  "resourcePath" => "/ObjectStore",
  "summary" => "Get Data",
  "nickname" => "get_data",
  "responseClass" => "ObjectStoreResponse",
...
MyApp.add_route('GET', '/api/3.18/object/get', {
  "resourcePath" => "/ObjectStore",
  "summary" => "Get Object",
  "nickname" => "get_object",
  "responseClass" => "ObjectStoreResponse",
...
MyApp.add_route('GET', '/api/3.18/object/data/{objectName}', {
  "resourcePath" => "/ObjectStore",
  "summary" => "Search Data",
...
MyApp.add_route('GET', '/api/3.18/object/search', {
  "resourcePath" => "/ObjectStore",
  "summary" => "Search Objects",
  "nickname" => "search_object",
  "responseClass" => "ObjectStoreResponse",
  "endpoint" => "/object/search",
...
MyApp.add_route('PUT', '/api/3.18/object/data/{objectName}/{objectId}', {
  "resourcePath" => "/ObjectStore",
  "summary" => "Update Data",
