...
public interface PackApi  {
    ...
    public SirqulResponse deletePack(@PathParam("version") BigDecimal version, @QueryParam("accountId") @NotNull Long accountId, @QueryParam("packId") @NotNull Long packId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = PackResponse.class) })
    public PackResponse getPack(@PathParam("version") BigDecimal version, @QueryParam("accountId") @NotNull Long accountId, @QueryParam("packId") @NotNull Long packId, @QueryParam("includeGameData") @NotNull Boolean includeGameData);
    ...
    public List<PackResponse> searchPacks(@PathParam("version") BigDecimal version, @QueryParam("accountId") @NotNull Long accountId, @QueryParam("sortField") @NotNull String sortField, @QueryParam("descending") @NotNull Boolean descending, @QueryParam("keyword") String keyword, @QueryParam("packType") String packType, @QueryParam("start") Integer start, @QueryParam("limit") Integer limit, @QueryParam("includeGameData") Boolean includeGameData, @QueryParam("includeInactive") Boolean includeInactive, @QueryParam("appKey") String appKey);
