...
public interface NotificationApi  {
    ...
    public NotificationTemplateResponse createNotificationTemplate(@QueryParam("accountId") @NotNull Long accountId, @QueryParam("conduit") @NotNull String conduit, @QueryParam("title") @NotNull String title, @QueryParam("body") @NotNull String body, @QueryParam("appKey") String appKey, @QueryParam("event") String event, @QueryParam("tags") String tags);
    ...
    public BlockedNotificationResponse createOrUpdateBlockedNotifications(@QueryParam("appKey") @NotNull String appKey, @QueryParam("data") @NotNull String data, @QueryParam("accountId") Long accountId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = NotificationTemplateResponse.class) })
    public NotificationTemplateResponse deleteNotificationTemplate(@QueryParam("accountId") @NotNull Long accountId, @QueryParam("notificationTemplateId") @NotNull Long notificationTemplateId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = NotificationTemplateResponse.class) })
    public NotificationTemplateResponse getNotificationTemplate(@QueryParam("accountId") @NotNull Long accountId, @QueryParam("notificationTemplateId") @NotNull Long notificationTemplateId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = BlockedNotificationResponse.class) })
    public BlockedNotificationResponse searchBlockedNotifications(@QueryParam("appKey") @NotNull String appKey, @QueryParam("accountId") Long accountId, @QueryParam("searchTags") String searchTags, @QueryParam("events") String events, @QueryParam("conduits") String conduits, @QueryParam("customTypes") String customTypes, @QueryParam("contentTypes") String contentTypes, @QueryParam("contentIds") String contentIds, @QueryParam("sortField") String sortField, @QueryParam("descending") Boolean descending, @QueryParam("start") Integer start, @QueryParam("limit") Integer limit);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = NotificationTemplateResponse.class) })
    public NotificationTemplateResponse searchNotificationTemplate(@QueryParam("accountId") @NotNull Long accountId, @QueryParam("sortField") @NotNull String sortField, @QueryParam("descending") @NotNull Boolean descending, @QueryParam("start") @NotNull Integer start, @QueryParam("limit") @NotNull Integer limit, @QueryParam("appKey") String appKey, @QueryParam("event") String event, @QueryParam("conduit") String conduit, @QueryParam("globalOnly") Boolean globalOnly, @QueryParam("reservedOnly") Boolean reservedOnly, @QueryParam("keyword") String keyword);
    ...
    public List<NotificationRecipientResponse> searchRecipients(@QueryParam("sortField") @NotNull String sortField, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("appKey") String appKey, @QueryParam("conduit") String conduit, @QueryParam("keyword") String keyword, @QueryParam("audienceId") Long audienceId, @QueryParam("audienceIds") String audienceIds, @QueryParam("connectionGroupIds") String connectionGroupIds, @QueryParam("recipientAccountIds") String recipientAccountIds, @QueryParam("descending") Boolean descending, @QueryParam("start") Integer start, @QueryParam("limit") Integer limit);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse sendBatchNotifications(@QueryParam("accountId") @NotNull Long accountId, @QueryParam("appKey") @NotNull String appKey, @QueryParam("customMessage") @NotNull String customMessage, @QueryParam("conduit") String conduit, @QueryParam("contentId") Long contentId, @QueryParam("contentName") String contentName, @QueryParam("contentType") String contentType, @QueryParam("parentId") Long parentId, @QueryParam("parentType") String parentType);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse sendCustomNotifications(@QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("receiverAccountIds") String receiverAccountIds, @QueryParam("includeFriendGroup") Boolean includeFriendGroup, @QueryParam("appKey") String appKey, @QueryParam("gameType") String gameType, @QueryParam("conduit") String conduit, @QueryParam("contentId") Long contentId, @QueryParam("contentName") String contentName, @QueryParam("contentType") String contentType, @QueryParam("parentId") Long parentId, @QueryParam("parentType") String parentType, @QueryParam("actionCategory") String actionCategory, @QueryParam("subject") String subject, @QueryParam("customMessage") String customMessage, @QueryParam("friendOnlyAPNS") Boolean friendOnlyAPNS, @QueryParam("latitude") Double latitude, @QueryParam("longitude") Double longitude);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = NotificationTemplateResponse.class) })
    public NotificationTemplateResponse updateNotificationTemplate(@QueryParam("accountId") @NotNull Long accountId, @QueryParam("notificationTemplateId") @NotNull Long notificationTemplateId, @QueryParam("title") String title, @QueryParam("body") String body, @QueryParam("tags") String tags);
}
