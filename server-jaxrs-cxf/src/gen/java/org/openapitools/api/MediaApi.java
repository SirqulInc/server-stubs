...
public interface MediaApi  {
    ...
    public SirqulResponse deleteMedia(@PathParam("version") BigDecimal version, @QueryParam("accountId") @NotNull Long accountId, @QueryParam("mediaId") @NotNull Long mediaId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = MediaOfferResponse.class) })
    public MediaOfferResponse getMedia(@PathParam("version") BigDecimal version, @QueryParam("accountId") @NotNull Long accountId, @QueryParam("mediaId") @NotNull Long mediaId);
    ...
    public List<MediaOfferResponse> searchMedia(@PathParam("version") BigDecimal version, @QueryParam("accountId") @NotNull Long accountId, @QueryParam("activeOnly") @NotNull Boolean activeOnly, @QueryParam("sortField") @NotNull String sortField, @QueryParam("descending") @NotNull Boolean descending, @QueryParam("keyword") String keyword, @QueryParam("categoryIds") String categoryIds, @QueryParam("filterIds") String filterIds, @QueryParam("start") Integer start, @QueryParam("limit") Integer limit);
