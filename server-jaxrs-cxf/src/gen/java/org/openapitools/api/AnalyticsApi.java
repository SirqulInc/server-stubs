...
public interface AnalyticsApi  {
    ...
    public List<UserActivityResponse> activities(@PathParam("version") BigDecimal version, @QueryParam("start") @NotNull Integer start, @QueryParam("limit") @NotNull Integer limit, @QueryParam("accountId") @NotNull Long accountId);
