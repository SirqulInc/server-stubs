...
public interface NoteApi  {
    ...
    public SirqulResponse batchOperation(@PathParam("version") BigDecimal version, @QueryParam("notableId") @NotNull Long notableId, @QueryParam("notableType") @NotNull String notableType, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("batchOperation") String batchOperation);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse deleteNote(@PathParam("version") BigDecimal version, @QueryParam("noteId") @NotNull Long noteId, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("latitude") Double latitude, @QueryParam("longitude") Double longitude, @QueryParam("appKey") String appKey);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse getNote(@PathParam("version") BigDecimal version, @QueryParam("noteId") @NotNull Long noteId, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("returnFullResponse") Boolean returnFullResponse);
