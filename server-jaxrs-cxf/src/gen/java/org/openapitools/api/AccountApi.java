...
public interface AccountApi  {
    ...
    public SirqulResponse blockAccount(@QueryParam("accountIdBeingBlocked") @NotNull Long accountIdBeingBlocked, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("blockFlagValue") @DefaultValue("true")Boolean blockFlagValue, @QueryParam("removeFromGroupsIfBlocked") @DefaultValue("false")Boolean removeFromGroupsIfBlocked, @QueryParam("latitude") Double latitude, @QueryParam("longitude") Double longitude);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse editUsername(@QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("emailAddress") String emailAddress, @QueryParam("username") String username);
    ...
    public void getReferralList(@QueryParam("accountId") Long accountId, @QueryParam("appKey") String appKey, @QueryParam("retrieveType") String retrieveType, @QueryParam("levelLimit") BigDecimal levelLimit, @QueryParam("ancestorLevelLimit") BigDecimal ancestorLevelLimit, @QueryParam("childrenLevelLimit") BigDecimal childrenLevelLimit, @QueryParam("ancestorListStart") BigDecimal ancestorListStart, @QueryParam("ancestorListLimit") BigDecimal ancestorListLimit, @QueryParam("childrenListStart") BigDecimal childrenListStart, @QueryParam("childrenListLimit") BigDecimal childrenListLimit, @QueryParam("childrenChildren") @DefaultValue("true")Boolean childrenChildren);
    ...
    public UserSettingsResponse getSettings(@QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("latitude") Double latitude, @QueryParam("longitude") Double longitude);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = ProfileResponse.class) })
    public ProfileResponse loginGeneral(@QueryParam("accessToken") @NotNull String accessToken, @QueryParam("networkUID") @NotNull @DefaultValue("USERNAME")String networkUID, @QueryParam("appKey") @NotNull String appKey, @QueryParam("deviceId") String deviceId, @QueryParam("deviceIdType") String deviceIdType, @QueryParam("accessTokenSecret") String accessTokenSecret, @QueryParam("ageRestriction") @DefaultValue("0")Integer ageRestriction, @QueryParam("responseFilters") @DefaultValue("PROFILE")String responseFilters, @QueryParam("latitude") Double latitude, @QueryParam("longitude") Double longitude, @QueryParam("emailMatch") @DefaultValue("false")Boolean emailMatch, @QueryParam("chosenAccountId") @DefaultValue("0")Long chosenAccountId, @QueryParam("thirdPartyCredentialId") @DefaultValue("0")Long thirdPartyCredentialId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = ProfileResponse.class) })
    public ProfileResponse loginUsername(@QueryParam("username") @NotNull String username, @QueryParam("password") @NotNull String password, @QueryParam("deviceId") String deviceId, @QueryParam("latitude") Double latitude, @QueryParam("longitude") Double longitude, @QueryParam("app") String app, @QueryParam("gameType") String gameType, @QueryParam("appKey") String appKey, @QueryParam("returnProfile") Boolean returnProfile, @QueryParam("responseFilters") String responseFilters);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse logout(@QueryParam("deviceId") String deviceId, @QueryParam("deviceIdType") String deviceIdType, @QueryParam("accountId") Long accountId, @QueryParam("latitude") Double latitude, @QueryParam("longitude") Double longitude);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse mergeAccount(@QueryParam("mergeAccountId") @NotNull Long mergeAccountId, @QueryParam("appKey") @NotNull String appKey, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse passwordChange(@QueryParam("accountId") @NotNull Long accountId, @QueryParam("oldPassword") @NotNull String oldPassword, @QueryParam("newPassword") @NotNull String newPassword, @QueryParam("confirmPassword") @NotNull String confirmPassword);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse passwordReset(@QueryParam("token") @NotNull String token, @QueryParam("password") @NotNull String password, @QueryParam("confirm") @NotNull String confirm);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse requestPasswordReset(@QueryParam("email") @NotNull String email, @QueryParam("from") @DefaultValue("Sirqul")String from, @QueryParam("domain") String domain, @QueryParam("subUrl") String subUrl, @QueryParam("referer") @DefaultValue("http://dev.sirqul.com/resetpassword")String referer);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse requestValidateAccount(@QueryParam("accountId") @NotNull Long accountId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = ProfileResponse.class) })
    public ProfileResponse secureLogin(@QueryParam("username") @NotNull String username, @QueryParam("password") @NotNull String password, @QueryParam("gameType") @NotNull String gameType, @QueryParam("deviceId") String deviceId, @QueryParam("charsetName") @DefaultValue("UTF-8")String charsetName, @QueryParam("latitude") Double latitude, @QueryParam("longitude") Double longitude, @QueryParam("returnProfile") @DefaultValue("false")Boolean returnProfile, @QueryParam("responseFilters") @DefaultValue("PROFILE")String responseFilters);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse setMatchToken(@QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("matchToken") String matchToken, @QueryParam("gameType") @DefaultValue("BOOPY")String gameType, @QueryParam("appKey") String appKey, @QueryParam("latitude") Double latitude, @QueryParam("longitude") Double longitude);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse updateActveStatus(@QueryParam("accountId") @NotNull Long accountId, @QueryParam("connectionAccountId") @NotNull Long connectionAccountId, @QueryParam("active") @NotNull Boolean active, @QueryParam("deviceId") String deviceId, @QueryParam("appKey") String appKey);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse updateLocation(@QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("latitude") Double latitude, @QueryParam("longitude") Double longitude, @QueryParam("clientTime") Long clientTime);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = AccountLoginResponse.class) })
    public AccountLoginResponse validateAccountSignup(@QueryParam("token") @NotNull String token);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse validatePasswordReset(@QueryParam("token") @NotNull String token);
}
