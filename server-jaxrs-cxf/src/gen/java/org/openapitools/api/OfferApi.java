...
public interface OfferApi  {
    ...
    public SirqulResponse batchUpdateOfferLocations(@PathParam("version") BigDecimal version, @QueryParam("data") @NotNull String data, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse deleteOffer(@PathParam("version") BigDecimal version, @QueryParam("offerId") @NotNull Long offerId, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse deleteOfferLocation(@PathParam("version") BigDecimal version, @QueryParam("offerLocationId") @NotNull Long offerLocationId, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = RetailerOfferResponse.class) })
    public RetailerOfferResponse getOffer(@PathParam("version") BigDecimal version, @QueryParam("offerId") @NotNull Long offerId, @QueryParam("includeOfferLocations") @NotNull Boolean includeOfferLocations, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId);
    ...
    public OfferResponse getOfferDetails(@PathParam("version") BigDecimal version, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("offerId") Long offerId, @QueryParam("offerLocationId") Long offerLocationId, @QueryParam("distance") Double distance, @QueryParam("latitude") Double latitude, @QueryParam("longitude") Double longitude, @QueryParam("includeOfferLocations") @DefaultValue("false")Boolean includeOfferLocations, @QueryParam("includeRetailerLocations") @DefaultValue("false")Boolean includeRetailerLocations, @QueryParam("includeChildOffers") @DefaultValue("false")Boolean includeChildOffers);
    ...
    public ListCountResponse getOfferListCounts(@PathParam("version") BigDecimal version, @QueryParam("latitude") @NotNull Double latitude, @QueryParam("longitude") @NotNull Double longitude, @QueryParam("searchRange") @DefaultValue("5")BigDecimal searchRange, @QueryParam("distanceUnit") @DefaultValue("MILES")String distanceUnit);
    ...
    public OfferShortResponse getOfferLocation(@PathParam("version") BigDecimal version, @QueryParam("offerLocationId") Long offerLocationId, @QueryParam("udid") String udid);
    ...
    public List<OfferShortResponse> getOfferLocationsForRetailers(@PathParam("version") BigDecimal version, @QueryParam("sortField") @NotNull String sortField, @QueryParam("descending") @NotNull Boolean descending, @QueryParam("start") @NotNull Integer start, @QueryParam("limit") @NotNull Integer limit, @QueryParam("activeOnly") @NotNull Boolean activeOnly, @QueryParam("includeRetailerLocation") @NotNull Boolean includeRetailerLocation, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("keyword") String keyword, @QueryParam("retailerId") Long retailerId, @QueryParam("retailerLocationId") Long retailerLocationId, @QueryParam("offerType") String offerType, @QueryParam("specialOfferType") String specialOfferType, @QueryParam("barcodeType") String barcodeType, @QueryParam("barcodeEntry") String barcodeEntry, @QueryParam("isbn") String isbn, @QueryParam("asin") String asin, @QueryParam("deviceStatus") String deviceStatus, @QueryParam("needsNotificationSent") Boolean needsNotificationSent, @QueryParam("lastNotificationSent") Long lastNotificationSent);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse redeemOfferTransaction(@PathParam("version") BigDecimal version, @QueryParam("offerTransactionId") @NotNull Long offerTransactionId, @QueryParam("status") @NotNull Integer status, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("offerLocationId") Long offerLocationId);
    ...
    public List<OfferTransactionResponse> searchOfferTransactionsForRetailers(@PathParam("version") BigDecimal version, @QueryParam("sortField") @NotNull String sortField, @QueryParam("descending") @NotNull Boolean descending, @QueryParam("start") @NotNull Integer start, @QueryParam("limit") @NotNull Integer limit, @QueryParam("activeOnly") @NotNull Boolean activeOnly, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("q") String q, @QueryParam("keyword") String keyword, @QueryParam("retailerId") Long retailerId, @QueryParam("retailerLocationId") Long retailerLocationId, @QueryParam("offerId") Long offerId, @QueryParam("offerLocationId") Long offerLocationId, @QueryParam("redeemed") Boolean redeemed, @QueryParam("reservationsOnly") Boolean reservationsOnly, @QueryParam("couponType") String couponType, @QueryParam("offerType") String offerType, @QueryParam("specialOfferType") String specialOfferType, @QueryParam("customerAccountIds") String customerAccountIds, @QueryParam("categoryIds") String categoryIds, @QueryParam("redeemableStartDate") Long redeemableStartDate, @QueryParam("redeemableEndDate") Long redeemableEndDate, @QueryParam("_i") Integer i, @QueryParam("_l") Integer l);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = OfferListResponse.class) })
    public OfferListResponse topOfferTransactions(@PathParam("version") BigDecimal version, @QueryParam("start") @DefaultValue("0")Integer start, @QueryParam("limit") @DefaultValue("20")Integer limit);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse updateOfferStatus(@PathParam("version") BigDecimal version, @QueryParam("offerIds") @NotNull String offerIds, @QueryParam("active") @NotNull Boolean active, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId);
}
