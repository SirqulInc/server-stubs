...
public interface AlbumApi  {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse approveAlbum(@PathParam("version") BigDecimal version, @QueryParam("albumId") @NotNull Long albumId, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("approvalStatus") String approvalStatus, @QueryParam("verified") Boolean verified);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse leaveAlbum(@PathParam("version") BigDecimal version, @QueryParam("albumId") @NotNull Long albumId, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse removeAlbum(@PathParam("version") BigDecimal version, @QueryParam("albumId") @NotNull Long albumId, @QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId);
