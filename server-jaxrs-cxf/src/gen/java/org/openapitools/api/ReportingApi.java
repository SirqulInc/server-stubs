...
public interface ReportingApi  {
    ...
    public ReportBatchResponse createBatch(@PathParam("version") BigDecimal version, @QueryParam("accountId") @NotNull Long accountId, @QueryParam("status") @NotNull String status, @QueryParam("previewLimit") @NotNull Integer previewLimit, @QueryParam("appKey") String appKey, @QueryParam("endpoint") String endpoint, @QueryParam("parameters") String parameters, @QueryParam("name") String name, @QueryParam("startDate") Long startDate, @QueryParam("endDate") Long endDate, @QueryParam("description") String description, @QueryParam("pageUrl") String pageUrl);
    ...
    public ReportRegionLegSummaryBatchResponse createRegionLegSummaryBatch(@PathParam("version") BigDecimal version, @Valid List<@Valid RegionLegSummary> body);
    ...
    public SirqulResponse deleteBatch(@PathParam("version") BigDecimal version, @QueryParam("accountId") @NotNull Long accountId, @QueryParam("batchId") @NotNull Long batchId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = ReportBatchResponse.class) })
    public ReportBatchResponse getReportBatch(@PathParam("version") BigDecimal version, @QueryParam("accountId") @NotNull Long accountId, @QueryParam("batchId") @NotNull Long batchId, @QueryParam("allResults") @NotNull Boolean allResults);
    ...
    public List<ReportBatchResponse> searchBatch(@PathParam("version") BigDecimal version, @QueryParam("accountId") @NotNull Long accountId, @QueryParam("start") @NotNull Integer start, @QueryParam("limit") @NotNull Integer limit, @QueryParam("names") String names, @QueryParam("appKey") String appKey, @QueryParam("status") String status, @QueryParam("globalAppSearch") Boolean globalAppSearch, @QueryParam("startDate") Long startDate, @QueryParam("endDate") Long endDate);
}
