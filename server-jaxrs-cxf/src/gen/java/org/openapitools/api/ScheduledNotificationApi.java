 ...
 *
 */
@Path("/api/{version}/notification/schedule")
...
public interface ScheduledNotificationApi  {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = ScheduledNotificationFullResponse.class) })
    public ScheduledNotificationFullResponse deleteScheduledNotification(@PathParam("version") BigDecimal version, @QueryParam("accountId") @NotNull Long accountId, @QueryParam("scheduledNotificationId") @NotNull Long scheduledNotificationId, @QueryParam("deleteByGroupingId") Boolean deleteByGroupingId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = ScheduledNotificationFullResponse.class) })
    public ScheduledNotificationFullResponse getScheduledNotification(@PathParam("version") BigDecimal version, @QueryParam("accountId") @NotNull Long accountId, @QueryParam("scheduledNotificationId") @NotNull Long scheduledNotificationId);
