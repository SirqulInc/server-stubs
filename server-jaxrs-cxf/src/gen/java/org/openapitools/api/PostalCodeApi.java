...
public interface PostalCodeApi  {
    ...
    public PostalCodeResponse createPostalCode(@QueryParam("accountId") @NotNull Long accountId, @QueryParam("code") @NotNull String code, @QueryParam("latitude") @NotNull Double latitude, @QueryParam("longitude") @NotNull Double longitude, @QueryParam("stateCode") String stateCode, @QueryParam("city") String city, @QueryParam("active") Boolean active);
    ...
    public SirqulResponse deletePostalCode(@QueryParam("accountId") @NotNull Long accountId, @QueryParam("postalCodeId") @NotNull Long postalCodeId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = PostalCodeResponse.class) })
    public PostalCodeResponse getPostalCode(@QueryParam("postalCodeId") @NotNull Long postalCodeId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = PostalCodeResponse.class) })
    public PostalCodeResponse updatePostalCode(@QueryParam("accountId") @NotNull Long accountId, @QueryParam("postalCodeId") @NotNull Long postalCodeId, @QueryParam("code") String code, @QueryParam("latitude") Double latitude, @QueryParam("longitude") Double longitude, @QueryParam("stateCode") String stateCode, @QueryParam("city") String city, @QueryParam("active") Boolean active);
}
