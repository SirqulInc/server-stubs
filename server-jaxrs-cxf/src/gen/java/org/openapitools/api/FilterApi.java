...
public interface FilterApi  {
    ...
    public FilterTreeResponse createFilter(@QueryParam("accountId") @NotNull Long accountId, @QueryParam("name") @NotNull String name, @QueryParam("appKey") String appKey, @QueryParam("parentFilterId") Long parentFilterId, @QueryParam("description") String description, @QueryParam("externalId") String externalId, @QueryParam("externalType") String externalType, @QueryParam("active") Boolean active, @QueryParam("metaData") String metaData);
    ...
    public SirqulResponse deleteFilter(@QueryParam("accountId") @NotNull Long accountId, @QueryParam("filterId") @NotNull Long filterId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = FilterTreeResponse.class) })
    public FilterTreeResponse getFilter(@QueryParam("filterId") @NotNull Long filterId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = FilterTreeResponse.class) })
    public FilterTreeResponse updateFilter(@QueryParam("accountId") @NotNull Long accountId, @QueryParam("filterId") @NotNull Long filterId, @QueryParam("parentFilterId") Long parentFilterId, @QueryParam("name") String name, @QueryParam("description") String description, @QueryParam("externalId") String externalId, @QueryParam("externalType") String externalType, @QueryParam("active") Boolean active, @QueryParam("metaData") String metaData);
}
