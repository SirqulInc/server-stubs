...
public interface LocationApi  {
    ...
    public SirqulResponse cacheTrilaterationData(@QueryParam("udid") @NotNull String udid, @QueryParam("sourceTime") Long sourceTime, @QueryParam("minimumSampleSize") Integer minimumSampleSize, @QueryParam("data") String data, @QueryParam("dataFile") File dataFile);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = SirqulResponse.class) })
    public SirqulResponse cacheTrilaterationDataGzip(@Valid TrilatCacheRequest body);
    ...
    public CoordsResponse getLocationByIp(@QueryParam("ip") String ip);
    ...
    public GeoPointResponse getLocationByTrilateration(@QueryParam("accountId") Long accountId, @QueryParam("latitude") Double latitude, @QueryParam("longitude") Double longitude, @QueryParam("data") String data, @QueryParam("responseFilters") String responseFilters);
    ...
    public LocationSearchResponse getLocations(@QueryParam("deviceId") String deviceId, @QueryParam("accountId") Long accountId, @QueryParam("currentlatitude") Double currentlatitude, @QueryParam("currentlongitude") Double currentlongitude, @QueryParam("currentLatitude") Double currentLatitude, @QueryParam("currentLongitude") Double currentLongitude, @QueryParam("query") String query, @QueryParam("zipcode") String zipcode, @QueryParam("zipCode") String zipCode, @QueryParam("selectedMaplatitude") Double selectedMaplatitude, @QueryParam("selectedMaplongitude") Double selectedMaplongitude, @QueryParam("selectedMapLatitude") Double selectedMapLatitude, @QueryParam("selectedMapLongitude") Double selectedMapLongitude, @QueryParam("searchRange") @DefaultValue("5")Double searchRange, @QueryParam("useGeocode") @DefaultValue("false")Boolean useGeocode, @QueryParam("_i") Integer i, @QueryParam("start") @DefaultValue("0")Integer start, @QueryParam("_l") Integer l, @QueryParam("limit") @DefaultValue("20")Integer limit);
}
