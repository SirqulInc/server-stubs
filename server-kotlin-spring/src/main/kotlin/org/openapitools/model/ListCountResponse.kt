...
data class ListCountResponse(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("locationOffersCount") val locationOffersCount: kotlin.Long? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("instantOffersCount") val instantOffersCount: kotlin.Long? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("allOffersCount") val allOffersCount: kotlin.Long? = null,
