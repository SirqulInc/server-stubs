...
data class TriggerResponse(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("status") val status: TriggerResponse.Status? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("type") val type: TriggerResponse.Type? = null,
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("templateType") val templateType: TriggerResponse.TemplateType? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("groupedTypes") val groupedTypes: kotlin.collections.List<TriggerResponse.GroupedTypes>? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("triggerId") val triggerId: kotlin.Long? = null
) {
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Status {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'TriggerResponse'")
            }
        }
    }
