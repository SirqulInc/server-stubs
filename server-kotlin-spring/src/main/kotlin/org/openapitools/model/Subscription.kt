...
data class Subscription(
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("subscriptionPlan") val subscriptionPlan: SubscriptionPlan? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("remoteSubscriptionId") val remoteSubscriptionId: kotlin.String? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("promoCode") val promoCode: kotlin.String? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("failed") val failed: kotlin.Boolean? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("message") val message: Subscription.Message? = null
) {
    ...
    */
    enum class Message(@get:JsonValue val value: kotlin.String) {
        ...
        companion object {
            @JvmStatic
            @JsonCreator
            fun forValue(value: kotlin.String): Message {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'Subscription'")
            }
        }
    }
