...
data class WrappedProxyItemResponse(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("requestDuration") val requestDuration: kotlin.Long? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("requestEndTime") val requestEndTime: kotlin.Long? = null,

    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("item") val item: ImageGenerationResponse? = null
) {
