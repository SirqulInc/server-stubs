...
data class AlbumResponse(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("visibility") val visibility: AlbumResponse.Visibility? = null,
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("approvalStatus") val approvalStatus: AlbumResponse.ApprovalStatus? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Visibility {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'AlbumResponse'")
            }
        }
    }
