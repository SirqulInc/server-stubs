...
data class PostalCode(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("plus4") val plus4: kotlin.String? = null,
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("regions") val regions: kotlin.collections.Set<Region>? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("eliminated") val eliminated: kotlin.Boolean? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("searchPoint") val searchPoint: kotlin.Boolean? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("lastOfferImport") val lastOfferImport: java.time.OffsetDateTime? = null,
