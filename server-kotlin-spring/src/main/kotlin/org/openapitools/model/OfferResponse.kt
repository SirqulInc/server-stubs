...
data class OfferResponse(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("barcodeType") val barcodeType: OfferResponse.BarcodeType? = null,
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("specialOfferType") val specialOfferType: OfferResponse.SpecialOfferType? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): BarcodeType {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'OfferResponse'")
            }
        }
    }
