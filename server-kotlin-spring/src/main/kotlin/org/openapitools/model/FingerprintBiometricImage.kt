...
data class FingerprintBiometricImage(
    ...
    @get:JsonProperty("position") val position: FingerprintBiometricImage.Position? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("data") val `data`: kotlin.String? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("imageFormat") val imageFormat: kotlin.String? = null
) {
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Position {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'FingerprintBiometricImage'")
            }
        }
    }
