 ...
 * @param returning 
 */
data class ReportRegionLegSummaryBatchResponse(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("successCount") val successCount: kotlin.Long? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("failureCount") val failureCount: kotlin.Long? = null,
