...
data class OrsonRenderResponse(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("thirdPartyAccountId") val thirdPartyAccountId: kotlin.String? = null,
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("completedOn") val completedOn: kotlin.String? = null,
    ...
    @field:Valid
    @Schema(example = "null", description = "")
    @get:JsonProperty("video") val video: OrsonVideoResponse? = null
) {
