...
data class MediaOfferResponse(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("specialOfferType") val specialOfferType: MediaOfferResponse.SpecialOfferType? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): SpecialOfferType {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'MediaOfferResponse'")
            }
        }
    }
