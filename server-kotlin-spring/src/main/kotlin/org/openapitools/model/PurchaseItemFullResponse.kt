...
data class PurchaseItemFullResponse(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("serviceAction") val serviceAction: PurchaseItemFullResponse.ServiceAction? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("appName") val appName: kotlin.String? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("secretKey") val secretKey: kotlin.String? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): ServiceAction {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'PurchaseItemFullResponse'")
            }
        }
    }
