...
data class RetailerOfferResponse(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("barcodeType") val barcodeType: RetailerOfferResponse.BarcodeType? = null,
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("specialOfferType") val specialOfferType: RetailerOfferResponse.SpecialOfferType? = null,
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("locations") val locations: kotlin.collections.List<kotlin.collections.Map<kotlin.String, kotlin.Any>>? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): BarcodeType {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'RetailerOfferResponse'")
            }
        }
    }
