...
data class ProfileInfoResponse(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("gender") val gender: ProfileInfoResponse.Gender? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("age") val age: kotlin.String? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("gameExperience") val gameExperience: ProfileInfoResponse.GameExperience? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Gender {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'ProfileInfoResponse'")
            }
        }
    }
