...
data class TournamentResponse(
    ...
    @get:JsonProperty("action") val action: TournamentResponse.Action? = null,
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("inviteStatus") val inviteStatus: TournamentResponse.InviteStatus? = null,
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("tournamentData") val tournamentData: kotlin.String? = null
) {
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Action {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'TournamentResponse'")
            }
        }
    }
