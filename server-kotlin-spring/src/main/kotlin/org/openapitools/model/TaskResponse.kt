...
data class TaskResponse(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("status") val status: TaskResponse.Status? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("type") val type: TaskResponse.Type? = null,
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("templateType") val templateType: TaskResponse.TemplateType? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("groupedTypes") val groupedTypes: kotlin.collections.List<TaskResponse.GroupedTypes>? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("taskId") val taskId: kotlin.Long? = null
) {
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Status {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'TaskResponse'")
            }
        }
    }
