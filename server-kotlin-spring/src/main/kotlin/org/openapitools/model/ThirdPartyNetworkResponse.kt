...
data class ThirdPartyNetworkResponse(
    ...
    @Schema(example = "null", description = "")
    @get:JsonProperty("network") val network: ThirdPartyNetworkResponse.Network? = null,

    @Schema(example = "null", description = "")
    @get:JsonProperty("introspectionMethod") val introspectionMethod: ThirdPartyNetworkResponse.IntrospectionMethod? = null,
        ...
        companion object {
            ...
            fun forValue(value: kotlin.String): Network {
                return values().firstOrNull{it -> it.value == value}
                    ?: throw IllegalArgumentException("Unexpected value '$value' for enum 'ThirdPartyNetworkResponse'")
            }
        }
    }
