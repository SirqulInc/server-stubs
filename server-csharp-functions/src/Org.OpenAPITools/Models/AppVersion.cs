...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class AppVersion : IEquatable<AppVersion>
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="versionIndex", EmitDefaultValue=false)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((AppVersion)obj);
        }

        /// <summary>
        /// Returns true if AppVersion instances are equal
        /// </summary>
        /// <param name="other">Instance of AppVersion to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + MinorVersion.GetHashCode();
