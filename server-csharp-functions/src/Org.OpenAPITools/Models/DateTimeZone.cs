...
{ 
    ...
    public partial class DateTimeZone : IEquatable<DateTimeZone>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DateTimeZone)obj);
        }

        /// <summary>
        /// Returns true if DateTimeZone instances are equal
        /// </summary>
        /// <param name="other">Instance of DateTimeZone to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + Fixed.GetHashCode();
                return hashCode;
            }
        }
