...
{ 
    ...
    public partial class Event : IEquatable<Event>
    {
        ...
        /// </summary>
        [DataMember(Name="sponsered", EmitDefaultValue=false)]
        ...
        public bool Equals(Event other)
        {
            ...
            return 
                (
                    Sponsered == other.Sponsered ||
                    
                    Sponsered.Equals(other.Sponsered)
                ) && 
                (
                    Listing == other.Listing ||
                    Listing != null &&
                    Listing.Equals(other.Listing)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + Sponsered.GetHashCode();
                    if (Listing != null)
                    hashCode = hashCode * 59 + Listing.GetHashCode();
                return hashCode;
            }
        }
