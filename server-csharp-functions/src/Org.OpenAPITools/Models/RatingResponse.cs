...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RatingResponse : IEquatable<RatingResponse>
    {
        /// <summary>
        /// Gets or Sets RatingId
        /// </summary>
        [DataMember(Name="ratingId", EmitDefaultValue=false)]
        public long RatingId { get; set; }

        /// <summary>
        /// Gets or Sets RatingValue
        /// </summary>
        [DataMember(Name="ratingValue", EmitDefaultValue=false)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RatingResponse)obj);
        }

        /// <summary>
        /// Returns true if RatingResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of RatingResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RatingResponse other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + RatingId.GetHashCode();
        ...
        public static bool operator ==(RatingResponse left, RatingResponse right)
        {
